...
public final class ArraysKt___ArraysKt$withIndex$7 extends Lambda implements C11289a<Iterator<? extends Double>> {
    ...
    public final Iterator<Double> invoke() {
        return C11335i.m43508d(this.$this_withIndex);
    }
}
