...
public final class FutureKt$await$2$1 extends Lambda implements C11300l<Throwable, C11079d2> {
    final /* synthetic */ C11957b<T> $consumer;
    final /* synthetic */ CompletableFuture<T> $future;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FutureKt$await$2$1(CompletableFuture<T> completableFuture, C11957b<T> bVar) {
        super(1);
