...
public final class C11783x49f1cbae extends Lambda implements C11300l<DebugProbesImpl.C11778a<?>, C11787c> {
    public C11783x49f1cbae() {
        super(1);
    }

    @C12580l
    /* renamed from: a */
    public final C11787c invoke(@C12579k DebugProbesImpl.C11778a<?> aVar) {
        CoroutineContext c;
        if (!DebugProbesImpl.f29218a.mo24039z(aVar) && (c = aVar.f29231b.mo23985c()) != null) {
            return new C11787c(aVar.f29231b, c);
        }
        return null;
    }
}
