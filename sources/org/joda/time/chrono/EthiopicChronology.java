...
public final class EthiopicChronology extends BasicFixedMonthChronology {
    ...
    /* renamed from: A1 */
    public static final int f30982A1 = 292272984;

    /* renamed from: B1 */
    public static final ConcurrentHashMap<DateTimeZone, EthiopicChronology[]> f30983B1 = new ConcurrentHashMap<>();

    /* renamed from: C1 */
    public static final EthiopicChronology f30984C1 = m52835X0(DateTimeZone.f30651a);
    private static final long serialVersionUID = -5972804258688333942L;

    /* renamed from: x1 */
    public static final int f30985x1 = 1;

    /* renamed from: y1 */
    public static final C12599c f30986y1 = new C12610d("EE");

    /* renamed from: z1 */
    public static final int f30987z1 = -292269337;

    public EthiopicChronology(C12589a aVar, Object obj, int i) {
        super(aVar, obj, i);
    }

    /* renamed from: W0 */
    public static EthiopicChronology m52834W0() {
        return m52836Y0(DateTimeZone.m51374n(), 4);
    }

    /* renamed from: X0 */
    public static EthiopicChronology m52835X0(DateTimeZone dateTimeZone) {
        return m52836Y0(dateTimeZone, 4);
    }
    ...
    public static org.joda.time.chrono.EthiopicChronology m52836Y0(org.joda.time.DateTimeZone r13, int r14) {
        /*
            if (r13 != 0) goto L_0x0006
            org.joda.time.DateTimeZone r13 = org.joda.time.DateTimeZone.m51374n()
        L_0x0006:
            java.util.concurrent.ConcurrentHashMap<org.joda.time.DateTimeZone, org.joda.time.chrono.EthiopicChronology[]> r0 = f30983B1
        ...
        L_0x001c:
            ...
            goto L_0x0056
        L_0x0049:
            org.joda.time.chrono.EthiopicChronology r2 = m52836Y0(r2, r14)     // Catch:{ all -> 0x005b }
            org.joda.time.chrono.EthiopicChronology r4 = new org.joda.time.chrono.EthiopicChronology     // Catch:{ all -> 0x005b }
        ...
        L_0x005f:
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: org.joda.time.chrono.EthiopicChronology.m52836Y0(org.joda.time.DateTimeZone, int):org.joda.time.chrono.EthiopicChronology");
    }

    /* renamed from: Z0 */
    public static EthiopicChronology m52837Z0() {
        return f30984C1;
    }
    ...
    private Object readResolve() {
        C12589a X = mo28850X();
        if (X == null) {
            return m52836Y0(DateTimeZone.f30651a, mo28859F0());
        }
        return m52836Y0(X.mo27836s(), mo28859F0());
    }
