...
public class C12722a implements C12723b {

    /* renamed from: a */
    public HashMap<Locale, Map<String, Map<String, Object>>> f31409a = mo29460c();

    /* renamed from: b */
    public HashMap<Locale, Map<String, Map<Boolean, Object>>> f31410b = mo29460c();

    /* renamed from: a */
    public String mo29458a(Locale locale, String str, String str2) {
        String[] e = mo29462e(locale, str, str2);
        if (e == null) {
            return null;
        }
        return e[1];
    ...
    /* renamed from: b */
    public String mo29459b(Locale locale, String str, String str2) {
        String[] e = mo29462e(locale, str, str2);
        if (e == null) {
            return null;
        }
    ...
    /* renamed from: c */
    public final HashMap mo29460c() {
        return new HashMap(7);
    }

    /* renamed from: d */
    public String mo29461d(Locale locale, String str, String str2, boolean z) {
        String[] f = mo29463f(locale, str, str2, z);
        if (f == null) {
            return null;
        }
        return f[1];
    ...
    public final synchronized java.lang.String[] mo29462e(java.util.Locale r10, java.lang.String r11, java.lang.String r12) {
        /*
            r9 = this;
            monitor-enter(r9)
            r0 = 0
            ...
            goto L_0x00cd
        L_0x000a:
            java.util.HashMap<java.util.Locale, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.Object>>> r1 = r9.f31409a     // Catch:{ all -> 0x00ca }
            java.lang.Object r1 = r1.get(r10)     // Catch:{ all -> 0x00ca }
            java.util.Map r1 = (java.util.Map) r1     // Catch:{ all -> 0x00ca }
            if (r1 != 0) goto L_0x001e
            java.util.HashMap<java.util.Locale, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.Object>>> r1 = r9.f31409a     // Catch:{ all -> 0x00ca }
            java.util.HashMap r2 = r9.mo29460c()     // Catch:{ all -> 0x00ca }
        ...
        L_0x001e:
            ...
            java.text.DateFormatSymbols r1 = org.joda.time.C12641d.m53371f(r1)     // Catch:{ all -> 0x00ca }
        ...
        L_0x0050:
            r7 = r0
        L_0x0051:
            java.text.DateFormatSymbols r10 = org.joda.time.C12641d.m53371f(r10)     // Catch:{ all -> 0x00ca }
        ...
        L_0x00cd:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.joda.time.p014tz.C12722a.mo29462e(java.util.Locale, java.lang.String, java.lang.String):java.lang.String[]");
    }
    ...
    /* renamed from: f */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized java.lang.String[] mo29463f(java.util.Locale r10, java.lang.String r11, java.lang.String r12, boolean r13) {
        /*
            r9 = this;
            monitor-enter(r9)
            r0 = 0
        ...
        L_0x0017:
            java.util.HashMap<java.util.Locale, java.util.Map<java.lang.String, java.util.Map<java.lang.Boolean, java.lang.Object>>> r12 = r9.f31410b     // Catch:{ all -> 0x00af }
            java.lang.Object r12 = r12.get(r10)     // Catch:{ all -> 0x00af }
            java.util.Map r12 = (java.util.Map) r12     // Catch:{ all -> 0x00af }
            if (r12 != 0) goto L_0x002b
            java.util.HashMap<java.util.Locale, java.util.Map<java.lang.String, java.util.Map<java.lang.Boolean, java.lang.Object>>> r12 = r9.f31410b     // Catch:{ all -> 0x00af }
            java.util.HashMap r2 = r9.mo29460c()     // Catch:{ all -> 0x00af }
        ...
        L_0x002b:
            ...
            java.text.DateFormatSymbols r12 = org.joda.time.C12641d.m53371f(r12)     // Catch:{ all -> 0x00af }
        ...
        L_0x005d:
            r7 = r0
        L_0x005e:
            java.text.DateFormatSymbols r10 = org.joda.time.C12641d.m53371f(r10)     // Catch:{ all -> 0x00af }
        ...
        L_0x00b2:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.joda.time.p014tz.C12722a.mo29463f(java.util.Locale, java.lang.String, java.lang.String, boolean):java.lang.String[]");
    }

    /* renamed from: g */
    public String mo29464g(Locale locale, String str, String str2, boolean z) {
        String[] f = mo29463f(locale, str, str2, z);
        if (f == null) {
            return null;
        }
