...
/* renamed from: androidx.core.graphics.r0 */
public class C17634r0 {

    /* renamed from: a */
    public static final String f46002a = "PathParser";

    /* renamed from: androidx.core.graphics.r0$a */
    public static class C17635a {
    ...
    /* renamed from: a */
    public static void m80735a(ArrayList<C17636b> arrayList, char c, float[] fArr) {
        arrayList.add(new C17636b(c, fArr));
    }

    /* renamed from: b */
    public static boolean m80736b(@C0363p0 C17636b[] bVarArr, @C0363p0 C17636b[] bVarArr2) {
        if (bVarArr == null || bVarArr2 == null || bVarArr.length != bVarArr2.length) {
            return false;
        }
        for (int i = 0; i < bVarArr.length; i++) {
            C17636b bVar = bVarArr[i];
            char c = bVar.f46005a;
            C17636b bVar2 = bVarArr2[i];
            if (c != bVar2.f46005a || bVar.f46006b.length != bVar2.f46006b.length) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: c */
    public static float[] m80737c(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    /* renamed from: d */
    public static C17636b[] m80738d(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                m80735a(arrayList, trim.charAt(0), m80742h(trim));
            }
            i2 = j;
            i = j + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m80735a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C17636b[]) arrayList.toArray(new C17636b[arrayList.size()]);
    }

    /* renamed from: e */
    public static Path m80739e(String str) {
        Path path = new Path();
        C17636b[] d = m80738d(str);
        if (d == null) {
            return null;
        }
        try {
            C17636b.m80749e(d, path);
            return path;
    ...
    /* renamed from: f */
    public static C17636b[] m80740f(C17636b[] bVarArr) {
        if (bVarArr == null) {
            return null;
        }
        C17636b[] bVarArr2 = new C17636b[bVarArr.length];
        for (int i = 0; i < bVarArr.length; i++) {
            bVarArr2[i] = new C17636b(bVarArr[i]);
        }
        return bVarArr2;
    }
    ...
    public static void m80741g(java.lang.String r8, int r9, androidx.core.graphics.C17634r0.C17635a r10) {
        /*
            r0 = 0
            r10.f46004b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.C17634r0.m80741g(java.lang.String, int, androidx.core.graphics.r0$a):void");
    }

    /* renamed from: h */
    public static float[] m80742h(String str) {
    ...
    /* renamed from: i */
    public static boolean m80743i(C17636b[] bVarArr, C17636b[] bVarArr2, C17636b[] bVarArr3, float f) {
        if (bVarArr == null || bVarArr2 == null || bVarArr3 == null) {
            ...
            if (!m80736b(bVarArr2, bVarArr3)) {
                return false;
            }
            for (int i = 0; i < bVarArr.length; i++) {
                bVarArr[i].mo52066d(bVarArr2[i], bVarArr3[i], f);
            }
            return true;
        } else {
    ...
    /* renamed from: j */
    public static int m80744j(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: k */
    public static void m80745k(C17636b[] bVarArr, C17636b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f46005a = bVarArr2[i].f46005a;
            int i2 = 0;
            while (true) {
                float[] fArr = bVarArr2[i].f46006b;
                if (i2 >= fArr.length) {
                    break;
                }
                bVarArr[i].f46006b[i2] = fArr[i2];
                i2++;
            }
        }
    }

    /* renamed from: androidx.core.graphics.r0$b */
    public static class C17636b {

        /* renamed from: a */
        public char f46005a;

        /* renamed from: b */
        public float[] f46006b;

        public C17636b(char c, float[] fArr) {
            this.f46005a = c;
            this.f46006b = fArr;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:103:0x0232, code lost:
            r24 = r7;
            m80748c(r25, r9, r8, r3, r4, r5, r6, r15, r22, r23);
            r9 = r9 + r12[r13];
            r8 = r8 + r12[r14];
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:116:0x02e3, code lost:
            m80748c(r25, r11, r15, r3, r4, r5, r6, r7, r8, r9);
            r9 = r12[r13];
            r8 = r12[r14];
         */
        ...
        /* renamed from: a */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static void m80746a(android.graphics.Path r25, float[] r26, char r27, char r28, float[] r29) {
            /*
                r10 = r25
                r11 = r28
                r12 = r29
            ...
            L_0x0232:
                ...
                r11 = r9
                r9 = r23
                m80748c(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9)
                r0 = r12[r13]
                float r9 = r11 + r0
                r0 = r12[r14]
                float r8 = r15 + r0
            ...
            L_0x02fa:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.C17634r0.C17636b.m80746a(android.graphics.Path, float[], char, char, float[]):void");
        }

        /* renamed from: b */
        public static void m80747b(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
        ...
        /* renamed from: c */
        public static void m80748c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            boolean z3;
            float f8 = f;
            ...
            if (d22 != 0.0d) {
                ...
                if (d23 < 0.0d) {
                    ...
                    m80748c(path, f, f2, f3, f4, f10 * sqrt, f6 * sqrt, f7, z, z2);
                    return;
                }
                ...
                double d26 = d2 * d15;
                double d27 = d * d11;
                m80747b(path, (d26 * cos) - (d27 * d21), (d26 * d21) + (d27 * cos), d15, d11, d5, d10, radians, atan2, atan22);
            }
        }

        /* renamed from: e */
        public static void m80749e(C17636b[] bVarArr, Path path) {
            float[] fArr = new float[6];
            char c = C15369g.f37977c;
            for (int i = 0; i < bVarArr.length; i++) {
                C17636b bVar = bVarArr[i];
                m80746a(path, fArr, c, bVar.f46005a, bVar.f46006b);
                c = bVarArr[i].f46005a;
            }
        }

        /* renamed from: d */
        public void mo52066d(C17636b bVar, C17636b bVar2, float f) {
            this.f46005a = bVar.f46005a;
            int i = 0;
            while (true) {
                float[] fArr = bVar.f46006b;
                if (i < fArr.length) {
                    this.f46006b[i] = (fArr[i] * (1.0f - f)) + (bVar2.f46006b[i] * f);
                    i++;
                } else {
                    return;
                }
        ...
        public C17636b(C17636b bVar) {
            this.f46005a = bVar.f46005a;
            float[] fArr = bVar.f46006b;
            this.f46006b = C17634r0.m80737c(fArr, 0, fArr.length);
        }
    }
}
