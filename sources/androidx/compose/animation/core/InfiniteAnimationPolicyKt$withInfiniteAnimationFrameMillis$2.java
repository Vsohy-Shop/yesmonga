...
public final class InfiniteAnimationPolicyKt$withInfiniteAnimationFrameMillis$2 extends Lambda implements C11300l<Long, R> {
    final /* synthetic */ C11300l<Long, R> $onFrame;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InfiniteAnimationPolicyKt$withInfiniteAnimationFrameMillis$2(C11300l<? super Long, ? extends R> lVar) {
        super(1);
        this.$onFrame = lVar;
    }

    /* renamed from: a */
    public final R mo6628a(long j) {
        return this.$onFrame.invoke(Long.valueOf(j / 1000000));
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return mo6628a(((Number) obj).longValue());
    }
}
