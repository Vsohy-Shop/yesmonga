...
public final class AndroidComposeView$removeAndroidView$1 extends Lambda implements C11289a<C11079d2> {
    ...
    public final void invoke() {
        ...
        C11370u0.m43695k(layoutNodeToHolder).remove(this.this$0.getAndroidViewsHandler$ui_release().getHolderToLayoutNode().remove(this.$view));
        C18196h2.m82531R1(this.$view, 0);
    }
}
