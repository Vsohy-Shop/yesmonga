...
public final class C15771x4da50561 extends Lambda implements C11300l<SemanticsNode, Comparable<?>> {

    /* renamed from: f */
    public static final C15771x4da50561 f39255f = new C15771x4da50561();

    public C15771x4da50561() {
        super(1);
    }
    ...
    public final Comparable<?> invoke(@C12579k SemanticsNode semanticsNode) {
        ...
        return Float.valueOf(semanticsNode.mo46020h().mo42249B());
    }
}
