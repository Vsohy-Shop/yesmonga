...
public final class AndroidUiFrameClock$withFrameNanos$2$1 extends Lambda implements C11300l<Throwable, C11079d2> {
    ...
    public final void invoke(@C12580l Throwable th) {
        this.$uiDispatcher.mo45493K0(this.$callback);
    }
}
