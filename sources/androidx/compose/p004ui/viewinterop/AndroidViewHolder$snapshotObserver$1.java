...
public final class AndroidViewHolder$snapshotObserver$1 extends Lambda implements C11300l<C11289a<? extends C11079d2>, C11079d2> {
    ...
    /* renamed from: c */
    public static final void m74827c(C11289a aVar) {
        Intrinsics.checkNotNullParameter(aVar, "$tmp0");
        aVar.invoke();
    }

    /* renamed from: b */
    public final void mo47973b(@C12579k C11289a<C11079d2> aVar) {
        Intrinsics.checkNotNullParameter(aVar, "command");
        if (this.this$0.getHandler().getLooper() == Looper.myLooper()) {
            aVar.invoke();
        } else {
            this.this$0.getHandler().post(new C16522b(aVar));
        }
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo47973b((C11289a) obj);
