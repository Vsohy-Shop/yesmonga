...
public final class AndroidView_androidKt$AndroidView$$inlined$ComposeNode$1 extends Lambda implements C11289a<LayoutNode> {
    final /* synthetic */ C11289a $factory;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AndroidView_androidKt$AndroidView$$inlined$ComposeNode$1(C11289a aVar) {
        super(0);
        this.$factory = aVar;
    }
