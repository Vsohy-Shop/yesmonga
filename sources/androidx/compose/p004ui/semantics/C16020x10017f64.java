...
public final class C16020x10017f64 extends Lambda implements C11300l<C15983v0, C11079d2> {
    final /* synthetic */ C11300l $properties$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C16020x10017f64(C11300l lVar) {
        super(1);
        this.$properties$inlined = lVar;
    }

    /* renamed from: a */
    public final void mo46007a(@C12579k C15983v0 v0Var) {
        Intrinsics.checkNotNullParameter(v0Var, "$this$null");
        v0Var.mo45973d("clearAndSetSemantics");
        v0Var.mo45971b().mo45707c("properties", this.$properties$inlined);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo46007a((C15983v0) obj);
