...
public final class OneDimensionalFocusSearchKt$generateAndSearchChildren$1 extends Lambda implements C11300l<C15535b.C15536a, Boolean> {
    ...
    public OneDimensionalFocusSearchKt$generateAndSearchChildren$1(FocusTargetModifierNode focusTargetModifierNode, FocusTargetModifierNode focusTargetModifierNode2, int i, C11300l<? super FocusTargetModifierNode, Boolean> lVar) {
        super(1);
    ...
    public final Boolean invoke(@C12579k C15535b.C15536a aVar) {
        ...
        Boolean valueOf = Boolean.valueOf(OneDimensionalFocusSearchKt.m64657k(this.$this_generateAndSearchChildren, this.$focusedItem, this.$direction, this.$onFound));
