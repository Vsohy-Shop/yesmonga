...
public final class C8674y<K, V> extends C8673x<K, V> implements Iterator<K>, C11348d {
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8674y(@C12579k C8667t<K, V> tVar, @C12579k Iterator<? extends Map.Entry<? extends K, ? extends V>> it) {
        super(tVar, it);
