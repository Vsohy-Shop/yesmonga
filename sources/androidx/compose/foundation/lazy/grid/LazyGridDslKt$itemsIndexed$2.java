...
public final class LazyGridDslKt$itemsIndexed$2 extends Lambda implements C11300l<Integer, Object> {
    final /* synthetic */ List<T> $items;
    final /* synthetic */ C11304p<Integer, T, Object> $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyGridDslKt$itemsIndexed$2(C11304p<? super Integer, ? super T, ? extends Object> pVar, List<? extends T> list) {
        super(1);
        this.$key = pVar;
        this.$items = list;
    }
