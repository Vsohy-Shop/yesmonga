...
public final class LazyGridDslKt$items$7 extends Lambda implements C11300l<Integer, Object> {
    final /* synthetic */ T[] $items;
    final /* synthetic */ C11300l<T, Object> $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyGridDslKt$items$7(C11300l<? super T, ? extends Object> lVar, T[] tArr) {
        super(1);
        this.$key = lVar;
        this.$items = tArr;
    }
