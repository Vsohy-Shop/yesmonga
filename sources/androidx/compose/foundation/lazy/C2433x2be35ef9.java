...
public final class C2433x2be35ef9 extends Lambda implements C11300l<C15983v0, C11079d2> {
    final /* synthetic */ float $fraction$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2433x2be35ef9(float f) {
        super(1);
        this.$fraction$inlined = f;
    }

    /* renamed from: a */
    public final void mo8272a(@C12579k C15983v0 v0Var) {
        Intrinsics.checkNotNullParameter(v0Var, "$this$null");
        v0Var.mo45973d("fillParentMaxSize");
        v0Var.mo45974e(Float.valueOf(this.$fraction$inlined));
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo8272a((C15983v0) obj);
