...
public final class LazyStaggeredGridDslKt$items$3 extends Lambda implements C11300l<Integer, Object> {
    final /* synthetic */ C11300l<T, Object> $contentType;
    final /* synthetic */ List<T> $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyStaggeredGridDslKt$items$3(C11300l<? super T, ? extends Object> lVar, List<? extends T> list) {
        super(1);
