...
public final class C2586x6e01acca extends Lambda implements C11300l<LazyStaggeredGridLaneInfo.C2585b, Integer> {
    final /* synthetic */ Comparable $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2586x6e01acca(Comparable comparable) {
        super(1);
        this.$key = comparable;
    }
