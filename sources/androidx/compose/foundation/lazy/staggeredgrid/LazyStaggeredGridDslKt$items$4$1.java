...
public final class LazyStaggeredGridDslKt$items$4$1 extends Lambda implements C11300l<Integer, C2617v> {
    final /* synthetic */ List<T> $items;
    final /* synthetic */ C11300l<T, C2617v> $span;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyStaggeredGridDslKt$items$4$1(C11300l<? super T, C2617v> lVar, List<? extends T> list) {
        super(1);
        this.$span = lVar;
        this.$items = list;
    }
    ...
    @C12579k
    /* renamed from: a */
    public final C2617v mo8845a(int i) {
        return this.$span.invoke(this.$items.get(i));
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return mo8845a(((Number) obj).intValue());
    }
}
