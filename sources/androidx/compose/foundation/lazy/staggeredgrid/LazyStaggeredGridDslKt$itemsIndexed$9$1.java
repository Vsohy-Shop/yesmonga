...
public final class LazyStaggeredGridDslKt$itemsIndexed$9$1 extends Lambda implements C11300l<Integer, C2617v> {
    final /* synthetic */ T[] $items;
    final /* synthetic */ C11304p<Integer, T, C2617v> $span;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyStaggeredGridDslKt$itemsIndexed$9$1(C11304p<? super Integer, ? super T, C2617v> pVar, T[] tArr) {
        super(1);
        this.$span = pVar;
        this.$items = tArr;
    }
    ...
    @C12579k
    /* renamed from: a */
    public final C2617v mo8860a(int i) {
        return this.$span.invoke(Integer.valueOf(i), this.$items[i]);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return mo8860a(((Number) obj).intValue());
    }
}
