...
public final class LazyDslKt$itemsIndexed$3 extends Lambda implements C11300l<Integer, Object> {
    final /* synthetic */ C11304p<Integer, T, Object> $contentType;
    final /* synthetic */ List<T> $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyDslKt$itemsIndexed$3(C11304p<? super Integer, ? super T, ? extends Object> pVar, List<? extends T> list) {
        super(1);
