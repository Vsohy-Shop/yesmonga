...
public final class BasicTextFieldKt$BasicTextField$5 extends Lambda implements C11304p<C8592o, Integer, C11079d2> {
    ...
    public final void invoke(@C12580l C8592o oVar, int i) {
        ...
        String str2 = str;
        BasicTextFieldKt.m12190c(str2, this.$onValueChange, this.$modifier, this.$enabled, this.$readOnly, this.$textStyle, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$minLines, this.$visualTransformation, this.$onTextLayout, this.$interactionSource, this.$cursorBrush, this.$decorationBox, oVar2, C8590n1.m31123a(this.$$changed | 1), C8590n1.m31123a(this.$$changed1), this.$$default);
    }
}
