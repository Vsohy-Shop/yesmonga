...
public final class C2334xaf5f9f7d extends Lambda implements C11300l<C15983v0, C11079d2> {
    final /* synthetic */ C2354e1 $insets$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C2334xaf5f9f7d(C2354e1 e1Var) {
        super(1);
        this.$insets$inlined = e1Var;
    }

    /* renamed from: a */
    public final void mo7974a(@C12579k C15983v0 v0Var) {
        Intrinsics.checkNotNullParameter(v0Var, "$this$null");
        v0Var.mo45973d("insetsEndWidth");
        v0Var.mo45971b().mo45707c("insets", this.$insets$inlined);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo7974a((C15983v0) obj);
