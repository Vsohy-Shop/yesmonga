...
public final class ToggleableKt$toggleableO2vRcR0$$inlined$debugInspectorInfo$1 extends Lambda implements C11300l<C15983v0, C11079d2> {
    ...
    public ToggleableKt$toggleableO2vRcR0$$inlined$debugInspectorInfo$1(boolean z, C2243g gVar, C2104a0 a0Var, boolean z2, C16031g gVar2, C11300l lVar) {
        super(1);
        this.$value$inlined = z;
        this.$interactionSource$inlined = gVar;
        this.$indication$inlined = a0Var;
        this.$enabled$inlined = z2;
        this.$role$inlined = gVar2;
        this.$onValueChange$inlined = lVar;
    }

    /* renamed from: a */
    public final void mo9150a(@C12579k C15983v0 v0Var) {
