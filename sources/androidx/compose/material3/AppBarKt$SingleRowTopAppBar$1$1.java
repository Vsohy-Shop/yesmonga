...
public final class AppBarKt$SingleRowTopAppBar$1$1 extends Lambda implements C11289a<C11079d2> {
    final /* synthetic */ float $heightOffsetLimit;
    final /* synthetic */ C8275r3 $scrollBehavior;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AppBarKt$SingleRowTopAppBar$1$1(C8275r3 r3Var, float f) {
        super(0);
    ...
    public final void invoke() {
        /*
            r3 = this;
            androidx.compose.material3.r3 r0 = r3.$scrollBehavior
            r1 = 0
