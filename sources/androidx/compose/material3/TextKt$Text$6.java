...
public final class TextKt$Text$6 extends Lambda implements C11304p<C8592o, Integer, C11079d2> {
    ...
    public final void invoke(@C12580l C8592o oVar, int i) {
        ...
        C16156d dVar2 = dVar;
        TextKt.m26701d(dVar2, this.$modifier, this.$color, this.$fontSize, this.$fontStyle, this.$fontWeight, this.$fontFamily, this.$letterSpacing, this.$textDecoration, this.$textAlign, this.$lineHeight, this.$overflow, this.$softWrap, this.$maxLines, this.$minLines, this.$inlineContent, this.$onTextLayout, this.$style, oVar2, C8590n1.m31123a(this.$$changed | 1), C8590n1.m31123a(this.$$changed1), this.$$default);
    }
}
