...
public final class TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1 implements C15560f0 {

    /* renamed from: a */
    public static final TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1 f19914a = new TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1();
    ...
    public final C15564g0 mo6397a(@C12579k C15568h0 h0Var, @C12579k List<? extends C15557e0> list, long j) {
        ...
        for (C15557e0 e0Var : iterable) {
            if (Intrinsics.areEqual(C15594q.m69317a(e0Var), (Object) "Spacer")) {
                C15611w0 t0 = e0Var.mo44324t0(C16476b.m74351e(j, 0, 0, 0, C11409d.m43851L0(h0Var.mo7425g5(C8306g1.f21226a.mo13654y())), 3, (Object) null));
                ...
                for (C15557e0 t02 : arrayList) {
                    arrayList2.add(t02.mo44324t0(C16476b.m74351e(j, 0, 0, 0, C16476b.m74361o(j) / 2, 3, (Object) null)));
                }
                return C15568h0.m69206r2(h0Var, C16476b.m74362p(j), C16476b.m74361o(j), (Map) null, new TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1$measure$1(arrayList2, t0), 4, (Object) null);
            }
        }
