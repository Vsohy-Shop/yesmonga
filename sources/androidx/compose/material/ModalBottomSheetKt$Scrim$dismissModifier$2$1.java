...
public final class ModalBottomSheetKt$Scrim$dismissModifier$2$1 extends Lambda implements C11300l<C16044q, C11079d2> {
    final /* synthetic */ String $closeSheet;
    final /* synthetic */ C11289a<C11079d2> $onDismiss;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ModalBottomSheetKt$Scrim$dismissModifier$2$1(String str, C11289a<C11079d2> aVar) {
        super(1);
        this.$closeSheet = str;
        this.$onDismiss = aVar;
    }
    ...
    public final void invoke(@C12579k C16044q qVar) {
        ...
        SemanticsPropertiesKt.m71959G0(qVar, this.$closeSheet);
