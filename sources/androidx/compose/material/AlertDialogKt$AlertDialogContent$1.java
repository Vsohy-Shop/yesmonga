...
public final class AlertDialogKt$AlertDialogContent$1 extends Lambda implements C11304p<C8592o, Integer, C11079d2> {
    ...
    public AlertDialogKt$AlertDialogContent$1(C11304p<? super C8592o, ? super Integer, C11079d2> pVar, C11304p<? super C8592o, ? super Integer, C11079d2> pVar2, C11304p<? super C8592o, ? super Integer, C11079d2> pVar3, int i) {
        super(2);
        this.$title = pVar;
        this.$text = pVar2;
        this.$buttons = pVar3;
    ...
    public final void invoke(@C12580l C8592o oVar, int i) {
        if ((i & 11) != 2 || !oVar.mo15011p()) {
            if (ComposerKt.m29813g0()) {
                ComposerKt.m29845w0(629950291, i, -1, "androidx.compose.material.AlertDialogContent.<anonymous> (AlertDialog.kt:57)");
            }
            C11304p<C8592o, Integer, C11079d2> pVar = this.$title;
            C11304p<C8592o, Integer, C11079d2> pVar2 = this.$text;
            C11304p<C8592o, Integer, C11079d2> pVar3 = this.$buttons;
            int i2 = this.$$dirty;
            ...
            C8552a aVar2 = null;
            C8552a b3 = pVar != null ? C8553b.m31048b(oVar, 620104160, true, new AlertDialogKt$AlertDialogContent$1$1$1$1(pVar, i2)) : null;
            if (pVar2 != null) {
                aVar2 = C8553b.m31048b(oVar, 1965858367, true, new AlertDialogKt$AlertDialogContent$1$1$2$1(pVar2, i2));
            }
            AlertDialogKt.m13188a(columnScopeInstance, b3, aVar2, oVar, 6);
            pVar3.invoke(oVar, Integer.valueOf(i2 & 14));
            oVar.mo15002m0();
            oVar.mo14896D();
            oVar.mo15002m0();
            oVar.mo15002m0();
