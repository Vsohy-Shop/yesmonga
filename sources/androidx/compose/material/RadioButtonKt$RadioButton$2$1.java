...
public final class RadioButtonKt$RadioButton$2$1 extends Lambda implements C11300l<C15187e, C11079d2> {
    ...
    public final void invoke(@C12579k C15187e eVar) {
        ...
        float g5 = eVar2.mo7425g5(RadioButtonKt.f7796g);
        float f = g5 / ((float) 2);
        C15187e.m65705a6(eVar, this.$radioColor.getValue().mo42833M(), eVar2.mo7425g5(RadioButtonKt.f7794e) - f, 0, 0.0f, new C15198m(g5, 0.0f, 0, 0, (C15242j3) null, 30, (DefaultConstructorMarker) null), (C15249k2) null, 0, 108, (Object) null);
        if (C16483g.m74452z(this.$dotRadius.getValue().mo47823t0(), C16483g.m74435M((float) 0)) > 0) {
            C15187e.m65705a6(eVar, this.$radioColor.getValue().mo42833M(), eVar2.mo7425g5(this.$dotRadius.getValue().mo47823t0()) - f, 0, 0.0f, C15197l.f37504a, (C15249k2) null, 0, 108, (Object) null);
        }
    }
}
