...
/* renamed from: androidx.compose.material.icons.sharp.ye */
public final class C6843ye {
    @C12580l

    /* renamed from: a */
    public static C15340c f16566a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22727a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16566a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Crib", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(4.0f);
        eVar.mo43285u(2.93f);
        eVar.mo43270f(-0.61f, -0.35f, -1.16f, -0.78f, -1.65f, -1.27f);
        eVar.mo43275k(-1.42f, 1.42f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(6.74f, 20.88f, 9.24f, 22.0f, 12.0f, 22.0f);
        eVar2.mo43270f(2.76f, 0.0f, 5.26f, -1.12f, 7.07f, -2.93f);
        eVar.mo43275k(-1.42f, -1.42f);
        eVar2.mo43270f(-0.49f, 0.49f, -1.05f, 0.92f, -1.65f, 1.27f);
        eVar.mo43284t(16.0f);
        eVar.mo43273i(4.0f);
        eVar.mo43284t(9.0f);
        eVar.mo43268d();
        eVar.mo43276l(14.0f, 19.75f);
        C15348e eVar3 = eVar;
        eVar3.mo43269e(13.36f, 19.91f, 12.69f, 20.0f, 12.0f, 20.0f);
        eVar3.mo43270f(-0.69f, 0.0f, -1.36f, -0.09f, -2.0f, -0.25f);
        eVar.mo43284t(16.0f);
        eVar.mo43273i(4.0f);
        eVar.mo43284t(19.75f);
        eVar.mo43268d();
