...
/* renamed from: androidx.compose.material.icons.sharp.x8 */
public final class C6800x8 {
    @C12580l

    /* renamed from: a */
    public static C15340c f16471a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22632a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16471a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Build", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(12.09f, 2.91f);
        eVar.mo43269e(10.08f, 0.9f, 7.07f, 0.49f, 4.65f, 1.67f);
        eVar.mo43275k(4.34f, 4.34f);
        eVar.mo43275k(-3.0f, 3.0f);
        eVar.mo43275k(-4.34f, -4.34f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(0.48f, 7.1f, 0.89f, 10.09f, 2.9f, 12.1f);
        eVar2.mo43270f(1.86f, 1.86f, 4.58f, 2.35f, 6.89f, 1.48f);
        eVar.mo43275k(9.82f, 9.82f);
        eVar.mo43275k(3.71f, -3.71f);
        eVar.mo43275k(-9.78f, -9.79f);
        eVar.mo43270f(0.92f, -2.34f, 0.44f, -5.1f, -1.45f, -6.99f);
        eVar.mo43268d();
