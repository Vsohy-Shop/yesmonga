...
public final class u80 {
    ...
    /* renamed from: a */
    public static C15340c f16226a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22387a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16226a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.NearbyError", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(12.0f, 7.58f);
        eVar.mo43274j(16.42f, 12.0f);
        eVar.mo43274j(12.0f, 16.42f);
        eVar.mo43274j(7.58f, 12.0f);
        eVar.mo43274j(12.0f, 7.58f);
        eVar.mo43268d();
        eVar.mo43276l(12.0f, 19.2f);
        eVar.mo43274j(4.8f, 12.0f);
        eVar.mo43274j(12.0f, 4.8f);
        eVar.mo43275k(6.0f, 6.0f);
        eVar.mo43284t(7.17f);
        eVar.mo43275k(-5.99f, -5.99f);
        eVar.mo43274j(1.18f, 12.01f);
        eVar.mo43275k(10.83f, 10.83f);
        eVar.mo43274j(18.0f, 16.83f);
        eVar.mo43284t(13.2f);
        eVar.mo43274j(12.0f, 19.2f);
        eVar.mo43268d();
