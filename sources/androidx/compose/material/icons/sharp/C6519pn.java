...
/* renamed from: androidx.compose.material.icons.sharp.pn */
public final class C6519pn {
    @C12580l

    /* renamed from: a */
    public static C15340c f15846a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22007a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f15846a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Extension", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar2.mo43269e(9.26f, 0.86f, 8.0f, 2.03f, 8.0f, 3.5f);
        eVar.mo43284t(5.0f);
        eVar.mo43272h(2.01f);
        eVar.mo43285u(5.8f);
        eVar.mo43272h(3.4f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(1.31f, 0.0f, 2.5f, 0.88f, 2.75f, 2.16f);
        eVar3.mo43270f(0.33f, 1.72f, -0.98f, 3.24f, -2.65f, 3.24f);
        eVar.mo43272h(2.0f);
        eVar.mo43284t(22.0f);
        eVar.mo43273i(5.8f);
        eVar.mo43285u(-1.4f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.0f, -1.31f, 0.88f, -2.5f, 2.16f, -2.75f);
        eVar4.mo43270f(1.72f, -0.33f, 3.24f, 0.98f, 3.24f, 2.65f);
        eVar.mo43284t(22.0f);
        eVar.mo43272h(19.0f);
        eVar.mo43285u(-6.0f);
        eVar.mo43273i(1.5f);
        C15348e eVar5 = eVar;
        eVar5.mo43270f(1.47f, 0.0f, 2.64f, -1.26f, 2.49f, -2.76f);
        eVar5.mo43270f(-0.13f, -1.3f, -1.33f, -2.24f, -2.63f, -2.24f);
        eVar.mo43268d();
