...
public final class zd0 {
    ...
    /* renamed from: a */
    public static C15340c f16647a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22808a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16647a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.PersonOff", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(8.65f, 5.82f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(9.36f, 4.72f, 10.6f, 4.0f, 12.0f, 4.0f);
        eVar2.mo43270f(2.21f, 0.0f, 4.0f, 1.79f, 4.0f, 4.0f);
        eVar2.mo43270f(0.0f, 1.4f, -0.72f, 2.64f, -1.82f, 3.35f);
        eVar.mo43274j(8.65f, 5.82f);
        eVar.mo43268d();
        eVar.mo43276l(20.0f, 17.17f);
        eVar2.mo43270f(-0.02f, -1.1f, -0.63f, -2.11f, -1.61f, -2.62f);
        eVar2.mo43270f(-0.54f, -0.28f, -1.13f, -0.54f, -1.77f, -0.76f);
        eVar.mo43274j(20.0f, 17.17f);
        eVar.mo43268d();
        eVar.mo43276l(21.19f, 21.19f);
        eVar.mo43274j(2.81f, 2.81f);
        eVar.mo43274j(1.39f, 4.22f);
        eVar.mo43275k(8.89f, 8.89f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-1.81f, 0.23f, -3.39f, 0.79f, -4.67f, 1.45f);
        eVar3.mo43269e(4.61f, 15.07f, 4.0f, 16.1f, 4.0f, 17.22f);
        eVar.mo43284t(20.0f);
        eVar.mo43273i(13.17f);
        eVar.mo43275k(2.61f, 2.61f);
