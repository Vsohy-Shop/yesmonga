...
public final class wq0 {
    ...
    /* renamed from: a */
    public static C15340c f16427a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22588a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16427a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Signpost", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(5.5f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(4.67f, 4.0f, 4.0f, 4.67f, 4.0f, 5.5f);
        eVar.mo43285u(3.0f);
        eVar2.mo43269e(4.0f, 9.33f, 4.67f, 10.0f, 5.5f, 10.0f);
        eVar.mo43272h(11.0f);
        eVar.mo43285u(2.0f);
        eVar.mo43272h(6.62f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-0.4f, 0.0f, -0.78f, 0.16f, -1.06f, 0.44f);
        eVar.mo43275k(-1.5f, 1.5f);
        eVar3.mo43270f(-0.59f, 0.59f, -0.59f, 1.54f, 0.0f, 2.12f);
        eVar.mo43275k(1.5f, 1.5f);
        eVar3.mo43269e(5.84f, 17.84f, 6.22f, 18.0f, 6.62f, 18.0f);
        eVar.mo43272h(11.0f);
        eVar.mo43285u(3.0f);
        ...
        eVar.mo43273i(4.38f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.4f, 0.0f, 0.78f, -0.16f, 1.06f, -0.44f);
        eVar.mo43275k(1.5f, -1.5f);
        eVar4.mo43270f(0.59f, -0.59f, 0.59f, -1.54f, 0.0f, -2.12f);
        eVar.mo43275k(-1.5f, -1.5f);
        eVar4.mo43269e(18.16f, 4.16f, 17.78f, 4.0f, 17.38f, 4.0f);
        eVar.mo43272h(13.0f);
        eVar.mo43284t(3.0f);
        eVar4.mo43269e(13.0f, 2.45f, 12.55f, 2.0f, 12.0f, 2.0f);
        eVar.mo43268d();
