...
/* renamed from: androidx.compose.material.icons.sharp.xq */
public final class C6818xq {
    @C12580l

    /* renamed from: a */
    public static C15340c f16508a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22669a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16508a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.FlightTakeoff", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43275k(-1.93f, 0.51f);
        eVar.mo43275k(4.14f, 7.17f);
        eVar.mo43275k(-4.97f, 1.33f);
        eVar.mo43275k(-1.97f, -1.54f);
        eVar.mo43275k(-1.45f, 0.39f);
        eVar.mo43275k(1.82f, 3.16f);
        eVar.mo43275k(0.77f, 1.33f);
        eVar.mo43274j(21.0f, 11.49f);
        eVar.mo43270f(0.81f, -0.23f, 1.28f, -1.05f, 1.07f, -1.85f);
        eVar.mo43268d();
