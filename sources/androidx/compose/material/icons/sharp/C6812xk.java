...
/* renamed from: androidx.compose.material.icons.sharp.xk */
public final class C6812xk {
    @C12580l

    /* renamed from: a */
    public static C15340c f16496a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22657a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16496a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Eco", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(6.05f, 8.05f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-2.73f, 2.73f, -2.73f, 7.15f, -0.02f, 9.88f);
        eVar2.mo43270f(1.47f, -3.4f, 4.09f, -6.24f, 7.36f, -7.93f);
        eVar2.mo43270f(-2.77f, 2.34f, -4.71f, 5.61f, -5.39f, 9.32f);
        eVar2.mo43270f(2.6f, 1.23f, 5.8f, 0.78f, 7.95f, -1.37f);
        eVar2.mo43269e(19.43f, 14.47f, 20.0f, 4.0f, 20.0f, 4.0f);
        eVar.mo43280p(9.53f, 4.57f, 6.05f, 8.05f);
        eVar.mo43268d();
