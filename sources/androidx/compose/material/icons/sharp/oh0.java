...
public final class oh0 {
    ...
    /* renamed from: a */
    public static C15340c f15753a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m21914a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f15753a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.PrintDisabled", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(9.65f, 7.0f);
        eVar.mo43274j(18.0f, 7.0f);
        eVar.mo43274j(18.0f, 3.01f);
        eVar.mo43274j(6.0f, 3.01f);
        eVar.mo43285u(0.35f);
        eVar.mo43268d();
        eVar.mo43276l(10.66f, 8.01f);
        eVar.mo43275k(9.0f, 8.99f);
        ...
        eVar.mo43270f(-1.66f, 0.0f, -3.0f, 1.33f, -3.0f, 2.99f);
        eVar.mo43285u(6.0f);
        eVar.mo43273i(4.0f);
        eVar.mo43285u(4.0f);
        eVar.mo43273i(12.0f);
        ...
        eVar.mo43268d();
        eVar.mo43276l(8.0f, 19.01f);
        eVar.mo43274j(8.0f, 15.0f);
        eVar.mo43273i(4.0f);
        eVar.mo43275k(4.0f, 4.0f);
        eVar.mo43275k(-8.0f, 0.01f);
        eVar.mo43268d();
