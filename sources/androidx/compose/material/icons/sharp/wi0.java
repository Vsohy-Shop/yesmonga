...
public final class wi0 {
    ...
    /* renamed from: a */
    public static C15340c f16411a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22572a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16411a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.RamenDining", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(22.0f, 3.51f);
        eVar.mo43284t(2.0f);
        eVar.mo43274j(4.0f, 3.99f);
        eVar.mo43284t(12.0f);
        eVar.mo43272h(2.0f);
        ...
        eVar.mo43272h(10.5f);
        eVar.mo43284t(4.78f);
        eVar.mo43274j(22.0f, 3.51f);
        eVar.mo43268d();
        eVar.mo43276l(6.5f, 5.22f);
        eVar.mo43284t(6.5f);
        eVar.mo43273i(-1.0f);
        eVar.mo43284t(5.34f);
        eVar.mo43274j(6.5f, 5.22f);
        eVar.mo43268d();
        eVar.mo43276l(5.5f, 8.0f);
        eVar.mo43273i(1.0f);
        eVar.mo43285u(4.0f);
        eVar.mo43273i(-1.0f);
        eVar.mo43284t(8.0f);
