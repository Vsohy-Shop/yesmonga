...
public final class ry0 {
    ...
    /* renamed from: a */
    public static C15340c f16033a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22194a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16033a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.ThumbsUpDown", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43275k(0.78f, -3.78f);
        eVar.mo43274j(5.38f, 0.0f);
        eVar.mo43274j(0.0f, 5.38f);
        eVar.mo43274j(0.0f, 14.0f);
        eVar.mo43273i(9.24f);
        eVar.mo43274j(12.0f, 7.54f);
        eVar.mo43268d();
        eVar.mo43276l(14.76f, 10.0f);
        eVar.mo43274j(12.0f, 16.46f);
        eVar.mo43274j(12.0f, 19.0f);
        eVar.mo43273i(6.18f);
        eVar.mo43275k(-0.78f, 3.78f);
        eVar.mo43274j(18.62f, 24.0f);
        eVar.mo43274j(24.0f, 18.62f);
        eVar.mo43274j(24.0f, 10.0f);
        eVar.mo43268d();
