...
public final class w80 {
    ...
    /* renamed from: a */
    public static C15340c f16390a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22551a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16390a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.NestCamWiredStand", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(18.0f, 0.85f);
        eVar.mo43274j(11.98f, 1.4f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(8.95f, 1.7f, 6.37f, 4.0f, 6.04f, 7.03f);
        eVar2.mo43270f(-0.39f, 3.57f, 2.2f, 6.69f, 5.68f, 7.04f);
        eVar.mo43275k(1.9f, 0.19f);
        eVar.mo43275k(-0.56f, 0.85f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-0.88f, -0.19f, -1.83f, -0.18f, -2.85f, 0.25f);
        eVar3.mo43269e(8.21f, 16.21f, 7.0f, 18.25f, 7.0f, 20.41f);
        eVar.mo43274j(7.0f, 23.0f);
        eVar.mo43273i(10.0f);
        eVar.mo43285u(-3.0f);
        eVar.mo43270f(0.0f, -1.67f, -0.83f, -3.15f, -2.09f, -4.06f);
        eVar.mo43275k(0.97f, -1.45f);
        eVar.mo43274j(18.0f, 14.72f);
        eVar.mo43284t(0.85f);
        eVar.mo43268d();
