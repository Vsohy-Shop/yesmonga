...
public final class z40 {
    ...
    /* renamed from: a */
    public static C15340c f16624a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22785a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f16624a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Map", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(15.0f, 5.1f);
        eVar.mo43274j(9.0f, 3.0f);
        eVar.mo43274j(3.0f, 5.02f);
        eVar.mo43285u(16.2f);
        eVar.mo43275k(6.0f, -2.33f);
        eVar.mo43275k(6.0f, 2.1f);
        eVar.mo43275k(6.0f, -2.02f);
        eVar.mo43274j(21.0f, 2.77f);
        eVar.mo43274j(15.0f, 5.1f);
        eVar.mo43268d();
        eVar.mo43276l(15.0f, 18.89f);
        eVar.mo43275k(-6.0f, -2.11f);
        eVar.mo43274j(9.0f, 5.11f);
        eVar.mo43275k(6.0f, 2.11f);
