...
public final class r01 {
    ...
    /* renamed from: a */
    public static C15340c f15957a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m22118a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f15957a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.TurnSlightRight", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(12.34f, 6.0f);
        eVar.mo43275k(0.0f, -2.0f);
        eVar.mo43275k(5.66f, 0.0f);
        eVar.mo43275k(0.0f, 5.66f);
        eVar.mo43275k(-2.0f, 0.0f);
        eVar.mo43275k(0.0f, -2.25f);
        eVar.mo43275k(-5.0f, 5.0f);
        eVar.mo43275k(0.0f, 7.59f);
        eVar.mo43275k(-2.0f, 0.0f);
        eVar.mo43275k(0.0f, -8.41f);
