...
public final class b41 {
    ...
    /* renamed from: a */
    public static C15340c f14658a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20819a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f14658a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Vrpano", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43270f(-5.25f, 0.0f, -9.01f, -1.54f, -10.0f, -1.92f);
        eVar.mo43284t(20.4f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(2.16f, -0.76f, 5.21f, -1.9f, 10.0f, -1.9f);
        eVar2.mo43270f(4.78f, 0.0f, 7.91f, 1.17f, 10.0f, 1.9f);
        eVar.mo43284t(3.6f);
        eVar.mo43269e(19.91f, 4.33f, 16.77f, 5.5f, 12.0f, 5.5f);
        eVar.mo43268d();
        eVar.mo43276l(12.0f, 15.0f);
        eVar.mo43270f(-2.34f, 0.0f, -4.52f, 0.15f, -6.52f, 0.41f);
        eVar.mo43275k(3.69f, -4.42f);
        eVar.mo43275k(2.0f, 2.4f);
        eVar.mo43274j(14.0f, 10.0f);
        eVar.mo43275k(4.51f, 5.4f);
        eVar.mo43269e(16.52f, 15.15f, 14.3f, 15.0f, 12.0f, 15.0f);
        eVar.mo43268d();
