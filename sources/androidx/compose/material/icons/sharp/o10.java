...
public final class o10 {
    ...
    /* renamed from: a */
    public static C15340c f15713a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m21874a(@C12579k C3053a.C3057d dVar) {
        Intrinsics.checkNotNullParameter(dVar, "<this>");
        C15340c cVar = f15713a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Sharp.Light", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(-2.0f);
        eVar.mo43285u(3.06f);
        eVar.mo43269e(5.87f, 6.63f, 2.03f, 11.51f, 3.22f, 17.0f);
        eVar.mo43274j(8.0f, 17.0f);
        eVar.mo43270f(0.0f, 2.21f, 1.79f, 4.0f, 4.0f, 4.0f);
        eVar.mo43281q(4.0f, -1.79f, 4.0f, -4.0f);
        eVar.mo43275k(4.78f, 0.0f);
        eVar.mo43269e(21.97f, 11.51f, 18.13f, 6.63f, 13.0f, 6.06f);
        eVar.mo43268d();
