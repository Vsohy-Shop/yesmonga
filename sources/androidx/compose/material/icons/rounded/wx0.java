...
public final class wx0 {
    ...
    /* renamed from: a */
    public static C15340c f14309a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20470a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14309a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.TextFormat", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43268d();
        eVar.mo43276l(9.5f, 12.8f);
        eVar.mo43273i(5.0f);
        eVar.mo43275k(0.66f, 1.6f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(0.15f, 0.36f, 0.5f, 0.6f, 0.89f, 0.6f);
        eVar3.mo43270f(0.69f, 0.0f, 1.15f, -0.71f, 0.88f, -1.34f);
        eVar.mo43275k(-3.88f, -8.97f);
        C15348e eVar4 = eVar;
        eVar4.mo43269e(12.87f, 4.27f, 12.46f, 4.0f, 12.0f, 4.0f);
        eVar4.mo43270f(-0.46f, 0.0f, -0.87f, 0.27f, -1.05f, 0.69f);
        eVar.mo43275k(-3.88f, 8.97f);
        C15348e eVar5 = eVar;
        eVar5.mo43270f(-0.27f, 0.63f, 0.2f, 1.34f, 0.89f, 1.34f);
        eVar5.mo43270f(0.39f, 0.0f, 0.74f, -0.24f, 0.89f, -0.6f);
        eVar.mo43275k(0.65f, -1.6f);
        eVar.mo43268d();
        eVar.mo43276l(12.0f, 5.98f);
        eVar.mo43274j(13.87f, 11.0f);
        eVar.mo43273i(-3.74f);
        eVar.mo43274j(12.0f, 5.98f);
        eVar.mo43268d();
