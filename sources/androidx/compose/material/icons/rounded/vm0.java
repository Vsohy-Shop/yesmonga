...
public final class vm0 {
    ...
    /* renamed from: a */
    public static C15340c f14205a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20366a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14205a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Science", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(8.0f);
        eVar.mo43269e(7.45f, 3.0f, 7.0f, 3.45f, 7.0f, 4.0f);
        eVar.mo43281q(0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(1.0f);
        eVar.mo43285u(6.0f);
        eVar.mo43275k(-5.54f, 6.73f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(3.14f, 18.12f, 3.0f, 18.56f, 3.0f, 19.0f);
        eVar2.mo43270f(0.01f, 1.03f, 0.82f, 2.0f, 2.0f, 2.0f);
        eVar.mo43272h(19.0f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(1.19f, 0.0f, 2.0f, -0.97f, 2.0f, -2.0f);
        eVar3.mo43269e(21.0f, 18.56f, 20.86f, 18.12f, 20.54f, 17.73f);
        eVar.mo43268d();
