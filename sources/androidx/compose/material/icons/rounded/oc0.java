...
public final class oc0 {
    ...
    /* renamed from: a */
    public static C15340c f13611a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19772a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13611a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.PanoramaWideAngleSelect", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        C15348e eVar2 = eVar;
        eVar2.mo43269e(8.03f, 4.0f, 5.15f, 4.63f, 3.0f, 5.0f);
        eVar2.mo43270f(-0.55f, 1.97f, -1.0f, 3.92f, -1.0f, 7.0f);
        eVar2.mo43270f(0.0f, 3.03f, 0.45f, 5.06f, 1.0f, 7.0f);
        eVar2.mo43270f(2.15f, 0.37f, 4.98f, 1.0f, 9.0f, 1.0f);
        eVar2.mo43270f(3.97f, 0.0f, 6.85f, -0.63f, 9.0f, -1.0f);
        eVar2.mo43270f(0.57f, -2.02f, 1.0f, -3.99f, 1.0f, -7.0f);
        eVar2.mo43270f(0.0f, -3.03f, -0.45f, -5.06f, -1.0f, -7.0f);
        eVar2.mo43269e(18.85f, 4.63f, 16.02f, 4.0f, 12.0f, 4.0f);
        eVar.mo43268d();
