...
public final class ey0 {
    ...
    /* renamed from: a */
    public static C15340c f12836a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18997a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12836a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.TextSnippet", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar3.mo43270f(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(7.0f, 15.45f, 7.45f, 15.0f, 8.0f, 15.0f);
        eVar.mo43268d();
        ...
        eVar4.mo43270f(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        eVar.mo43285u(0.0f);
        eVar4.mo43269e(7.0f, 11.45f, 7.45f, 11.0f, 8.0f, 11.0f);
        eVar.mo43268d();
        ...
        eVar.mo43272h(8.0f);
        eVar5.mo43269e(7.45f, 9.0f, 7.0f, 8.55f, 7.0f, 8.0f);
        eVar.mo43285u(0.0f);
        eVar5.mo43269e(7.0f, 7.45f, 7.45f, 7.0f, 8.0f, 7.0f);
        eVar.mo43268d();
