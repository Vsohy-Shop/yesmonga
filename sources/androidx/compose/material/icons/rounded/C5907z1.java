...
/* renamed from: androidx.compose.material.icons.rounded.z1 */
public final class C5907z1 {
    @C12580l

    /* renamed from: a */
    public static C15340c f14482a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20643a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14482a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.AllInbox", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(-3.14f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-0.47f, 0.0f, -0.84f, 0.33f, -0.97f, 0.78f);
        eVar3.mo43269e(14.53f, 11.04f, 13.35f, 12.0f, 12.0f, 12.0f);
        eVar.mo43281q(-2.53f, -0.96f, -2.89f, -2.22f);
        eVar.mo43270f(-0.13f, -0.45f, -0.5f, -0.78f, -0.97f, -0.78f);
        ...
        eVar.mo43285u(3.0f);
        eVar.mo43268d();
        eVar.mo43276l(15.87f, 16.0f);
        eVar.mo43274j(20.0f, 16.0f);
        eVar.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(2.0f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.0f, 1.1f, -0.9f, 2.0f, -2.0f, 2.0f);
        eVar.mo43274j(5.0f, 21.0f);
        eVar4.mo43270f(-1.1f, 0.0f, -2.0f, -0.9f, -2.0f, -2.0f);
        eVar.mo43285u(-2.0f);
        eVar.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43273i(4.13f);
        C15348e eVar5 = eVar;
        eVar5.mo43270f(0.47f, 0.0f, 0.85f, 0.34f, 0.98f, 0.8f);
        eVar5.mo43270f(0.35f, 1.27f, 1.51f, 2.2f, 2.89f, 2.2f);
        eVar.mo43281q(2.54f, -0.93f, 2.89f, -2.2f);
        eVar.mo43270f(0.13f, -0.46f, 0.51f, -0.8f, 0.98f, -0.8f);
        eVar.mo43268d();
