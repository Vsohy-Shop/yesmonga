...
public final class g80 {
    ...
    /* renamed from: a */
    public static C15340c f12947a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19108a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12947a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.MultipleStop", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar3.mo43269e(9.45f, 7.0f, 9.0f, 7.45f, 9.0f, 8.0f);
        eVar.mo43281q(0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43281q(1.0f, -0.45f, 1.0f, -1.0f);
        eVar.mo43280p(10.55f, 7.0f, 10.0f, 7.0f);
        eVar.mo43268d();
        eVar.mo43276l(6.0f, 7.0f);
        eVar.mo43269e(5.45f, 7.0f, 5.0f, 7.45f, 5.0f, 8.0f);
        eVar.mo43281q(0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43281q(1.0f, -0.45f, 1.0f, -1.0f);
        ...
        eVar.mo43275k(2.79f, 2.79f);
        eVar.mo43269e(6.46f, 19.46f, 7.0f, 19.24f, 7.0f, 18.79f);
        eVar.mo43284t(17.0f);
        eVar.mo43268d();
        ...
        eVar.mo43281q(-1.0f, 0.45f, -1.0f, 1.0f);
        eVar4.mo43269e(13.0f, 16.55f, 13.45f, 17.0f, 14.0f, 17.0f);
        eVar.mo43268d();
        ...
        eVar.mo43281q(-1.0f, 0.45f, -1.0f, 1.0f);
        eVar5.mo43269e(17.0f, 16.55f, 17.45f, 17.0f, 18.0f, 17.0f);
        eVar.mo43268d();
