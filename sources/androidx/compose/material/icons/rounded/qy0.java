...
public final class qy0 {
    ...
    /* renamed from: a */
    public static C15340c f13819a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19980a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13819a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ThumbUpOffAlt", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(13.12f, 2.06f);
        eVar.mo43274j(7.58f, 7.6f);
        eVar.mo43269e(7.21f, 7.97f, 7.0f, 8.48f, 7.0f, 9.01f);
        eVar.mo43284t(19.0f);
        eVar.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(9.0f);
        eVar.mo43270f(0.8f, 0.0f, 1.52f, -0.48f, 1.84f, -1.21f);
        eVar.mo43275k(3.26f, -7.61f);
        eVar.mo43269e(23.94f, 10.2f, 22.49f, 8.0f, 20.34f, 8.0f);
        eVar.mo43273i(-5.65f);
        eVar.mo43275k(0.95f, -4.58f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.1f, -0.5f, -0.05f, -1.01f, -0.41f, -1.37f);
        eVar2.mo43269e(14.64f, 1.47f, 13.7f, 1.47f, 13.12f, 2.06f);
        eVar.mo43268d();
        ...
        eVar.mo43285u(8.0f);
        eVar.mo43269e(1.0f, 20.1f, 1.9f, 21.0f, 3.0f, 21.0f);
        eVar.mo43268d();
