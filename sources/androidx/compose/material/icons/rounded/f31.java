...
public final class f31 {
    ...
    /* renamed from: a */
    public static C15340c f12851a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19012a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12851a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ViewModule", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar2.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43273i(3.33f);
        eVar2.mo43269e(14.22f, 5.0f, 14.67f, 5.45f, 14.67f, 6.0f);
        eVar.mo43268d();
        eVar.mo43276l(16.67f, 11.5f);
        eVar.mo43272h(20.0f);
        C15348e eVar3 = eVar;
        ...
        eVar3.mo43270f(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        eVar.mo43285u(4.5f);
        eVar3.mo43269e(15.67f, 11.05f, 16.11f, 11.5f, 16.67f, 11.5f);
        eVar.mo43268d();
        eVar.mo43276l(14.67f, 18.0f);
        eVar.mo43285u(-4.5f);
        eVar3.mo43270f(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43273i(-3.33f);
        eVar3.mo43270f(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        ...
        eVar3.mo43270f(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(3.33f);
        eVar3.mo43269e(14.22f, 19.0f, 14.67f, 18.55f, 14.67f, 18.0f);
        eVar.mo43268d();
        eVar.mo43276l(15.67f, 13.5f);
        eVar.mo43284t(18.0f);
        C15348e eVar4 = eVar;
        ...
        eVar4.mo43270f(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43273i(-3.33f);
        eVar4.mo43269e(16.11f, 12.5f, 15.67f, 12.95f, 15.67f, 13.5f);
        eVar.mo43268d();
        eVar.mo43276l(7.33f, 12.5f);
        eVar.mo43272h(4.0f);
        C15348e eVar5 = eVar;
        ...
        eVar5.mo43270f(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        eVar.mo43285u(-4.5f);
        eVar5.mo43269e(8.33f, 12.95f, 7.89f, 12.5f, 7.33f, 12.5f);
        eVar.mo43268d();
        eVar.mo43276l(8.33f, 10.5f);
        eVar.mo43284t(6.0f);
        C15348e eVar6 = eVar;
        eVar6.mo43270f(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43272h(4.0f);
        eVar6.mo43269e(3.45f, 5.0f, 3.0f, 5.45f, 3.0f, 6.0f);
        eVar.mo43285u(4.5f);
        C15348e eVar7 = eVar;
        eVar7.mo43270f(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(3.33f);
        eVar7.mo43269e(7.89f, 11.5f, 8.33f, 11.05f, 8.33f, 10.5f);
        eVar.mo43268d();
