...
/* renamed from: androidx.compose.material.icons.rounded.g0 */
public final class C5204g0 {
    @C12580l

    /* renamed from: a */
    public static C15340c f12922a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19083a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12922a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.AddLocationAlt", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43284t(1.0f);
        C15348e eVar3 = eVar;
        eVar3.mo43269e(18.0f, 0.45f, 18.45f, 0.0f, 19.0f, 0.0f);
        eVar.mo43268d();
        ...
        eVar.mo43280p(10.9f, 12.0f, 12.0f, 12.0f);
        eVar.mo43268d();
        eVar.mo43276l(14.72f, 2.47f);
        C15348e eVar4 = eVar;
        eVar4.mo43269e(14.28f, 2.83f, 14.0f, 3.38f, 14.0f, 4.0f);
        eVar4.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(1.0f);
        eVar.mo43285u(1.0f);
        eVar4.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar4.mo43270f(0.32f, 0.0f, 0.62f, -0.08f, 0.89f, -0.21f);
        eVar4.mo43269e(19.96f, 9.24f, 20.0f, 9.71f, 20.0f, 10.2f);
        eVar4.mo43270f(0.0f, 3.18f, -2.45f, 6.92f, -7.34f, 11.23f);
        eVar4.mo43270f(-0.38f, 0.33f, -0.95f, 0.33f, -1.33f, 0.0f);
        eVar4.mo43269e(6.45f, 17.12f, 4.0f, 13.38f, 4.0f, 10.2f);
        eVar4.mo43269e(4.0f, 5.22f, 7.8f, 2.0f, 12.0f, 2.0f);
        eVar4.mo43269e(12.94f, 2.0f, 13.86f, 2.16f, 14.72f, 2.47f);
        eVar.mo43268d();
