...
public final class ly0 {
    ...
    /* renamed from: a */
    public static C15340c f13409a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19570a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13409a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ThumbDownAlt", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(10.88f, 21.94f);
        eVar.mo43275k(5.53f, -5.54f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.37f, -0.37f, 0.58f, -0.88f, 0.58f, -1.41f);
        eVar.mo43284t(5.0f);
        eVar2.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar.mo43272h(6.0f);
        eVar.mo43270f(-0.8f, 0.0f, -1.52f, 0.48f, -1.83f, 1.21f);
        eVar.mo43274j(0.91f, 11.82f);
        eVar.mo43269e(0.06f, 13.8f, 1.51f, 16.0f, 3.66f, 16.0f);
        eVar.mo43273i(5.65f);
        eVar.mo43275k(-0.95f, 4.58f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-0.1f, 0.5f, 0.05f, 1.01f, 0.41f, 1.37f);
        eVar3.mo43270f(0.59f, 0.58f, 1.53f, 0.58f, 2.11f, -0.01f);
        eVar.mo43268d();
