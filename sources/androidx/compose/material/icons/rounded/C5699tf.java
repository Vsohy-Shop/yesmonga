...
/* renamed from: androidx.compose.material.icons.rounded.tf */
public final class C5699tf {
    @C12580l

    /* renamed from: a */
    public static C15340c f14026a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20187a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14026a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.CurrencyRuble", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(4.5f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(3.22f, 0.0f, 5.79f, -2.76f, 5.47f, -6.04f);
        eVar2.mo43269e(18.7f, 5.1f, 16.14f, 3.0f, 13.26f, 3.0f);
        eVar.mo43275k(-0.96f, 0.0f);
        eVar.mo43272h(8.0f);
        C15348e eVar3 = eVar;
        eVar3.mo43269e(7.45f, 3.0f, 7.0f, 3.45f, 7.0f, 4.0f);
        eVar.mo43285u(8.0f);
        eVar.mo43272h(6.0f);
        ...
        eVar.mo43273i(1.0f);
        eVar.mo43285u(2.0f);
        eVar.mo43269e(7.0f, 20.55f, 7.45f, 21.0f, 8.0f, 21.0f);
        eVar.mo43268d();
        eVar.mo43276l(13.5f, 12.0f);
        eVar.mo43272h(9.0f);
        eVar.mo43284t(5.0f);
        eVar.mo43273i(4.5f);
        eVar.mo43269e(15.43f, 5.0f, 17.0f, 6.57f, 17.0f, 8.5f);
        eVar.mo43280p(15.43f, 12.0f, 13.5f, 12.0f);
        eVar.mo43268d();
