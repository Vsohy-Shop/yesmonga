...
public final class i90 {
    ...
    /* renamed from: a */
    public static C15340c f13114a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19275a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13114a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.NextPlan", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43268d();
        eVar.mo43276l(18.0f, 13.97f);
        eVar.mo43273i(-5.0f);
        eVar.mo43275k(2.26f, -2.26f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-0.91f, -1.06f, -2.25f, -1.74f, -3.76f, -1.74f);
        eVar3.mo43270f(-2.37f, 0.0f, -4.35f, 1.66f, -4.86f, 3.88f);
        eVar.mo43275k(-0.96f, -0.32f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.64f, -2.62f, 3.0f, -4.56f, 5.82f, -4.56f);
        eVar4.mo43270f(1.78f, 0.0f, 3.37f, 0.79f, 4.47f, 2.03f);
        eVar.mo43274j(18.0f, 8.97f);
        eVar.mo43284t(13.97f);
        eVar.mo43268d();
