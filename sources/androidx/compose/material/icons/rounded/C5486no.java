...
/* renamed from: androidx.compose.material.icons.rounded.no */
public final class C5486no {
    @C12580l

    /* renamed from: a */
    public static C15340c f13552a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19713a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13552a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Female", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43268d();
        eVar.mo43276l(13.0f, 14.91f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(2.56f, -0.47f, 4.5f, -2.71f, 4.5f, -5.41f);
        eVar2.mo43269e(17.5f, 6.46f, 15.04f, 4.0f, 12.0f, 4.0f);
        eVar.mo43280p(6.5f, 6.46f, 6.5f, 9.5f);
        eVar.mo43270f(0.0f, 2.7f, 1.94f, 4.94f, 4.5f, 5.41f);
        eVar.mo43284t(17.0f);
        eVar.mo43273i(-1.0f);
