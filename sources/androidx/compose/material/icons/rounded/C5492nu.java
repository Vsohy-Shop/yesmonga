...
/* renamed from: androidx.compose.material.icons.rounded.nu */
public final class C5492nu {
    @C12580l

    /* renamed from: a */
    public static C15340c f13564a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19725a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13564a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Grid3x3", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar2.mo43270f(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43273i(0.0f);
        eVar2.mo43269e(8.45f, 4.0f, 8.0f, 4.45f, 8.0f, 5.0f);
        eVar.mo43285u(3.0f);
        eVar.mo43272h(5.0f);
        eVar2.mo43269e(4.45f, 8.0f, 4.0f, 8.45f, 4.0f, 9.0f);
        eVar.mo43285u(0.0f);
        eVar2.mo43270f(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(3.0f);
        eVar.mo43285u(4.0f);
        ...
        eVar.mo43285u(-4.0f);
        eVar.mo43273i(3.0f);
        eVar2.mo43269e(19.55f, 10.0f, 20.0f, 9.55f, 20.0f, 9.0f);
        eVar.mo43268d();
