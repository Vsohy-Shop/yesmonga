...
public final class qg0 {
    ...
    /* renamed from: a */
    public static C15340c f13783a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19944a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13783a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.PlaylistPlay", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43281q(0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43268d();
        eVar.mo43276l(14.0f, 14.88f);
        eVar.mo43285u(4.23f);
        eVar.mo43270f(0.0f, 0.39f, 0.42f, 0.63f, 0.76f, 0.43f);
        eVar.mo43275k(3.53f, -2.12f);
        eVar.mo43270f(0.32f, -0.19f, 0.32f, -0.66f, 0.0f, -0.86f);
        eVar.mo43275k(-3.53f, -2.12f);
        eVar.mo43270f(-0.34f, -0.19f, -0.76f, 0.05f, -0.76f, 0.44f);
        eVar.mo43268d();
