...
/* renamed from: androidx.compose.material.icons.rounded.ll */
public final class C5409ll {
    @C12580l

    /* renamed from: a */
    public static C15340c f13382a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19543a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13382a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Eject", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43281q(0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43268d();
        eVar.mo43276l(11.17f, 6.25f);
        eVar.mo43275k(-4.8f, 7.2f);
        eVar.mo43270f(-0.45f, 0.66f, 0.03f, 1.55f, 0.83f, 1.55f);
        eVar.mo43273i(9.6f);
        eVar.mo43270f(0.8f, 0.0f, 1.28f, -0.89f, 0.83f, -1.55f);
        eVar.mo43275k(-4.8f, -7.2f);
        eVar.mo43270f(-0.39f, -0.6f, -1.27f, -0.6f, -1.66f, 0.0f);
        eVar.mo43268d();
