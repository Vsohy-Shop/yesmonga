...
public final class d61 {
    ...
    /* renamed from: a */
    public static C15340c f12696a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18857a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12696a;
        if (cVar2 != null) {
        ...
        C15340c.C15341a aVar8 = new C15340c.C15341a("Rounded.WindPower", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(5.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(4.45f, 3.0f, 4.0f, 3.45f, 4.0f, 4.0f);
        eVar.mo43285u(0.0f);
        eVar2.mo43270f(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(4.0f);
        eVar2.mo43270f(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        eVar.mo43285u(0.0f);
        eVar2.mo43269e(10.0f, 3.45f, 9.55f, 3.0f, 9.0f, 3.0f);
        eVar.mo43268d();
        ...
        eVar3.mo43272h(2.0f);
        C15348e eVar4 = eVar3;
        eVar4.mo43269e(1.45f, 7.0f, 1.0f, 7.45f, 1.0f, 8.0f);
        eVar3.mo43285u(0.0f);
        eVar4.mo43270f(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        eVar3.mo43273i(3.0f);
        eVar4.mo43270f(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        eVar3.mo43285u(0.0f);
        eVar4.mo43269e(6.0f, 7.45f, 5.55f, 7.0f, 5.0f, 7.0f);
        eVar3.mo43268d();
        ...
        eVar6.mo43270f(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        eVar5.mo43285u(0.0f);
        eVar6.mo43269e(3.0f, 20.55f, 3.45f, 21.0f, 4.0f, 21.0f);
        eVar5.mo43268d();
        ...
        eVar7.mo43276l(13.73f, 10.61f);
        eVar7.mo43270f(0.75f, 0.23f, 1.3f, 0.78f, 1.57f, 1.46f);
        eVar7.mo43275k(4.27f, -7.11f);
        C15348e eVar8 = eVar7;
        eVar8.mo43270f(0.65f, -1.08f, 0.3f, -2.48f, -0.78f, -3.13f);
        eVar8.mo43270f(-0.87f, -0.52f, -1.99f, -0.41f, -2.73f, 0.29f);
        eVar7.mo43275k(-3.43f, 3.21f);
        eVar7.mo43269e(12.23f, 5.7f, 12.0f, 6.23f, 12.0f, 6.78f);
        eVar7.mo43285u(3.93f);
        eVar7.mo43269e(12.36f, 10.56f, 12.98f, 10.38f, 13.73f, 10.61f);
        eVar7.mo43268d();
        ...
        eVar9.mo43276l(10.61f, 12.27f);
        eVar9.mo43270f(0.16f, -0.52f, 0.48f, -0.96f, 0.89f, -1.27f);
        eVar9.mo43272h(3.28f);
        C15348e eVar10 = eVar9;
        eVar10.mo43269e(2.02f, 11.0f, 1.0f, 12.02f, 1.0f, 13.28f);
        eVar10.mo43270f(0.0f, 1.02f, 0.67f, 1.91f, 1.65f, 2.19f);
        eVar9.mo43275k(4.51f, 1.29f);
        eVar9.mo43270f(0.53f, 0.15f, 1.1f, 0.08f, 1.58f, -0.21f);
        eVar9.mo43275k(2.69f, -1.61f);
        eVar9.mo43269e(10.66f, 14.32f, 10.3f, 13.27f, 10.61f, 12.27f);
        eVar9.mo43268d();
        ...
        eVar11.mo43276l(22.21f, 18.61f);
        eVar11.mo43275k(-2.28f, -4.1f);
        eVar11.mo43270f(-0.27f, -0.48f, -0.73f, -0.83f, -1.26f, -0.97f);
        eVar11.mo43275k(-3.18f, -0.8f);
        C15348e eVar12 = eVar11;
        eVar12.mo43270f(0.03f, 0.32f, 0.0f, 0.66f, -0.1f, 0.99f);
        eVar12.mo43270f(-0.32f, 1.06f, -1.28f, 1.77f, -2.39f, 1.77f);
        eVar12.mo43270f(-0.61f, 0.0f, -0.99f, -0.22f, -1.0f, -0.22f);
        eVar11.mo43284t(21.0f);
        eVar12.mo43270f(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        eVar11.mo43273i(6.0f);
        eVar11.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar11.mo43285u(-4.28f);
        eVar11.mo43275k(4.61f, 4.61f);
        C15348e eVar13 = eVar11;
        eVar13.mo43270f(0.89f, 0.89f, 2.33f, 0.89f, 3.22f, 0.0f);
        ...
        eVar14.mo43276l(12.56f, 14.43f);
        C15348e eVar15 = eVar14;
        eVar15.mo43270f(0.79f, 0.24f, 1.63f, -0.2f, 1.87f, -1.0f);
        eVar15.mo43270f(0.24f, -0.79f, -0.2f, -1.63f, -1.0f, -1.87f);
        eVar15.mo43270f(-0.79f, -0.24f, -1.63f, 0.2f, -1.87f, 1.0f);
        eVar15.mo43269e(11.32f, 13.35f, 11.77f, 14.19f, 12.56f, 14.43f);
        eVar14.mo43268d();
