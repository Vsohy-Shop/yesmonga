...
public final class ck0 {
    ...
    /* renamed from: a */
    public static C15340c f12644a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18805a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12644a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.RepeatOn", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(3.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(1.9f, 1.0f, 1.0f, 1.9f, 1.0f, 3.0f);
        eVar.mo43285u(18.0f);
        eVar2.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(18.0f);
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43284t(3.0f);
        eVar2.mo43269e(23.0f, 1.9f, 22.1f, 1.0f, 21.0f, 1.0f);
        eVar.mo43268d();
        ...
        eVar.mo43285u(1.79f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(0.0f, 0.45f, -0.54f, 0.67f, -0.85f, 0.36f);
        eVar.mo43275k(-2.79f, -2.79f);
        eVar3.mo43270f(-0.2f, -0.2f, -0.2f, -0.51f, 0.0f, -0.71f);
        eVar.mo43275k(2.79f, -2.79f);
        eVar3.mo43269e(6.46f, 14.54f, 7.0f, 14.76f, 7.0f, 15.21f);
        eVar.mo43284t(17.0f);
        eVar.mo43273i(10.0f);
        eVar.mo43285u(-3.0f);
        eVar.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        ...
        eVar.mo43284t(18.0f);
        eVar.mo43268d();
        eVar.mo43276l(20.64f, 6.35f);
        eVar.mo43275k(-2.79f, 2.79f);
        C15348e eVar4 = eVar;
        eVar4.mo43269e(17.54f, 9.46f, 17.0f, 9.24f, 17.0f, 8.79f);
        eVar.mo43284t(7.0f);
        eVar.mo43272h(7.0f);
        eVar.mo43285u(3.0f);
        ...
        eVar.mo43284t(3.21f);
        C15348e eVar5 = eVar;
        eVar5.mo43270f(0.0f, -0.45f, 0.54f, -0.67f, 0.85f, -0.36f);
        eVar.mo43275k(2.79f, 2.79f);
        eVar5.mo43269e(20.84f, 5.84f, 20.84f, 6.15f, 20.64f, 6.35f);
        eVar.mo43268d();
