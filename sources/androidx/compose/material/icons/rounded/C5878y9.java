...
/* renamed from: androidx.compose.material.icons.rounded.y9 */
public final class C5878y9 {
    @C12580l

    /* renamed from: a */
    public static C15340c f14424a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20585a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14424a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.CameraFront", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(17.0f, 0.0f);
        eVar.mo43274j(7.0f, 0.0f);
        eVar.mo43269e(5.9f, 0.0f, 5.0f, 0.9f, 5.0f, 2.0f);
        eVar.mo43285u(14.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(10.0f);
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43274j(19.0f, 2.0f);
        eVar.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar.mo43268d();
        eVar.mo43276l(17.0f, 12.5f);
        eVar.mo43270f(0.0f, -1.67f, -3.33f, -2.5f, -5.0f, -2.5f);
        eVar.mo43281q(-5.0f, 0.83f, -5.0f, 2.5f);
        ...
        eVar.mo43285u(9.5f);
        eVar.mo43268d();
        eVar.mo43276l(10.85f, 18.85f);
        eVar.mo43270f(-0.31f, -0.31f, -0.85f, -0.09f, -0.85f, 0.36f);
        ...
        eVar.mo43281q(-1.99f, 0.9f, -1.99f, 2.0f);
