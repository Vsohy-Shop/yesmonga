...
public final class er0 {
    ...
    /* renamed from: a */
    public static C15340c f12822a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18983a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12822a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.SkipPrevious", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43268d();
        eVar.mo43276l(10.66f, 12.82f);
        eVar.mo43275k(5.77f, 4.07f);
        eVar.mo43270f(0.66f, 0.47f, 1.58f, -0.01f, 1.58f, -0.82f);
        eVar.mo43274j(18.01f, 7.93f);
        eVar.mo43270f(0.0f, -0.81f, -0.91f, -1.28f, -1.58f, -0.82f);
        eVar.mo43275k(-5.77f, 4.07f);
        eVar.mo43270f(-0.57f, 0.4f, -0.57f, 1.24f, 0.0f, 1.64f);
        eVar.mo43268d();
