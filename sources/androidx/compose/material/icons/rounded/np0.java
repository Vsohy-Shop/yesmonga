...
public final class np0 {
    ...
    /* renamed from: a */
    public static C15340c f13555a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19716a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13555a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Shop", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43268d();
        eVar.mo43276l(9.0f, 17.07f);
        eVar.mo43274j(9.0f, 9.83f);
        eVar.mo43270f(0.0f, -0.38f, 0.4f, -0.62f, 0.74f, -0.44f);
        eVar.mo43275k(6.03f, 3.21f);
        eVar.mo43270f(0.33f, 0.18f, 0.36f, 0.65f, 0.04f, 0.86f);
        eVar.mo43275k(-6.03f, 4.02f);
        eVar.mo43270f(-0.33f, 0.22f, -0.78f, -0.01f, -0.78f, -0.41f);
        eVar.mo43268d();
