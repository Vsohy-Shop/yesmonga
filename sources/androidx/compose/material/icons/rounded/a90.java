...
public final class a90 {
    ...
    /* renamed from: a */
    public static C15340c f12457a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18618a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12457a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.NetworkPing", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        C15348e eVar2 = eVar;
        eVar2.mo43269e(18.91f, 10.95f, 19.2f, 11.0f, 19.5f, 11.0f);
        eVar2.mo43270f(1.38f, 0.0f, 2.5f, -1.12f, 2.5f, -2.5f);
        eVar.mo43280p(20.88f, 6.0f, 19.5f, 6.0f);
        eVar.mo43280p(17.0f, 7.12f, 17.0f, 8.5f);
        eVar.mo43270f(0.0f, 0.35f, 0.07f, 0.67f, 0.2f, 0.97f);
        eVar.mo43275k(-5.2f, 5.2f);
        eVar.mo43274j(4.12f, 6.79f);
        eVar.mo43269e(3.73f, 6.4f, 3.1f, 6.4f, 2.71f, 6.79f);
        eVar.mo43268d();
