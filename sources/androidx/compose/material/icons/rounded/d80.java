...
public final class d80 {
    ...
    /* renamed from: a */
    public static C15340c f12701a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18862a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12701a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Moving", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43275k(4.18f, -4.17f);
        eVar.mo43275k(1.44f, 1.44f);
        eVar.mo43270f(0.31f, 0.31f, 0.85f, 0.09f, 0.85f, -0.35f);
        eVar.mo43284t(6.5f);
        eVar.mo43269e(22.0f, 6.22f, 21.78f, 6.0f, 21.5f, 6.0f);
        eVar.mo43273i(-4.29f);
        eVar.mo43270f(-0.45f, 0.0f, -0.67f, 0.54f, -0.35f, 0.85f);
        eVar.mo43275k(1.44f, 1.44f);
        eVar.mo43275k(-4.17f, 4.17f);
        eVar.mo43270f(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        eVar.mo43275k(-1.17f, -1.17f);
        eVar.mo43270f(-1.17f, -1.17f, -3.07f, -1.17f, -4.24f, 0.0f);
        eVar.mo43274j(2.7f, 15.88f);
        eVar.mo43269e(2.32f, 16.27f, 2.32f, 16.91f, 2.7f, 17.29f);
        eVar.mo43268d();
