...
/* renamed from: androidx.compose.material.icons.rounded.vf */
public final class C5773vf {
    @C12580l

    /* renamed from: a */
    public static C15340c f14190a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20351a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14190a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.CurrencyYen", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(6.82f, 3.0f);
        eVar.mo43270f(0.34f, 0.0f, 0.66f, 0.17f, 0.84f, 0.46f);
        eVar.mo43274j(12.0f, 10.29f);
        eVar.mo43275k(4.34f, -6.83f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(16.52f, 3.17f, 16.84f, 3.0f, 17.18f, 3.0f);
        eVar2.mo43270f(0.79f, 0.0f, 1.27f, 0.87f, 0.84f, 1.54f);
        eVar.mo43274j(13.92f, 11.0f);
        eVar.mo43272h(17.0f);
        C15348e eVar3 = eVar;
        ...
        eVar.mo43273i(3.08f);
        eVar.mo43274j(5.98f, 4.54f);
        eVar.mo43269e(5.55f, 3.87f, 6.03f, 3.0f, 6.82f, 3.0f);
        eVar.mo43268d();
