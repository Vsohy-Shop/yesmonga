...
public final class xf0 {
    ...
    /* renamed from: a */
    public static C15340c f14355a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20516a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14355a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.PinEnd", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43280p(20.66f, 14.0f, 19.0f, 14.0f);
        eVar.mo43268d();
        eVar.mo43276l(14.66f, 13.66f);
        eVar.mo43270f(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        eVar.mo43275k(-2.12f, -2.12f);
        eVar.mo43275k(1.27f, -1.27f);
        eVar.mo43269e(14.12f, 8.54f, 13.9f, 8.0f, 13.45f, 8.0f);
        eVar.mo43272h(9.5f);
        eVar.mo43269e(9.22f, 8.0f, 9.0f, 8.22f, 9.0f, 8.5f);
        eVar.mo43285u(3.95f);
        eVar.mo43270f(0.0f, 0.45f, 0.54f, 0.67f, 0.85f, 0.35f);
        eVar.mo43275k(1.27f, -1.27f);
        eVar.mo43275k(2.12f, 2.12f);
        eVar.mo43269e(13.63f, 14.05f, 14.27f, 14.05f, 14.66f, 13.66f);
        eVar.mo43268d();
