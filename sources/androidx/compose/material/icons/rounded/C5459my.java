...
/* renamed from: androidx.compose.material.icons.rounded.my */
public final class C5459my {
    @C12580l

    /* renamed from: a */
    public static C15340c f13490a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19651a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13490a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Input", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43281q(-1.0f, 0.45f, -1.0f, 1.0f);
        eVar.mo43285u(3.01f);
        eVar3.mo43270f(0.0f, 1.09f, 0.89f, 1.98f, 1.98f, 1.98f);
        eVar.mo43274j(21.0f, 20.99f);
        eVar.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43274j(23.0f, 5.01f);
        eVar.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar.mo43268d();
        eVar.mo43276l(11.85f, 15.15f);
        eVar.mo43275k(2.79f, -2.79f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.2f, -0.2f, 0.2f, -0.51f, 0.0f, -0.71f);
        eVar.mo43275k(-2.79f, -2.79f);
        eVar4.mo43270f(-0.31f, -0.32f, -0.85f, -0.1f, -0.85f, 0.35f);
        ...
        eVar.mo43273i(9.0f);
        eVar.mo43285u(1.79f);
        eVar.mo43270f(0.0f, 0.45f, 0.54f, 0.67f, 0.85f, 0.36f);
        eVar.mo43268d();
