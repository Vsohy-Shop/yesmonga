...
/* renamed from: androidx.compose.material.icons.rounded.zt */
public final class C5935zt {
    @C12580l

    /* renamed from: a */
    public static C15340c f14546a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20707a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14546a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Gite", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(21.41f, 9.41f);
        eVar.mo43275k(-2.83f, -2.83f);
        eVar.mo43269e(18.21f, 6.21f, 17.7f, 6.0f, 17.17f, 6.0f);
        eVar.mo43272h(9.0f);
        eVar.mo43284t(5.0f);
        eVar.mo43270f(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43280p(7.0f, 4.45f, 7.0f, 5.0f);
        eVar.mo43285u(1.0f);
        eVar.mo43272h(6.83f);
        eVar.mo43269e(6.3f, 6.0f, 5.79f, 6.21f, 5.41f, 6.59f);
        eVar.mo43274j(2.59f, 9.41f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(2.21f, 9.79f, 2.0f, 10.3f, 2.0f, 10.83f);
        eVar.mo43284t(17.0f);
        ...
        eVar.mo43285u(-6.17f);
        eVar3.mo43269e(22.0f, 10.3f, 21.79f, 9.79f, 21.41f, 9.41f);
        eVar.mo43268d();
