...
/* renamed from: androidx.compose.material.icons.rounded.ak */
public final class C5003ak {
    @C12580l

    /* renamed from: a */
    public static C15340c f12479a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18640a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12479a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.DownloadDone", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43281q(0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43268d();
        eVar.mo43276l(11.01f, 13.9f);
        eVar.mo43270f(-0.78f, 0.77f, -2.04f, 0.77f, -2.82f, -0.01f);
        eVar.mo43274j(6.0f, 11.7f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-0.55f, -0.55f, -0.54f, -1.44f, 0.03f, -1.97f);
        eVar2.mo43270f(0.54f, -0.52f, 1.4f, -0.5f, 1.92f, 0.02f);
        eVar.mo43274j(9.6f, 11.4f);
        eVar.mo43275k(6.43f, -6.43f);
        eVar.mo43270f(0.54f, -0.54f, 1.41f, -0.54f, 1.95f, 0.0f);
        eVar.mo43275k(0.04f, 0.04f);
        eVar.mo43270f(0.54f, 0.54f, 0.54f, 1.42f, -0.01f, 1.96f);
        eVar.mo43275k(-7.0f, 6.93f);
        eVar.mo43268d();
