...
/* renamed from: androidx.compose.material.icons.rounded.c8 */
public final class C5064c8 {
    @C12580l

    /* renamed from: a */
    public static C15340c f12618a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18779a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12618a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Brightness2", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(12.43f, 2.3f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-2.38f, -0.59f, -4.68f, -0.27f, -6.63f, 0.64f);
        eVar2.mo43270f(-0.35f, 0.16f, -0.41f, 0.64f, -0.1f, 0.86f);
        eVar2.mo43269e(8.3f, 5.6f, 10.0f, 8.6f, 10.0f, 12.0f);
        eVar2.mo43270f(0.0f, 3.4f, -1.7f, 6.4f, -4.3f, 8.2f);
        eVar2.mo43270f(-0.32f, 0.22f, -0.26f, 0.7f, 0.09f, 0.86f);
        eVar2.mo43270f(1.28f, 0.6f, 2.71f, 0.94f, 4.21f, 0.94f);
        eVar2.mo43270f(6.05f, 0.0f, 10.85f, -5.38f, 9.87f, -11.6f);
        eVar2.mo43270f(-0.61f, -3.92f, -3.59f, -7.16f, -7.44f, -8.1f);
        eVar.mo43268d();
