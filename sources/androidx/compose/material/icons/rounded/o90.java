...
public final class o90 {
    ...
    /* renamed from: a */
    public static C15340c f13605a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19766a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13605a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.NightlightRound", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(15.5f, 22.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.07f, 0.0f, 0.14f, 0.0f, 0.21f, 0.0f);
        eVar2.mo43270f(0.84f, -0.02f, 1.12f, -1.11f, 0.41f, -1.56f);
        eVar2.mo43270f(-2.78f, -1.77f, -4.63f, -4.89f, -4.63f, -8.43f);
        eVar2.mo43270f(0.0f, -3.55f, 1.85f, -6.66f, 4.63f, -8.44f);
        eVar2.mo43270f(0.7f, -0.45f, 0.44f, -1.54f, -0.39f, -1.56f);
        eVar2.mo43270f(-0.04f, 0.0f, -0.09f, 0.0f, -0.13f, 0.0f);
        eVar2.mo43270f(-4.9f, -0.05f, -9.21f, 3.53f, -9.98f, 8.37f);
        eVar2.mo43269e(4.64f, 16.61f, 9.45f, 22.0f, 15.5f, 22.0f);
        eVar.mo43274j(15.5f, 22.0f);
        eVar.mo43268d();
