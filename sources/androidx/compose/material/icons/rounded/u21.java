...
public final class u21 {
    ...
    /* renamed from: a */
    public static C15340c f14077a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20238a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14077a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ViewColumn", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar3.mo43270f(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        eVar.mo43285u(12.0f);
        eVar3.mo43269e(15.67f, 18.55f, 16.11f, 19.0f, 16.67f, 19.0f);
        eVar.mo43268d();
        eVar.mo43276l(8.33f, 18.0f);
        eVar.mo43284t(6.0f);
        eVar.mo43270f(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43272h(4.0f);
        C15348e eVar4 = eVar;
        eVar4.mo43269e(3.45f, 5.0f, 3.0f, 5.45f, 3.0f, 6.0f);
        eVar.mo43285u(12.0f);
        eVar4.mo43270f(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(3.33f);
        eVar4.mo43269e(7.89f, 19.0f, 8.33f, 18.55f, 8.33f, 18.0f);
        eVar.mo43268d();
