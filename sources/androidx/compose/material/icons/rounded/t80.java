...
public final class t80 {
    ...
    /* renamed from: a */
    public static C15340c f14012a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20173a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14012a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.NearMe", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(18.75f, 3.94f);
        eVar.mo43274j(4.07f, 10.08f);
        eVar.mo43270f(-0.83f, 0.35f, -0.81f, 1.53f, 0.02f, 1.85f);
        eVar.mo43274j(9.43f, 14.0f);
        eVar.mo43270f(0.26f, 0.1f, 0.47f, 0.31f, 0.57f, 0.57f);
        eVar.mo43275k(2.06f, 5.33f);
        eVar.mo43270f(0.32f, 0.84f, 1.51f, 0.86f, 1.86f, 0.03f);
        eVar.mo43275k(6.15f, -14.67f);
        eVar.mo43270f(0.33f, -0.83f, -0.5f, -1.66f, -1.32f, -1.32f);
        eVar.mo43268d();
