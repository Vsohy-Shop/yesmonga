...
public final class vp0 {
    ...
    /* renamed from: a */
    public static C15340c f14211a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20372a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14211a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ShowChart", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(4.2f, 17.78f);
        eVar.mo43275k(5.3f, -5.3f);
        eVar.mo43275k(3.25f, 3.25f);
        eVar.mo43270f(0.41f, 0.41f, 1.07f, 0.39f, 1.45f, -0.04f);
        eVar.mo43275k(7.17f, -8.07f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.35f, -0.39f, 0.33f, -0.99f, -0.04f, -1.37f);
        eVar2.mo43270f(-0.4f, -0.4f, -1.07f, -0.39f, -1.45f, 0.04f);
        eVar.mo43275k(-6.39f, 7.18f);
        eVar.mo43275k(-3.29f, -3.29f);
        eVar.mo43270f(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        eVar.mo43275k(-6.09f, 6.1f);
        eVar.mo43270f(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        eVar.mo43275k(0.09f, 0.09f);
