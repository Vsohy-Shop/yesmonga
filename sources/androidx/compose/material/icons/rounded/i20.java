...
public final class i20 {
    ...
    /* renamed from: a */
    public static C15340c f13093a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19254a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13093a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.LocalBar", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(21.0f, 4.45f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.0f, -0.8f, -0.65f, -1.45f, -1.45f, -1.45f);
        eVar.mo43272h(4.45f);
        eVar2.mo43269e(3.65f, 3.0f, 3.0f, 3.65f, 3.0f, 4.45f);
        eVar2.mo43270f(0.0f, 0.35f, 0.13f, 0.7f, 0.37f, 0.96f);
        ...
        eVar.mo43273i(-4.0f);
        eVar.mo43285u(-5.0f);
        eVar.mo43275k(7.63f, -8.59f);
        eVar.mo43270f(0.24f, -0.26f, 0.37f, -0.61f, 0.37f, -0.96f);
        eVar.mo43268d();
        eVar.mo43276l(7.43f, 7.0f);
        eVar.mo43274j(5.66f, 5.0f);
        eVar.mo43273i(12.69f);
