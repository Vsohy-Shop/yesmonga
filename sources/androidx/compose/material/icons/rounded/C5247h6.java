...
/* renamed from: androidx.compose.material.icons.rounded.h6 */
public final class C5247h6 {
    @C12580l

    /* renamed from: a */
    public static C15340c f13022a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19183a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13022a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Bedtime", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(11.65f, 3.46f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.27f, -0.71f, -0.36f, -1.45f, -1.12f, -1.34f);
        eVar2.mo43270f(-5.52f, 0.8f, -9.47f, 6.07f, -8.34f, 11.88f);
        eVar2.mo43270f(0.78f, 4.02f, 4.09f, 7.21f, 8.14f, 7.87f);
        eVar2.mo43270f(3.74f, 0.61f, 7.16f, -0.87f, 9.32f, -3.44f);
        eVar2.mo43270f(0.48f, -0.57f, 0.19f, -1.48f, -0.55f, -1.62f);
        eVar2.mo43269e(13.08f, 15.66f, 9.42f, 9.27f, 11.65f, 3.46f);
        eVar.mo43268d();
