...
/* renamed from: androidx.compose.material.icons.rounded.lo */
public final class C5412lo {
    @C12580l

    /* renamed from: a */
    public static C15340c f13388a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19549a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13388a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Feed", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(7.0f, 7.45f, 7.45f, 7.0f, 8.0f, 7.0f);
        eVar.mo43268d();
        ...
        eVar5.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(0.0f);
        eVar5.mo43269e(17.0f, 12.55f, 16.55f, 13.0f, 16.0f, 13.0f);
        eVar.mo43268d();
        eVar.mo43276l(15.0f, 8.0f);
        eVar.mo43284t(5.0f);
        eVar.mo43275k(4.0f, 4.0f);
        eVar.mo43273i(-3.0f);
        eVar.mo43269e(15.45f, 9.0f, 15.0f, 8.55f, 15.0f, 8.0f);
        eVar.mo43268d();
