...
/* renamed from: androidx.compose.material.icons.rounded.qs */
public final class C5601qs {
    @C12580l

    /* renamed from: a */
    public static C15340c f13806a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19967a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13806a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.FormatQuote", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(7.17f, 17.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.51f, 0.0f, 0.98f, -0.29f, 1.2f, -0.74f);
        eVar.mo43275k(1.42f, -2.84f);
        eVar2.mo43270f(0.14f, -0.28f, 0.21f, -0.58f, 0.21f, -0.89f);
        ...
        eVar.mo43273i(2.0f);
        eVar.mo43275k(-1.03f, 2.06f);
        eVar3.mo43270f(-0.45f, 0.89f, 0.2f, 1.94f, 1.2f, 1.94f);
        eVar.mo43268d();
        eVar.mo43276l(17.17f, 17.0f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.51f, 0.0f, 0.98f, -0.29f, 1.2f, -0.74f);
        eVar.mo43275k(1.42f, -2.84f);
        eVar4.mo43270f(0.14f, -0.28f, 0.21f, -0.58f, 0.21f, -0.89f);
        ...
        eVar.mo43273i(2.0f);
        eVar.mo43275k(-1.03f, 2.06f);
        eVar.mo43270f(-0.45f, 0.89f, 0.2f, 1.94f, 1.2f, 1.94f);
        eVar.mo43268d();
