...
/* renamed from: androidx.compose.material.icons.rounded.p7 */
public final class C5543p7 {
    @C12580l

    /* renamed from: a */
    public static C15340c f13680a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19841a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13680a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.BorderColor", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(22.0f, 23.1f, 21.1f, 24.0f, 20.0f, 24.0f);
        eVar.mo43268d();
        eVar.mo43276l(13.06f, 5.19f);
        eVar.mo43275k(3.75f, 3.75f);
        eVar.mo43275k(-8.77f, 8.77f);
        eVar.mo43269e(7.86f, 17.9f, 7.6f, 18.0f, 7.34f, 18.0f);
        eVar.mo43272h(5.0f);
        eVar.mo43270f(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        eVar.mo43285u(-2.34f);
        eVar.mo43270f(0.0f, -0.27f, 0.11f, -0.52f, 0.29f, -0.71f);
        eVar.mo43274j(13.06f, 5.19f);
        eVar.mo43268d();
        eVar.mo43276l(17.88f, 7.87f);
        eVar.mo43275k(-3.75f, -3.75f);
