...
/* renamed from: androidx.compose.material.icons.rounded.q3 */
public final class C5576q3 {
    @C12580l

    /* renamed from: a */
    public static C15340c f13750a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19911a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13750a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Article", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(5.0f);
        eVar3.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar3.mo43269e(14.0f, 16.55f, 13.55f, 17.0f, 13.0f, 17.0f);
        eVar.mo43268d();
        ...
        eVar.mo43273i(8.0f);
        eVar3.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar3.mo43269e(17.0f, 12.55f, 16.55f, 13.0f, 16.0f, 13.0f);
        eVar.mo43268d();
        eVar.mo43276l(16.0f, 9.0f);
        eVar.mo43272h(8.0f);
        C15348e eVar4 = eVar;
        eVar4.mo43269e(7.45f, 9.0f, 7.0f, 8.55f, 7.0f, 8.0f);
        eVar4.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43273i(8.0f);
        eVar4.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar4.mo43269e(17.0f, 8.55f, 16.55f, 9.0f, 16.0f, 9.0f);
        eVar.mo43268d();
