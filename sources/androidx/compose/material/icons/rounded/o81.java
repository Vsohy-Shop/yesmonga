...
public final class o81 {
    ...
    /* renamed from: a */
    public static C15340c f13603a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19764a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13603a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded._60fpsSelect", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43284t(6.0f);
        eVar2.mo43269e(20.0f, 4.9f, 19.1f, 4.0f, 18.0f, 4.0f);
        eVar.mo43268d();
        ...
        eVar.mo43272h(6.0f);
        eVar3.mo43269e(4.9f, 4.0f, 4.0f, 4.9f, 4.0f, 6.0f);
        eVar.mo43285u(6.0f);
        ...
        eVar.mo43284t(6.0f);
        eVar.mo43273i(4.0f);
        eVar3.mo43269e(10.55f, 6.0f, 11.0f, 5.55f, 11.0f, 5.0f);
        eVar.mo43268d();
        ...
        eVar4.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(3.0f);
        eVar4.mo43269e(5.0f, 21.55f, 4.55f, 22.0f, 4.0f, 22.0f);
        eVar.mo43268d();
        eVar.mo43276l(8.0f, 22.0f);
        ...
        eVar5.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(3.0f);
        eVar5.mo43269e(9.0f, 21.55f, 8.55f, 22.0f, 8.0f, 22.0f);
        eVar.mo43268d();
        ...
        eVar6.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(3.0f);
        eVar6.mo43269e(13.0f, 21.55f, 12.55f, 22.0f, 12.0f, 22.0f);
        eVar.mo43268d();
        ...
        eVar7.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(3.0f);
        eVar7.mo43269e(21.0f, 21.55f, 20.55f, 22.0f, 20.0f, 22.0f);
        eVar.mo43268d();
