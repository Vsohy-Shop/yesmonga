...
public final class d10 {
    ...
    /* renamed from: a */
    public static C15340c f12680a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18841a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12680a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Leaderboard", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar2.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(10.0f);
        eVar2.mo43269e(7.5f, 20.55f, 7.05f, 21.0f, 6.5f, 21.0f);
        eVar.mo43268d();
        eVar.mo43276l(13.75f, 3.0f);
        eVar.mo43273i(-3.5f);
        ...
        eVar.mo43284t(4.0f);
        eVar.mo43269e(14.75f, 3.45f, 14.3f, 3.0f, 13.75f, 3.0f);
        eVar.mo43268d();
        ...
        eVar.mo43285u(-8.0f);
        eVar.mo43269e(22.0f, 11.45f, 21.55f, 11.0f, 21.0f, 11.0f);
        eVar.mo43268d();
