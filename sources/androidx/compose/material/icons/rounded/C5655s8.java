...
/* renamed from: androidx.compose.material.icons.rounded.s8 */
public final class C5655s8 {
    @C12580l

    /* renamed from: a */
    public static C15340c f13929a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20090a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13929a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.BrunchDining", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43284t(8.0f);
        eVar.mo43268d();
        eVar.mo43276l(15.0f, 22.0f);
        eVar.mo43272h(3.0f);
        eVar.mo43270f(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        eVar.mo43285u(-1.0f);
        eVar.mo43273i(14.0f);
        eVar.mo43285u(1.0f);
        eVar.mo43269e(16.0f, 21.55f, 15.55f, 22.0f, 15.0f, 22.0f);
        eVar.mo43268d();
        eVar.mo43276l(18.0f, 15.89f);
        eVar.mo43275k(-0.4f, -0.42f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-1.03f, -1.08f, -1.6f, -2.51f, -1.6f, -4.0f);
        eVar.mo43284t(3.0f);
        eVar2.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43273i(4.0f);
        eVar2.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(8.51f);
        eVar.mo43270f(0.0f, 1.46f, -0.54f, 2.87f, -1.53f, 3.94f);
        eVar.mo43274j(20.0f, 15.97f);
        eVar.mo43284t(20.0f);
        eVar.mo43273i(1.0f);
        eVar.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(0.0f);
