...
public final class cm0 {
    ...
    /* renamed from: a */
    public static C15340c f12648a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18809a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12648a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.RvHookup", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(-0.74f);
        eVar.mo43270f(0.0f, -0.46f, -0.56f, -0.7f, -0.89f, -0.37f);
        eVar.mo43274j(4.37f, 9.63f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-0.2f, 0.2f, -0.2f, 0.53f, 0.0f, 0.74f);
        eVar.mo43275k(1.74f, 1.74f);
        eVar2.mo43270f(0.33f, 0.33f, 0.89f, 0.1f, 0.89f, -0.37f);
        ...
        eVar.mo43275k(1.74f, -1.74f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.2f, -0.2f, 0.2f, -0.53f, 0.0f, -0.74f);
        eVar.mo43275k(-1.74f, -1.74f);
        eVar4.mo43270f(-0.33f, -0.33f, -0.89f, -0.1f, -0.89f, 0.37f);
