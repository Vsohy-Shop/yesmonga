...
/* renamed from: androidx.compose.material.icons.rounded.ce */
public final class C5070ce {
    @C12580l

    /* renamed from: a */
    public static C15340c f12631a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18792a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12631a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ContentCopy", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(0.0f);
        eVar2.mo43269e(3.45f, 6.0f, 3.0f, 6.45f, 3.0f, 7.0f);
        eVar.mo43285u(13.0f);
        ...
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(16.0f, 20.45f, 15.55f, 20.0f, 15.0f, 20.0f);
        eVar.mo43268d();
        eVar.mo43276l(20.0f, 16.0f);
        eVar.mo43284t(4.0f);
        eVar3.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar.mo43272h(9.0f);
        eVar3.mo43269e(7.9f, 2.0f, 7.0f, 2.9f, 7.0f, 4.0f);
        eVar.mo43285u(12.0f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(9.0f);
        eVar4.mo43269e(19.1f, 18.0f, 20.0f, 17.1f, 20.0f, 16.0f);
        eVar.mo43268d();
