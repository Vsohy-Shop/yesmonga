...
/* renamed from: androidx.compose.material.icons.rounded.ip */
public final class C5303ip {
    @C12580l

    /* renamed from: a */
    public static C15340c f13145a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19306a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13145a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Filter7", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar4.mo43270f(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        eVar.mo43268d();
        eVar.mo43276l(13.25f, 14.51f);
        eVar.mo43275k(3.58f, -7.17f);
        C15348e eVar5 = eVar;
        eVar5.mo43270f(0.11f, -0.22f, 0.17f, -0.47f, 0.17f, -0.72f);
        eVar5.mo43270f(0.0f, -0.9f, -0.72f, -1.62f, -1.62f, -1.62f);
        eVar.mo43274j(12.0f, 5.0f);
        eVar5.mo43270f(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        eVar.mo43281q(0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(3.0f);
        eVar.mo43275k(-3.36f, 6.71f);
        eVar.mo43270f(-0.3f, 0.59f, 0.13f, 1.29f, 0.8f, 1.29f);
        eVar.mo43273i(0.01f);
        eVar.mo43270f(0.34f, 0.0f, 0.65f, -0.19f, 0.8f, -0.49f);
        eVar.mo43268d();
