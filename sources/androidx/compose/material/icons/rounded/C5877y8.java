...
/* renamed from: androidx.compose.material.icons.rounded.y8 */
public final class C5877y8 {
    @C12580l

    /* renamed from: a */
    public static C15340c f14421a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20582a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14421a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Bungalow", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43270f(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        eVar.mo43285u(-5.21f);
        eVar.mo43275k(0.57f, 0.92f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.29f, 0.47f, 0.91f, 0.61f, 1.38f, 0.32f);
        eVar2.mo43270f(0.47f, -0.29f, 0.61f, -0.91f, 0.32f, -1.38f);
        eVar.mo43274j(12.85f, 4.36f);
        eVar.mo43270f(-0.39f, -0.63f, -1.31f, -0.63f, -1.7f, 0.0f);
        eVar.mo43274j(4.73f, 14.65f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-0.29f, 0.47f, -0.15f, 1.09f, 0.32f, 1.38f);
        eVar3.mo43270f(0.47f, 0.29f, 1.08f, 0.15f, 1.38f, -0.32f);
        eVar.mo43274j(7.0f, 14.8f);
        eVar.mo43284t(20.0f);
        eVar.mo43270f(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        eVar.mo43273i(3.0f);
        eVar.mo43285u(-4.0f);
        C15348e eVar4 = eVar;
        eVar4.mo43269e(11.0f, 16.45f, 11.45f, 16.0f, 12.0f, 16.0f);
        eVar.mo43268d();
        ...
        eVar.mo43280p(13.0f, 12.45f, 13.0f, 13.0f);
        eVar.mo43268d();
