...
public final class ro0 {
    ...
    /* renamed from: a */
    public static C15340c f13881a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20042a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13881a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.SettingsCell", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar3.mo43270f(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(15.0f, 23.55f, 15.45f, 24.0f, 16.0f, 24.0f);
        eVar.mo43268d();
        eVar.mo43276l(16.0f, 0.01f);
        eVar.mo43274j(8.0f, 0.0f);
        eVar3.mo43269e(6.9f, 0.0f, 6.0f, 0.9f, 6.0f, 2.0f);
        eVar.mo43285u(16.0f);
        eVar3.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(8.0f);
        eVar3.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43284t(2.0f);
        eVar3.mo43269e(18.0f, 0.9f, 17.1f, 0.01f, 16.0f, 0.01f);
        eVar.mo43268d();
