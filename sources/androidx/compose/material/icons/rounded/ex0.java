...
public final class ex0 {
    ...
    /* renamed from: a */
    public static C15340c f12834a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18995a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12834a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.TableView", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(9.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(7.9f, 7.0f, 7.0f, 7.9f, 7.0f, 9.0f);
        eVar.mo43285u(10.0f);
        eVar2.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(10.0f);
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43284t(9.0f);
        eVar2.mo43269e(21.0f, 7.9f, 20.1f, 7.0f, 19.0f, 7.0f);
        eVar.mo43268d();
        ...
        eVar.mo43273i(8.0f);
        eVar.mo43269e(18.55f, 9.0f, 19.0f, 9.45f, 19.0f, 10.0f);
        eVar.mo43268d();
