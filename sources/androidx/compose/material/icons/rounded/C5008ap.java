...
/* renamed from: androidx.compose.material.icons.rounded.ap */
public final class C5008ap {
    @C12580l

    /* renamed from: a */
    public static C15340c f12489a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18650a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12489a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.FilePresent", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        C15348e eVar3 = eVar;
        eVar3.mo43269e(14.21f, 2.21f, 13.7f, 2.0f, 13.17f, 2.0f);
        eVar.mo43268d();
        eVar.mo43276l(16.0f, 15.0f);
        eVar3.mo43270f(0.0f, 2.34f, -2.01f, 4.21f, -4.39f, 3.98f);
        eVar3.mo43269e(9.53f, 18.78f, 8.0f, 16.92f, 8.0f, 14.83f);
        eVar.mo43275k(0.0f, -5.19f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.0f, -1.31f, 0.94f, -2.5f, 2.24f, -2.63f);
        eVar4.mo43269e(11.74f, 6.86f, 13.0f, 8.03f, 13.0f, 9.5f);
        eVar.mo43284t(14.0f);
        eVar4.mo43270f(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        eVar.mo43273i(0.0f);
        eVar4.mo43270f(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        eVar.mo43284t(9.5f);
        eVar4.mo43269e(11.0f, 9.22f, 10.78f, 9.0f, 10.5f, 9.0f);
        eVar.mo43280p(10.0f, 9.22f, 10.0f, 9.5f);
        eVar.mo43285u(5.39f);
        C15348e eVar5 = eVar;
        eVar5.mo43270f(0.0f, 1.0f, 0.68f, 1.92f, 1.66f, 2.08f);
        eVar5.mo43269e(12.92f, 17.18f, 14.0f, 16.21f, 14.0f, 15.0f);
        eVar.mo43285u(-3.0f);
        ...
        eVar.mo43273i(-3.0f);
        eVar.mo43269e(14.45f, 8.0f, 14.0f, 7.55f, 14.0f, 7.0f);
        eVar.mo43268d();
