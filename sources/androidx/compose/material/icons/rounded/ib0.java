...
public final class ib0 {
    ...
    /* renamed from: a */
    public static C15340c f13118a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19279a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13118a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.OndemandVideo", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43268d();
        eVar.mo43276l(14.48f, 11.87f);
        eVar.mo43275k(-3.98f, 2.28f);
        eVar.mo43270f(-0.67f, 0.38f, -1.5f, -0.11f, -1.5f, -0.87f);
        eVar.mo43274j(9.0f, 8.72f);
        eVar.mo43270f(0.0f, -0.77f, 0.83f, -1.25f, 1.5f, -0.87f);
        eVar.mo43275k(3.98f, 2.28f);
        eVar.mo43270f(0.67f, 0.39f, 0.67f, 1.35f, 0.0f, 1.74f);
        eVar.mo43268d();
