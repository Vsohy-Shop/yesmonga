...
/* renamed from: androidx.compose.material.icons.rounded.uh */
public final class C5738uh {
    @C12580l

    /* renamed from: a */
    public static C15340c f14112a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20273a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14112a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Difference", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43284t(8.0f);
        eVar2.mo43269e(2.0f, 7.45f, 2.45f, 7.0f, 3.0f, 7.0f);
        eVar.mo43268d();
        eVar.mo43276l(15.59f, 1.59f);
        eVar2.mo43269e(15.21f, 1.21f, 14.7f, 1.0f, 14.17f, 1.0f);
        eVar.mo43272h(8.0f);
        eVar2.mo43269e(6.9f, 1.0f, 6.01f, 1.9f, 6.01f, 3.0f);
        ...
        eVar3.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(16.5f, 14.55f, 16.05f, 15.0f, 15.5f, 15.0f);
        eVar.mo43268d();
        ...
        eVar3.mo43270f(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(16.5f, 8.55f, 16.05f, 9.0f, 15.5f, 9.0f);
        eVar.mo43268d();
