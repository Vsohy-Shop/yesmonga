...
/* renamed from: androidx.compose.material.icons.rounded.i3 */
public final class C5281i3 {
    @C12580l

    /* renamed from: a */
    public static C15340c f13095a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19256a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13095a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ArrowForwardIos", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(7.38f, 21.01f);
        eVar.mo43270f(0.49f, 0.49f, 1.28f, 0.49f, 1.77f, 0.0f);
        eVar.mo43275k(8.31f, -8.31f);
        eVar.mo43270f(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        eVar.mo43274j(9.15f, 2.98f);
        eVar.mo43270f(-0.49f, -0.49f, -1.28f, -0.49f, -1.77f, 0.0f);
        eVar.mo43281q(-0.49f, 1.28f, 0.0f, 1.77f);
        eVar.mo43274j(14.62f, 12.0f);
        eVar.mo43275k(-7.25f, 7.25f);
        eVar.mo43270f(-0.48f, 0.48f, -0.48f, 1.28f, 0.01f, 1.76f);
        eVar.mo43268d();
