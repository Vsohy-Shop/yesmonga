...
public final class qi0 {
    ...
    /* renamed from: a */
    public static C15340c f13787a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19948a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13787a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.RMobiledata", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(7.8f, 7.2f);
        eVar.mo43275k(0.65f, 1.52f);
        eVar.mo43269e(8.71f, 9.33f, 8.27f, 10.0f, 7.61f, 10.0f);
        eVar.mo43273i(0.0f);
        eVar.mo43270f(-0.37f, 0.0f, -0.7f, -0.22f, -0.85f, -0.56f);
        eVar.mo43274j(5.87f, 7.33f);
        eVar.mo43272h(4.0f);
        eVar.mo43285u(1.75f);
        eVar.mo43269e(4.0f, 9.59f, 3.59f, 10.0f, 3.08f, 10.0f);
        eVar.mo43272h(2.92f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(2.41f, 10.0f, 2.0f, 9.59f, 2.0f, 9.08f);
        eVar.mo43284t(3.0f);
        eVar2.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43273i(4.0f);
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        eVar.mo43285u(1.33f);
        eVar2.mo43269e(9.0f, 6.13f, 8.47f, 6.87f, 7.8f, 7.2f);
        eVar.mo43268d();
