...
public final class ar0 {
    ...
    /* renamed from: a */
    public static C15340c f12494a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18655a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12494a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.SingleBed", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(8.0f);
        eVar2.mo43269e(6.9f, 5.0f, 6.0f, 5.9f, 6.0f, 7.0f);
        eVar.mo43285u(3.0f);
        ...
        C15348e eVar3 = eVar;
        eVar3.mo43269e(5.94f, 18.81f, 6.2f, 19.0f, 6.5f, 19.0f);
        eVar.mo43273i(0.0f);
        eVar3.mo43270f(0.3f, 0.0f, 0.56f, -0.19f, 0.66f, -0.47f);
        eVar.mo43274j(7.67f, 17.0f);
        eVar.mo43273i(8.67f);
        eVar.mo43275k(0.51f, 1.53f);
        C15348e eVar4 = eVar;
        eVar4.mo43269e(16.94f, 18.81f, 17.2f, 19.0f, 17.5f, 19.0f);
        eVar.mo43275k(0.0f, 0.0f);
        eVar4.mo43270f(0.3f, 0.0f, 0.56f, -0.19f, 0.66f, -0.47f);
        eVar.mo43274j(18.67f, 17.0f);
        eVar.mo43272h(20.0f);
        eVar.mo43285u(-5.0f);
        eVar.mo43269e(20.0f, 10.9f, 19.1f, 10.0f, 18.0f, 10.0f);
        eVar.mo43268d();
