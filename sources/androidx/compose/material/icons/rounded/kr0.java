...
public final class kr0 {
    ...
    /* renamed from: a */
    public static C15340c f13313a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19474a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13313a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.SmartScreen", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(3.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(1.9f, 5.0f, 1.0f, 5.9f, 1.0f, 7.0f);
        eVar.mo43285u(10.0f);
        eVar2.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(18.0f);
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43284t(7.0f);
        eVar2.mo43269e(23.0f, 5.9f, 22.1f, 5.0f, 21.0f, 5.0f);
        eVar.mo43268d();
        ...
        eVar.mo43280p(12.5f, 11.59f, 12.5f, 12.0f);
        eVar.mo43281q(0.34f, 0.75f, 0.75f, 0.75f);
        eVar.mo43280p(14.0f, 12.41f, 14.0f, 12.0f);
        eVar.mo43268d();
        eVar.mo43276l(9.0f, 12.0f);
        eVar.mo43270f(0.0f, -0.41f, -0.34f, -0.75f, -0.75f, -0.75f);
        eVar.mo43280p(7.5f, 11.59f, 7.5f, 12.0f);
        eVar.mo43281q(0.34f, 0.75f, 0.75f, 0.75f);
        eVar.mo43280p(9.0f, 12.41f, 9.0f, 12.0f);
        eVar.mo43268d();
        eVar.mo43276l(16.5f, 12.0f);
        eVar.mo43270f(0.0f, -0.41f, -0.34f, -0.75f, -0.75f, -0.75f);
        eVar.mo43280p(15.0f, 11.59f, 15.0f, 12.0f);
        eVar.mo43281q(0.34f, 0.75f, 0.75f, 0.75f);
        eVar.mo43280p(16.5f, 12.41f, 16.5f, 12.0f);
        eVar.mo43268d();
        eVar.mo43276l(11.5f, 12.0f);
        eVar.mo43270f(0.0f, -0.41f, -0.34f, -0.75f, -0.75f, -0.75f);
        eVar.mo43280p(10.0f, 11.59f, 10.0f, 12.0f);
        eVar.mo43281q(0.34f, 0.75f, 0.75f, 0.75f);
        eVar.mo43280p(11.5f, 12.41f, 11.5f, 12.0f);
        eVar.mo43268d();
