...
public final class w80 {
    ...
    /* renamed from: a */
    public static C15340c f14258a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20419a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14258a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.NestCamWiredStand", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(15.83f, 1.01f);
        eVar.mo43275k(-4.11f, 0.42f);
        eVar.mo43269e(8.47f, 1.75f, 6.0f, 4.48f, 6.0f, 7.75f);
        eVar.mo43281q(2.47f, 6.0f, 5.72f, 6.33f);
        eVar.mo43275k(1.9f, 0.19f);
        eVar.mo43275k(-0.56f, 0.85f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(12.71f, 15.04f, 12.36f, 15.0f, 12.0f, 15.0f);
        ...
        eVar.mo43285u(-2.0f);
        eVar.mo43270f(0.0f, -1.67f, -0.83f, -3.15f, -2.09f, -4.06f);
        eVar.mo43275k(0.97f, -1.45f);
        eVar.mo43269e(17.02f, 14.56f, 18.0f, 13.66f, 18.0f, 12.5f);
        eVar.mo43284t(3.0f);
        eVar.mo43269e(18.0f, 1.83f, 17.0f, 0.91f, 15.83f, 1.01f);
        eVar.mo43268d();
