...
/* renamed from: androidx.compose.material.icons.rounded.r2 */
public final class C5612r2 {
    @C12580l

    /* renamed from: a */
    public static C15340c f13829a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19990a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13829a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Approval", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(6.0f);
        eVar.mo43269e(4.9f, 14.0f, 4.0f, 14.9f, 4.0f, 16.0f);
        eVar.mo43268d();
        ...
        eVar.mo43285u(0.0f);
        eVar4.mo43269e(18.0f, 17.55f, 17.55f, 18.0f, 17.0f, 18.0f);
        eVar.mo43268d();
        eVar.mo43276l(12.0f, 2.0f);
        C15348e eVar5 = eVar;
        eVar5.mo43269e(9.54f, 2.0f, 7.48f, 3.79f, 7.07f, 6.13f);
        eVar5.mo43269e(6.99f, 6.65f, 7.13f, 7.18f, 7.43f, 7.6f);
        eVar.mo43275k(3.76f, 5.26f);
        eVar.mo43270f(0.4f, 0.56f, 1.23f, 0.56f, 1.63f, 0.0f);
        eVar.mo43275k(3.76f, -5.26f);
        C15348e eVar6 = eVar;
        eVar6.mo43270f(0.3f, -0.42f, 0.44f, -0.95f, 0.35f, -1.47f);
        eVar6.mo43269e(16.52f, 3.79f, 14.46f, 2.0f, 12.0f, 2.0f);
        eVar.mo43268d();
