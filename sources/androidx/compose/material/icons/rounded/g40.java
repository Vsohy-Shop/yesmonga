...
public final class g40 {
    ...
    /* renamed from: a */
    public static C15340c f12935a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19096a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12935a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.LowPriority", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43281q(0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43268d();
        eVar.mo43276l(9.85f, 19.15f);
        eVar.mo43275k(1.79f, -1.79f);
        C15348e eVar5 = eVar;
        eVar5.mo43270f(0.2f, -0.2f, 0.2f, -0.51f, 0.0f, -0.71f);
        eVar.mo43275k(-1.79f, -1.79f);
        eVar5.mo43270f(-0.31f, -0.32f, -0.85f, -0.1f, -0.85f, 0.35f);
        eVar.mo43285u(3.59f);
        eVar.mo43270f(0.0f, 0.44f, 0.54f, 0.66f, 0.85f, 0.35f);
        eVar.mo43268d();
        eVar.mo43276l(9.0f, 16.0f);
        eVar.mo43273i(-0.3f);
        C15348e eVar6 = eVar;
        eVar6.mo43270f(-2.35f, 0.0f, -4.45f, -1.71f, -4.68f, -4.05f);
        eVar6.mo43269e(3.76f, 9.27f, 5.87f, 7.0f, 8.5f, 7.0f);
        eVar.mo43274j(11.0f, 7.0f);
        eVar.mo43270f(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        eVar.mo43281q(-0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43274j(8.5f, 5.0f);
        C15348e eVar7 = eVar;
        eVar7.mo43270f(-3.86f, 0.0f, -6.96f, 3.4f, -6.44f, 7.36f);
        eVar7.mo43269e(2.48f, 15.64f, 5.43f, 18.0f, 8.73f, 18.0f);
        eVar.mo43274j(9.0f, 18.0f);
