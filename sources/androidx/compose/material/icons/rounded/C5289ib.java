...
/* renamed from: androidx.compose.material.icons.rounded.ib */
public final class C5289ib {
    @C12580l

    /* renamed from: a */
    public static C15340c f13117a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19278a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13117a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.ChangeHistory", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(12.0f, 7.77f);
        eVar.mo43274j(18.39f, 18.0f);
        eVar.mo43272h(5.61f);
        eVar.mo43274j(12.0f, 7.77f);
        eVar.mo43277m(-0.85f, -2.41f);
        eVar.mo43275k(-8.2f, 13.11f);
        eVar.mo43270f(-0.41f, 0.67f, 0.07f, 1.53f, 0.85f, 1.53f);
        eVar.mo43273i(16.4f);
        eVar.mo43270f(0.79f, 0.0f, 1.26f, -0.86f, 0.85f, -1.53f);
        eVar.mo43275k(-8.2f, -13.11f);
