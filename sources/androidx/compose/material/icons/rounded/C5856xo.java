...
/* renamed from: androidx.compose.material.icons.rounded.xo */
public final class C5856xo {
    @C12580l

    /* renamed from: a */
    public static C15340c f14372a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m20533a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f14372a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.FileDownload", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(16.59f, 9.0f);
        eVar.mo43272h(15.0f);
        eVar.mo43284t(4.0f);
        eVar.mo43270f(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        eVar.mo43273i(-4.0f);
        eVar.mo43269e(9.45f, 3.0f, 9.0f, 3.45f, 9.0f, 4.0f);
        eVar.mo43285u(5.0f);
        eVar.mo43272h(7.41f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-0.89f, 0.0f, -1.34f, 1.08f, -0.71f, 1.71f);
        eVar.mo43275k(4.59f, 4.59f);
        eVar2.mo43270f(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        eVar.mo43275k(4.59f, -4.59f);
        eVar.mo43269e(17.92f, 10.08f, 17.48f, 9.0f, 16.59f, 9.0f);
        eVar.mo43268d();
        ...
        eVar.mo43272h(6.0f);
        eVar.mo43269e(5.45f, 18.0f, 5.0f, 18.45f, 5.0f, 19.0f);
        eVar.mo43268d();
