...
public final class j50 {
    ...
    /* renamed from: a */
    public static C15340c f13183a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19344a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13183a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.Markunread", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43275k(-6.54f, 4.09f);
        eVar.mo43270f(-0.65f, 0.41f, -1.47f, 0.41f, -2.12f, 0.0f);
        eVar.mo43274j(4.4f, 8.25f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(-0.25f, -0.16f, -0.4f, -0.43f, -0.4f, -0.72f);
        eVar3.mo43270f(0.0f, -0.67f, 0.73f, -1.07f, 1.3f, -0.72f);
        eVar.mo43274j(12.0f, 11.0f);
        eVar.mo43275k(6.7f, -4.19f);
        C15348e eVar4 = eVar;
        eVar4.mo43270f(0.57f, -0.35f, 1.3f, 0.05f, 1.3f, 0.72f);
        eVar4.mo43270f(0.0f, 0.29f, -0.15f, 0.56f, -0.4f, 0.72f);
        eVar.mo43268d();
