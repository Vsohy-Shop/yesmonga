...
/* renamed from: androidx.compose.material.icons.rounded.k9 */
public final class C5360k9 {
    @C12580l

    /* renamed from: a */
    public static C15340c f13276a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m19437a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f13276a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.CalendarViewDay", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43284t(9.0f);
        eVar.mo43269e(3.0f, 7.9f, 3.9f, 7.0f, 5.0f, 7.0f);
        eVar.mo43268d();
        ...
        eVar.mo43272h(4.0f);
        eVar3.mo43269e(3.45f, 5.0f, 3.0f, 4.55f, 3.0f, 4.0f);
        eVar.mo43285u(0.0f);
        eVar3.mo43269e(3.0f, 3.45f, 3.45f, 3.0f, 4.0f, 3.0f);
        eVar.mo43268d();
        ...
        eVar4.mo43270f(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        eVar.mo43285u(0.0f);
        eVar4.mo43269e(3.0f, 19.45f, 3.45f, 19.0f, 4.0f, 19.0f);
        eVar.mo43268d();
