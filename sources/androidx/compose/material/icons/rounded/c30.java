...
public final class c30 {
    ...
    /* renamed from: a */
    public static C15340c f12604a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18765a(@C12579k C3053a.C3056c cVar) {
        Intrinsics.checkNotNullParameter(cVar, "<this>");
        C15340c cVar2 = f12604a;
        if (cVar2 != null) {
            Intrinsics.checkNotNull(cVar2);
            return cVar2;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Rounded.LocalPizza", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        C15348e eVar2 = eVar;
        eVar2.mo43269e(9.01f, 2.0f, 6.28f, 3.08f, 4.17f, 4.88f);
        eVar2.mo43270f(-0.71f, 0.61f, -0.86f, 1.65f, -0.4f, 2.46f);
        eVar.mo43275k(7.36f, 13.11f);
        eVar.mo43270f(0.38f, 0.68f, 1.36f, 0.68f, 1.74f, 0.0f);
        eVar.mo43275k(7.36f, -13.11f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(0.46f, -0.81f, 0.31f, -1.86f, -0.4f, -2.46f);
        eVar3.mo43269e(17.73f, 3.09f, 14.99f, 2.0f, 12.0f, 2.0f);
        eVar.mo43268d();
