...
public final class e51 {
    ...
    /* renamed from: a */
    public static C15340c f8511a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m14672a(@C12579k C3053a.C3054a aVar) {
        ...
        C15340c.C15341a aVar3 = new C15340c.C15341a("Filled.Weekend", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(-5.0f);
        eVar.mo43269e(23.0f, 10.9f, 22.1f, 10.0f, 21.0f, 10.0f);
        eVar.mo43268d();
        eVar.mo43276l(18.0f, 5.0f);
        eVar.mo43272h(6.0f);
        eVar.mo43269e(4.9f, 5.0f, 4.0f, 5.9f, 4.0f, 7.0f);
        eVar.mo43285u(2.15f);
        eVar.mo43270f(1.16f, 0.41f, 2.0f, 1.52f, 2.0f, 2.81f);
        eVar.mo43284t(14.0f);
        eVar.mo43273i(12.0f);
        eVar.mo43285u(-2.03f);
        eVar.mo43270f(0.0f, -1.3f, 0.84f, -2.4f, 2.0f, -2.81f);
        eVar.mo43284t(7.0f);
        eVar.mo43269e(20.0f, 5.9f, 19.1f, 5.0f, 18.0f, 5.0f);
        eVar.mo43268d();
