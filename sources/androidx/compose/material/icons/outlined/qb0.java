...
public final class qb0 {
    ...
    /* renamed from: a */
    public static C15340c f11641a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17802a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11641a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.OtherHouses", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar2.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43280p(9.0f, 13.45f, 9.0f, 14.0f);
        eVar.mo43268d();
        ...
        eVar.mo43281q(-1.0f, -0.45f, -1.0f, -1.0f);
        eVar3.mo43269e(11.0f, 13.45f, 11.45f, 13.0f, 12.0f, 13.0f);
        eVar.mo43268d();
        eVar.mo43276l(15.0f, 14.0f);
        eVar3.mo43270f(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        eVar.mo43281q(1.0f, 0.45f, 1.0f, 1.0f);
        eVar.mo43270f(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        eVar.mo43280p(15.0f, 14.55f, 15.0f, 14.0f);
        eVar.mo43268d();
