...
/* renamed from: androidx.compose.material.icons.outlined.sp */
public final class C4712sp {
    @C12580l

    /* renamed from: a */
    public static C15340c f11832a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17993a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11832a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.FilterHdr", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43275k(-4.22f, 5.63f);
        eVar.mo43275k(1.25f, 1.67f);
        eVar.mo43274j(14.0f, 9.33f);
        eVar.mo43274j(19.0f, 16.0f);
        eVar.mo43273i(-8.46f);
        eVar.mo43275k(-4.01f, -5.37f);
        eVar.mo43274j(1.0f, 18.0f);
        eVar.mo43273i(22.0f);
        eVar.mo43274j(14.0f, 6.0f);
        eVar.mo43268d();
        eVar.mo43276l(5.0f, 16.0f);
        eVar.mo43275k(1.52f, -2.03f);
        eVar.mo43274j(8.04f, 16.0f);
        eVar.mo43272h(5.0f);
        eVar.mo43268d();
