...
public final class sq0 {
    ...
    /* renamed from: a */
    public static C15340c f11835a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17996a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11835a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.SignalWifiOff", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar2.mo43270f(-1.32f, 0.0f, -2.55f, 0.14f, -3.69f, 0.38f);
        eVar.mo43274j(18.43f, 13.5f);
        eVar.mo43274j(23.64f, 7.0f);
        eVar.mo43268d();
        eVar.mo43276l(3.41f, 1.31f);
        eVar.mo43274j(2.0f, 2.72f);
        eVar.mo43275k(2.05f, 2.05f);
        eVar.mo43269e(1.91f, 5.76f, 0.59f, 6.82f, 0.36f, 7.0f);
        eVar.mo43274j(12.0f, 21.5f);
        eVar.mo43275k(3.91f, -4.87f);
        eVar.mo43275k(3.32f, 3.32f);
        eVar.mo43275k(1.41f, -1.41f);
        eVar.mo43274j(3.41f, 1.31f);
        eVar.mo43268d();
