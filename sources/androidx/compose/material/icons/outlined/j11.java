...
public final class j11 {
    ...
    /* renamed from: a */
    public static C15340c f11040a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17201a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11040a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Upcoming", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(17.6f, 10.81f);
        eVar.mo43274j(16.19f, 9.4f);
        eVar.mo43275k(3.56f, -3.55f);
        eVar.mo43275k(1.41f, 1.41f);
        eVar.mo43269e(21.05f, 7.29f, 17.6f, 10.81f, 17.6f, 10.81f);
        eVar.mo43268d();
        ...
        eVar.mo43284t(3.0f);
        eVar.mo43268d();
        eVar.mo43276l(6.4f, 10.81f);
        eVar.mo43274j(7.81f, 9.4f);
        eVar.mo43274j(4.26f, 5.84f);
        eVar.mo43274j(2.84f, 7.26f);
        eVar.mo43269e(2.95f, 7.29f, 6.4f, 10.81f, 6.4f, 10.81f);
        eVar.mo43268d();
        eVar.mo43276l(20.0f, 14.0f);
        eVar.mo43273i(-3.42f);
        eVar.mo43270f(-0.77f, 1.76f, -2.54f, 3.0f, -4.58f, 3.0f);
        eVar.mo43281q(-3.81f, -1.24f, -4.58f, -3.0f);
        eVar.mo43272h(4.0f);
        eVar.mo43285u(5.0f);
        eVar.mo43273i(16.0f);
        eVar.mo43284t(14.0f);
