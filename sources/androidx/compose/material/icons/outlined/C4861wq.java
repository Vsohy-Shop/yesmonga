...
/* renamed from: androidx.compose.material.icons.outlined.wq */
public final class C4861wq {
    @C12580l

    /* renamed from: a */
    public static C15340c f12162a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18323a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f12162a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.FlightLand", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(-2.0f);
        eVar.mo43268d();
        eVar.mo43276l(19.34f, 15.85f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.8f, 0.21f, 1.62f, -0.26f, 1.84f, -1.06f);
        eVar2.mo43270f(0.21f, -0.8f, -0.26f, -1.62f, -1.06f, -1.84f);
        eVar.mo43275k(-5.31f, -1.42f);
        eVar.mo43275k(-2.76f, -9.02f);
        eVar.mo43274j(10.12f, 2.0f);
        eVar.mo43285u(8.28f);
        eVar.mo43274j(5.15f, 8.95f);
        eVar.mo43275k(-0.93f, -2.32f);
        eVar.mo43275k(-1.45f, -0.39f);
        eVar.mo43285u(5.17f);
        eVar.mo43275k(16.57f, 4.44f);
        eVar.mo43268d();
