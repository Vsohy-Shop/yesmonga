...
/* renamed from: androidx.compose.material.icons.outlined.jk */
public final class C4374jk {
    @C12580l

    /* renamed from: a */
    public static C15340c f11084a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17245a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11084a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.DriveFileMove", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43274j(11.17f, 8.0f);
        eVar.mo43272h(20.0f);
        eVar.mo43284t(18.0f);
        eVar.mo43268d();
        eVar.mo43276l(12.16f, 12.0f);
        eVar.mo43272h(8.0f);
        eVar.mo43285u(2.0f);
        eVar.mo43273i(4.16f);
        eVar.mo43275k(-1.59f, 1.59f);
        eVar.mo43274j(11.99f, 17.0f);
        eVar.mo43274j(16.0f, 13.01f);
        eVar.mo43274j(11.99f, 9.0f);
        eVar.mo43275k(-1.41f, 1.41f);
        eVar.mo43274j(12.16f, 12.0f);
        eVar.mo43268d();
