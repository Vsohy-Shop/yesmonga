...
public final class vh0 {
    ...
    /* renamed from: a */
    public static C15340c f12063a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18224a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f12063a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.PropaneTank", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(17.0f, 6.14f);
        eVar.mo43284t(4.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar.mo43272h(9.0f);
        eVar2.mo43269e(7.9f, 2.0f, 7.0f, 2.9f, 7.0f, 4.0f);
        eVar.mo43285u(2.14f);
        C15348e eVar3 = eVar;
        ...
        eVar.mo43285u(-8.0f);
        eVar.mo43269e(20.0f, 8.14f, 18.72f, 6.59f, 17.0f, 6.14f);
        eVar.mo43268d();
        ...
        eVar.mo43272h(6.0f);
        eVar.mo43285u(-3.0f);
        eVar4.mo43269e(6.0f, 8.9f, 6.9f, 8.0f, 8.0f, 8.0f);
        eVar.mo43268d();
        ...
        eVar.mo43273i(12.0f);
        eVar.mo43285u(3.0f);
        eVar.mo43269e(18.0f, 19.1f, 17.1f, 20.0f, 16.0f, 20.0f);
        eVar.mo43268d();
