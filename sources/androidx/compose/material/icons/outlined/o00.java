...
public final class o00 {
    ...
    /* renamed from: a */
    public static C15340c f11446a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17607a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11446a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.LabelImportant", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(4.0f, 18.99f);
        eVar.mo43273i(11.0f);
        eVar.mo43270f(0.67f, 0.0f, 1.27f, -0.32f, 1.63f, -0.83f);
        eVar.mo43274j(21.0f, 12.0f);
        eVar.mo43275k(-4.37f, -6.16f);
        eVar.mo43269e(16.27f, 5.33f, 15.67f, 5.0f, 15.0f, 5.0f);
        eVar.mo43272h(4.0f);
        eVar.mo43275k(5.0f, 7.0f);
        eVar.mo43275k(-5.0f, 6.99f);
        eVar.mo43268d();
