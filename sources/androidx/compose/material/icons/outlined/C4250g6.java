...
/* renamed from: androidx.compose.material.icons.outlined.g6 */
public final class C4250g6 {
    @C12580l

    /* renamed from: a */
    public static C15340c f10808a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m16969a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f10808a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.BedroomParent", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(18.35f, 11.45f);
        eVar.mo43284t(9.0f);
        eVar.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar.mo43272h(13.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-0.37f, 0.0f, -0.72f, 0.12f, -1.0f, 0.32f);
        eVar2.mo43269e(11.72f, 7.12f, 11.37f, 7.0f, 11.0f, 7.0f);
        eVar.mo43272h(7.65f);
        eVar.mo43270f(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        eVar.mo43285u(2.45f);
        eVar.mo43269e(5.25f, 11.91f, 5.0f, 12.51f, 5.0f, 13.17f);
        eVar.mo43284t(17.0f);
        eVar.mo43273i(1.5f);
        eVar.mo43285u(-1.5f);
        eVar.mo43273i(11.0f);
        ...
        eVar.mo43272h(19.0f);
        eVar.mo43285u(-3.83f);
        eVar.mo43269e(19.0f, 12.51f, 18.75f, 11.91f, 18.35f, 11.45f);
        eVar.mo43268d();
        eVar.mo43276l(16.75f, 10.5f);
        eVar.mo43273i(-4.0f);
        eVar.mo43285u(-2.0f);
        eVar.mo43273i(4.0f);
        eVar.mo43284t(10.5f);
        eVar.mo43268d();
        eVar.mo43276l(7.25f, 8.5f);
        eVar.mo43273i(4.0f);
        eVar.mo43285u(2.0f);
        eVar.mo43273i(-4.0f);
        eVar.mo43284t(8.5f);
        eVar.mo43268d();
        eVar.mo43276l(17.5f, 14.0f);
        eVar.mo43273i(-11.0f);
        eVar.mo43285u(-1.0f);
        C15348e eVar3 = eVar;
