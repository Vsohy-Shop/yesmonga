...
/* renamed from: androidx.compose.material.icons.outlined.wl */
public final class C4856wl {
    @C12580l

    /* renamed from: a */
    public static C15340c f12152a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18313a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f12152a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Elevator", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(10.0f);
        eVar.mo43268d();
        eVar.mo43276l(8.5f, 8.5f);
        eVar3.mo43270f(0.69f, 0.0f, 1.25f, -0.56f, 1.25f, -1.25f);
        eVar.mo43280p(9.19f, 6.0f, 8.5f, 6.0f);
        eVar.mo43280p(7.25f, 6.56f, 7.25f, 7.25f);
        eVar.mo43280p(7.81f, 8.5f, 8.5f, 8.5f);
        eVar.mo43268d();
        eVar.mo43276l(18.0f, 11.0f);
        eVar.mo43275k(-2.5f, -4.0f);
