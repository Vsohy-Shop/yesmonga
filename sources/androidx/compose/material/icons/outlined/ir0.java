...
public final class ir0 {
    ...
    /* renamed from: a */
    public static C15340c f11018a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17179a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11018a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.SmartButton", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(16.0f);
        eVar.mo43269e(21.1f, 7.0f, 22.0f, 7.9f, 22.0f, 9.0f);
        eVar.mo43268d();
        eVar.mo43276l(14.5f, 19.0f);
        eVar.mo43275k(1.09f, -2.41f);
        eVar.mo43274j(18.0f, 15.5f);
        eVar.mo43275k(-2.41f, -1.09f);
        eVar.mo43274j(14.5f, 12.0f);
        eVar.mo43275k(-1.09f, 2.41f);
        eVar.mo43274j(11.0f, 15.5f);
        eVar.mo43275k(2.41f, 1.09f);
        eVar.mo43274j(14.5f, 19.0f);
        eVar.mo43268d();
        eVar.mo43276l(17.0f, 14.0f);
        eVar.mo43275k(0.62f, -1.38f);
        eVar.mo43274j(19.0f, 12.0f);
        eVar.mo43275k(-1.38f, -0.62f);
