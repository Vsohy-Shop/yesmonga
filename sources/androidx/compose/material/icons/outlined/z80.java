...
public final class z80 {
    ...
    /* renamed from: a */
    public static C15340c f12372a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18533a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f12372a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.NetworkLocked", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43280p(17.0f, 14.12f, 17.0f, 15.5f);
        eVar.mo43285u(0.5f);
        ...
        eVar.mo43285u(0.5f);
        eVar.mo43268d();
        eVar.mo43276l(18.0f, 5.83f);
        eVar.mo43285u(5.43f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(0.47f, -0.16f, 0.97f, -0.26f, 1.5f, -0.26f);
        eVar2.mo43270f(0.17f, 0.0f, 0.33f, 0.03f, 0.5f, 0.05f);
        eVar.mo43274j(20.0f, 1.0f);
        eVar.mo43274j(1.0f, 20.0f);
        eVar.mo43273i(13.0f);
        eVar.mo43285u(-2.0f);
        eVar.mo43274j(5.83f, 18.0f);
        eVar.mo43274j(18.0f, 5.83f);
        eVar.mo43268d();
