...
/* renamed from: androidx.compose.material.icons.outlined.j0 */
public final class C4354j0 {
    @C12580l

    /* renamed from: a */
    public static C15340c f11035a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17196a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11035a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.AddPhotoAlternate", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(9.0f);
        eVar.mo43268d();
        eVar.mo43276l(10.21f, 16.83f);
        eVar.mo43275k(-1.96f, -2.36f);
        eVar.mo43274j(5.5f, 18.0f);
        eVar.mo43273i(11.0f);
        ...
        eVar.mo43285u(3.0f);
        eVar.mo43273i(-3.0f);
        eVar.mo43270f(0.01f, 0.01f, 0.0f, 2.0f, 0.0f, 2.0f);
        eVar.mo43273i(3.0f);
        eVar.mo43285u(2.99f);
        eVar.mo43270f(0.01f, 0.01f, 2.0f, 0.0f, 2.0f, 0.0f);
