...
public final class kl0 {
    ...
    /* renamed from: a */
    public static C15340c f11169a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17330a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11169a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.RoomService", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-0.27f, -4.07f, -3.25f, -7.4f, -7.16f, -8.21f);
        eVar2.mo43270f(0.1f, -0.24f, 0.16f, -0.51f, 0.16f, -0.79f);
        eVar2.mo43270f(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        eVar.mo43281q(-2.0f, 0.9f, -2.0f, 2.0f);
        C15348e eVar3 = eVar;
        eVar3.mo43270f(0.0f, 0.28f, 0.06f, 0.55f, 0.16f, 0.79f);
        eVar3.mo43269e(6.25f, 8.6f, 3.27f, 11.93f, 3.0f, 16.0f);
        eVar.mo43273i(18.0f);
        eVar.mo43268d();
        eVar.mo43276l(12.0f, 9.58f);
        eVar.mo43270f(2.95f, 0.0f, 5.47f, 1.83f, 6.5f, 4.41f);
        eVar.mo43273i(-13.0f);
        eVar.mo43270f(1.03f, -2.58f, 3.55f, -4.41f, 6.5f, -4.41f);
        eVar.mo43268d();
