...
public final class p00 {
    ...
    /* renamed from: a */
    public static C15340c f11528a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17689a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11528a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Label", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(17.63f, 5.84f);
        eVar.mo43269e(17.27f, 5.33f, 16.67f, 5.0f, 16.0f, 5.0f);
        eVar.mo43274j(5.0f, 5.01f);
        eVar.mo43269e(3.9f, 5.01f, 3.0f, 5.9f, 3.0f, 7.0f);
        eVar.mo43285u(10.0f);
        eVar.mo43270f(0.0f, 1.1f, 0.9f, 1.99f, 2.0f, 1.99f);
        eVar.mo43274j(16.0f, 19.0f);
        eVar.mo43270f(0.67f, 0.0f, 1.27f, -0.33f, 1.63f, -0.84f);
