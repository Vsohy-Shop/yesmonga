...
public final class um0 {
    ...
    /* renamed from: a */
    public static C15340c f11991a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18152a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11991a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.School", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43275k(4.0f, 2.18f);
        eVar.mo43285u(6.0f);
        eVar.mo43274j(12.0f, 21.0f);
        eVar.mo43275k(7.0f, -3.82f);
        eVar.mo43285u(-6.0f);
        eVar.mo43275k(2.0f, -1.09f);
        eVar.mo43274j(21.0f, 17.0f);
        eVar.mo43273i(2.0f);
        eVar.mo43274j(23.0f, 9.0f);
        eVar.mo43274j(12.0f, 3.0f);
        eVar.mo43268d();
        eVar.mo43276l(18.82f, 9.0f);
        eVar.mo43274j(12.0f, 12.72f);
        eVar.mo43274j(5.18f, 9.0f);
        eVar.mo43274j(12.0f, 5.28f);
        eVar.mo43274j(18.82f, 9.0f);
        eVar.mo43268d();
        eVar.mo43276l(17.0f, 15.99f);
