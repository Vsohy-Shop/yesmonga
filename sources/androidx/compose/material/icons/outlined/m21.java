...
public final class m21 {
    ...
    /* renamed from: a */
    public static C15340c f11289a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17450a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11289a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.VideoStable", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43284t(6.0f);
        eVar.mo43273i(2.95f);
        eVar.mo43275k(-2.33f, 8.73f);
        eVar.mo43274j(16.82f, 18.0f);
        eVar.mo43272h(4.0f);
        eVar.mo43268d();
        eVar.mo43276l(15.62f, 15.61f);
        eVar.mo43275k(-8.55f, -2.29f);
        eVar.mo43275k(1.31f, -4.92f);
        eVar.mo43275k(8.56f, 2.29f);
        eVar.mo43274j(15.62f, 15.61f);
        eVar.mo43268d();
        eVar.mo43276l(20.0f, 18.0f);
        eVar.mo43273i(-2.95f);
        eVar.mo43275k(2.34f, -8.73f);
        eVar.mo43274j(7.18f, 6.0f);
        eVar.mo43272h(20.0f);
        eVar.mo43284t(18.0f);
        eVar.mo43268d();
