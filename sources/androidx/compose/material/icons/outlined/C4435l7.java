...
/* renamed from: androidx.compose.material.icons.outlined.l7 */
public final class C4435l7 {
    @C12580l

    /* renamed from: a */
    public static C15340c f11220a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17381a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11220a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Bookmarks", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(12.97f);
        eVar.mo43275k(-4.21f, -1.81f);
        eVar.mo43275k(-0.79f, -0.34f);
        eVar.mo43275k(-0.79f, 0.34f);
        eVar.mo43274j(5.0f, 19.97f);
        eVar.mo43274j(5.0f, 7.0f);
        eVar.mo43273i(10.0f);
        eVar.mo43277m(4.0f, -6.0f);
        eVar.mo43274j(8.99f, 1.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(7.89f, 1.0f, 7.0f, 1.9f, 7.0f, 3.0f);
        eVar.mo43273i(10.0f);
