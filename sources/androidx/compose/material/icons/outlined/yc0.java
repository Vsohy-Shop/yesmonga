...
public final class yc0 {
    ...
    /* renamed from: a */
    public static C15340c f12299a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18460a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f12299a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.PausePresentation", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-1.1f, 0.0f, -2.0f, 0.85f, -2.0f, 1.95f);
        eVar.mo43285u(14.0f);
        eVar2.mo43270f(0.0f, 1.1f, 0.9f, 2.05f, 2.0f, 2.05f);
        eVar.mo43273i(18.0f);
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, -0.95f, 2.0f, -2.05f);
        eVar.mo43285u(-14.0f);
        eVar.mo43269e(23.0f, 3.85f, 22.1f, 3.0f, 21.0f, 3.0f);
        eVar.mo43268d();
