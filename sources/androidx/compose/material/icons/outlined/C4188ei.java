...
/* renamed from: androidx.compose.material.icons.outlined.ei */
public final class C4188ei {
    @C12580l

    /* renamed from: a */
    public static C15340c f10671a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m16832a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f10671a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Directions", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(22.43f, 10.59f);
        eVar.mo43275k(-9.01f, -9.01f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(-0.75f, -0.75f, -2.07f, -0.76f, -2.83f, 0.0f);
        eVar.mo43275k(-9.0f, 9.0f);
        eVar2.mo43270f(-0.78f, 0.78f, -0.78f, 2.04f, 0.0f, 2.82f);
        eVar.mo43275k(9.0f, 9.0f);
        eVar2.mo43270f(0.39f, 0.39f, 0.9f, 0.58f, 1.41f, 0.58f);
        eVar2.mo43270f(0.51f, 0.0f, 1.02f, -0.19f, 1.41f, -0.58f);
        eVar.mo43275k(8.99f, -8.99f);
        eVar.mo43270f(0.79f, -0.76f, 0.8f, -2.02f, 0.03f, -2.82f);
        eVar.mo43268d();
        eVar.mo43276l(12.01f, 20.99f);
        eVar.mo43275k(-9.0f, -9.0f);
        eVar.mo43275k(9.0f, -9.0f);
        eVar.mo43275k(9.0f, 9.0f);
        eVar.mo43275k(-9.0f, 9.0f);
