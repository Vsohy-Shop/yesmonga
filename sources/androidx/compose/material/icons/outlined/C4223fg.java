...
/* renamed from: androidx.compose.material.icons.outlined.fg */
public final class C4223fg {
    @C12580l

    /* renamed from: a */
    public static C15340c f10749a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m16910a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f10749a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.DataExploration", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(-8.0f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(22.0f, 6.48f, 17.52f, 2.0f, 12.0f, 2.0f);
        eVar.mo43268d();
        eVar.mo43276l(12.0f, 20.0f);
        eVar2.mo43270f(-2.89f, 0.0f, -5.43f, -1.54f, -6.83f, -3.84f);
        eVar.mo43275k(2.95f, -2.95f);
        eVar.mo43274j(11.41f, 16.0f);
        eVar.mo43274j(16.0f, 11.42f);
        eVar.mo43284t(13.0f);
        eVar.mo43273i(2.0f);
        eVar.mo43284t(8.0f);
        eVar.mo43273i(-5.0f);
        eVar.mo43285u(2.0f);
        eVar.mo43273i(1.58f);
        eVar.mo43275k(-3.28f, 3.28f);
        eVar.mo43274j(8.0f, 10.5f);
        eVar.mo43275k(-3.69f, 3.7f);
        C15348e eVar3 = eVar;
