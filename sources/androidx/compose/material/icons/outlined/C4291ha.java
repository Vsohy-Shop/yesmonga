...
/* renamed from: androidx.compose.material.icons.outlined.ha */
public final class C4291ha {
    @C12580l

    /* renamed from: a */
    public static C15340c f10901a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17062a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f10901a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.CancelPresentation", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(14.0f);
        eVar.mo43268d();
        eVar.mo43276l(9.41f, 15.95f);
        eVar.mo43274j(12.0f, 13.36f);
        eVar.mo43275k(2.59f, 2.59f);
        eVar.mo43274j(16.0f, 14.54f);
        eVar.mo43275k(-2.59f, -2.59f);
        eVar.mo43274j(16.0f, 9.36f);
        eVar.mo43275k(-1.41f, -1.41f);
        eVar.mo43274j(12.0f, 10.54f);
        eVar.mo43274j(9.41f, 7.95f);
        eVar.mo43274j(8.0f, 9.36f);
        eVar.mo43275k(2.59f, 2.59f);
        eVar.mo43274j(8.0f, 14.54f);
        eVar.mo43268d();
