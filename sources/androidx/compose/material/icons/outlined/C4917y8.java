...
/* renamed from: androidx.compose.material.icons.outlined.y8 */
public final class C4917y8 {
    @C12580l

    /* renamed from: a */
    public static C15340c f12289a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18450a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f12289a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Bungalow", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43284t(14.0f);
        eVar.mo43268d();
        eVar.mo43276l(18.1f, 16.56f);
        eVar.mo43274j(17.0f, 14.79f);
        eVar.mo43284t(21.0f);
        eVar.mo43272h(7.0f);
        eVar.mo43285u(-6.2f);
        eVar.mo43275k(-1.1f, 1.76f);
        eVar.mo43274j(4.2f, 15.5f);
        eVar.mo43274j(12.0f, 3.0f);
        eVar.mo43275k(7.8f, 12.5f);
        eVar.mo43274j(18.1f, 16.56f);
        eVar.mo43268d();
        eVar.mo43276l(15.0f, 11.59f);
        eVar.mo43275k(-3.0f, -4.8f);
        eVar.mo43275k(-3.0f, 4.8f);
        eVar.mo43284t(19.0f);
        eVar.mo43273i(2.0f);
        eVar.mo43285u(-3.0f);
