...
/* renamed from: androidx.compose.material.icons.outlined.rj */
public final class C4669rj {
    @C12580l

    /* renamed from: a */
    public static C15340c f11738a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17899a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11738a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.DoneOutline", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(19.77f, 4.93f);
        eVar.mo43275k(1.4f, 1.4f);
        eVar.mo43274j(8.43f, 19.07f);
        eVar.mo43275k(-5.6f, -5.6f);
        eVar.mo43275k(1.4f, -1.4f);
        eVar.mo43275k(4.2f, 4.2f);
        eVar.mo43274j(19.77f, 4.93f);
        eVar.mo43277m(0.0f, -2.83f);
        eVar.mo43274j(8.43f, 13.44f);
        eVar.mo43275k(-4.2f, -4.2f);
        eVar.mo43274j(0.0f, 13.47f);
        eVar.mo43275k(8.43f, 8.43f);
        eVar.mo43274j(24.0f, 6.33f);
        eVar.mo43274j(19.77f, 2.1f);
        eVar.mo43268d();
