...
public final class jq0 {
    ...
    /* renamed from: a */
    public static C15340c f11097a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17258a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11097a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.SignalCellularNoSim", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43273i(-7.0f);
        eVar.mo43274j(7.94f, 5.06f);
        eVar.mo43275k(1.42f, 1.42f);
        eVar.mo43274j(10.83f, 5.0f);
        eVar.mo43268d();
        eVar.mo43276l(21.26f, 21.21f);
        eVar.mo43274j(3.79f, 3.74f);
        eVar.mo43274j(2.38f, 5.15f);
        eVar.mo43274j(5.0f, 7.77f);
        eVar.mo43274j(5.0f, 19.0f);
        eVar.mo43270f(0.0f, 1.11f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(11.23f);
        eVar.mo43275k(1.62f, 1.62f);
        eVar.mo43275k(1.41f, -1.41f);
        eVar.mo43268d();
        eVar.mo43276l(7.0f, 19.0f);
        eVar.mo43274j(7.0f, 9.79f);
        eVar.mo43274j(16.23f, 19.0f);
