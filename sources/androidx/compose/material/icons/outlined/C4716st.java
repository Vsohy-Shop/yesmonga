...
/* renamed from: androidx.compose.material.icons.outlined.st */
public final class C4716st {
    @C12580l

    /* renamed from: a */
    public static C15340c f11840a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18001a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11840a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Gavel", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43268d();
        eVar.mo43276l(12.32f, 1.0f);
        eVar.mo43275k(5.66f, 5.66f);
        eVar.mo43275k(-2.83f, 2.83f);
        eVar.mo43275k(-5.66f, -5.66f);
        eVar.mo43274j(12.32f, 1.0f);
        eVar.mo43268d();
        eVar.mo43276l(3.83f, 9.48f);
        eVar.mo43275k(5.66f, 5.66f);
        eVar.mo43275k(-2.83f, 2.83f);
        eVar.mo43274j(1.0f, 12.31f);
        eVar.mo43275k(2.83f, -2.83f);
        eVar.mo43268d();
