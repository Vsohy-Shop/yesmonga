...
public final class s10 {
    ...
    /* renamed from: a */
    public static C15340c f11777a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17938a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11777a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.LineAxis", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(22.0f, 7.43f);
        eVar.mo43275k(-1.41f, -1.41f);
        eVar.mo43275k(-4.03f, 4.53f);
        eVar.mo43275k(-7.06f, -6.55f);
        eVar.mo43275k(-7.5f, 7.51f);
        eVar.mo43275k(1.5f, 1.5f);
        eVar.mo43275k(6.14f, -6.15f);
        eVar.mo43275k(5.59f, 5.18f);
        eVar.mo43275k(-1.73f, 1.95f);
        eVar.mo43275k(-4.0f, -4.0f);
        eVar.mo43275k(-7.5f, 7.51f);
        eVar.mo43275k(1.5f, 1.5f);
        eVar.mo43275k(6.0f, -6.01f);
        eVar.mo43275k(4.0f, 4.0f);
        eVar.mo43275k(3.19f, -3.59f);
        eVar.mo43275k(3.9f, 3.61f);
        eVar.mo43275k(1.41f, -1.41f);
        eVar.mo43275k(-3.98f, -3.7f);
        eVar.mo43268d();
