...
public final class nz0 {
    ...
    /* renamed from: a */
    public static C15340c f11443a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17604a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11443a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Tornado", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43272h(1.0f);
        eVar.mo43275k(11.0f, 19.0f);
        eVar.mo43274j(23.0f, 3.0f);
        eVar.mo43268d();
        eVar.mo43276l(19.53f, 5.0f);
        eVar.mo43275k(-1.74f, 3.0f);
        eVar.mo43272h(6.21f);
        eVar.mo43274j(4.47f, 5.0f);
        eVar.mo43272h(19.53f);
        eVar.mo43268d();
        eVar.mo43276l(10.26f, 15.0f);
        eVar.mo43273i(3.48f);
        eVar.mo43274j(12.0f, 18.01f);
        eVar.mo43274j(10.26f, 15.0f);
        eVar.mo43268d();
        eVar.mo43276l(14.9f, 13.0f);
        eVar.mo43272h(9.1f);
        eVar.mo43275k(-1.74f, -3.0f);
        eVar.mo43273i(9.27f);
        eVar.mo43274j(14.9f, 13.0f);
        eVar.mo43268d();
