...
/* renamed from: androidx.compose.material.icons.outlined.c5 */
public final class C4101c5 {
    @C12580l

    /* renamed from: a */
    public static C15340c f10477a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m16638a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f10477a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Backpack", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(2.14f);
        C15348e eVar2 = eVar;
        eVar2.mo43269e(5.28f, 4.59f, 4.0f, 6.14f, 4.0f, 8.0f);
        eVar.mo43285u(12.0f);
        eVar2.mo43270f(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        eVar.mo43273i(12.0f);
        eVar2.mo43270f(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        eVar.mo43284t(8.0f);
        eVar2.mo43269e(20.0f, 6.14f, 18.72f, 4.59f, 17.0f, 4.14f);
        eVar.mo43268d();
