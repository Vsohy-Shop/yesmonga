...
public final class n80 {
    ...
    /* renamed from: a */
    public static C15340c f11388a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17549a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11388a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.Nature", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(13.0f, 16.12f);
        eVar.mo43273i(-0.03f);
        C15348e eVar2 = eVar;
        eVar2.mo43270f(3.49f, -0.4f, 6.2f, -3.36f, 6.2f, -6.95f);
        eVar2.mo43270f(0.0f, -3.87f, -3.13f, -7.0f, -7.0f, -7.0f);
        eVar.mo43281q(-7.0f, 3.13f, -7.0f, 7.0f);
        eVar.mo43270f(0.0f, 3.47f, 2.52f, 6.34f, 5.83f, 6.89f);
        eVar.mo43284t(20.0f);
        eVar.mo43272h(5.0f);
        eVar.mo43285u(2.0f);
        eVar.mo43273i(14.0f);
