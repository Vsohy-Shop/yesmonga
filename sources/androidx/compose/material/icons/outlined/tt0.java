...
public final class tt0 {
    ...
    /* renamed from: a */
    public static C15340c f11923a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m18084a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11923a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.SsidChart", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43276l(21.0f, 5.47f);
        eVar.mo43274j(12.0f, 12.0f);
        eVar.mo43274j(7.62f, 7.62f);
        eVar.mo43274j(3.0f, 11.0f);
        eVar.mo43284t(8.52f);
        eVar.mo43274j(7.83f, 5.0f);
        eVar.mo43275k(4.38f, 4.38f);
        eVar.mo43274j(21.0f, 3.0f);
        eVar.mo43274j(21.0f, 5.47f);
        eVar.mo43268d();
        eVar.mo43276l(21.0f, 15.0f);
        eVar.mo43273i(-4.7f);
        eVar.mo43275k(-4.17f, 3.34f);
        eVar.mo43274j(6.0f, 12.41f);
        eVar.mo43275k(-3.0f, 2.13f);
        eVar.mo43274j(3.0f, 17.0f);
        eVar.mo43275k(2.8f, -2.0f);
        eVar.mo43275k(6.2f, 6.0f);
