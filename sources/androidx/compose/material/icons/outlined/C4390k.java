...
/* renamed from: androidx.compose.material.icons.outlined.k */
public final class C4390k {
    @C12580l

    /* renamed from: a */
    public static C15340c f11116a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17277a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f11116a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.AccountBalance", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43285u(-7.0f);
        eVar.mo43268d();
        eVar.mo43276l(11.5f, 3.26f);
        eVar.mo43274j(16.71f, 6.0f);
        eVar.mo43274j(6.29f, 6.0f);
        eVar.mo43275k(5.21f, -2.74f);
        eVar.mo43277m(0.0f, -2.26f);
        eVar.mo43274j(2.0f, 6.0f);
        eVar.mo43285u(2.0f);
        eVar.mo43273i(19.0f);
        eVar.mo43274j(21.0f, 6.0f);
        eVar.mo43275k(-9.5f, -5.0f);
        eVar.mo43268d();
