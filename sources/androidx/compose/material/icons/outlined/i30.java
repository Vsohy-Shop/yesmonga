...
public final class i30 {
    ...
    /* renamed from: a */
    public static C15340c f10964a;

    @C12579k
    /* renamed from: a */
    public static final C15340c m17125a(@C12579k C3053a.C3055b bVar) {
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        C15340c cVar = f10964a;
        if (cVar != null) {
            Intrinsics.checkNotNull(cVar);
            return cVar;
        }
        C15340c.C15341a aVar = r1;
        C15340c.C15341a aVar2 = new C15340c.C15341a("Outlined.LocalShipping", C16483g.m74435M(24.0f), C16483g.m74435M(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        eVar.mo43281q(-0.45f, 1.0f, -1.0f, 1.0f);
        eVar.mo43268d();
        eVar.mo43276l(8.22f, 15.0f);
        eVar3.mo43270f(-0.55f, -0.61f, -1.33f, -1.0f, -2.22f, -1.0f);
        eVar.mo43281q(-1.67f, 0.39f, -2.22f, 1.0f);
        eVar.mo43274j(3.0f, 15.0f);
        eVar.mo43274j(3.0f, 6.0f);
        eVar.mo43273i(12.0f);
        eVar.mo43285u(9.0f);
        eVar.mo43274j(8.22f, 15.0f);
        eVar.mo43268d();
