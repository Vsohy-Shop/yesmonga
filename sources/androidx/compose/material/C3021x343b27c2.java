...
public final class C3021x343b27c2 extends Lambda implements C11300l<C15983v0, C11079d2> {
    final /* synthetic */ C7930s1 $colors$inlined;
    ...
    public C3021x343b27c2(boolean z, boolean z2, C2241e eVar, C7930s1 s1Var, float f, float f2) {
        super(1);
        this.$enabled$inlined = z;
        this.$isError$inlined = z2;
        this.$interactionSource$inlined = eVar;
        this.$colors$inlined = s1Var;
        this.$focusedIndicatorLineThickness$inlined = f;
        this.$unfocusedIndicatorLineThickness$inlined = f2;
    }

    /* renamed from: a */
    public final void mo10642a(@C12579k C15983v0 v0Var) {
