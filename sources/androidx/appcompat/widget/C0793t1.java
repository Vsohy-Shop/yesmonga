...
public class C0793t1 extends C0815x0 {

    /* renamed from: c */
    public static boolean f2589c = false;

    /* renamed from: d */
    public static final int f2590d = 20;

    /* renamed from: b */
    public final WeakReference<Context> f2591b;

    public C0793t1(@C0359n0 Context context, @C0359n0 Resources resources) {
        super(resources);
        this.f2591b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m3853b() {
        return f2589c;
    }

    /* renamed from: c */
    public static void m3854c(boolean z) {
        f2589c = z;
    }

    /* renamed from: d */
    public static boolean m3855d() {
        m3853b();
        return false;
    }
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        Context context = this.f2591b.get();
        if (context != null) {
            return C0806w0.m3884h().mo3751t(context, this, i);
        }
        return mo3758a(i);
    }
