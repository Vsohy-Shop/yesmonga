...
public class AppCompatCheckBox extends CheckBox implements C18466b0, C18164e2, C0752n0, C18471c0 {

    /* renamed from: a */
    public final C0713f f1898a;

    /* renamed from: b */
    public final C0706d f1899b;

    /* renamed from: c */
    public final C0784t f1900c;

    /* renamed from: d */
    public C0724i f1901d;

    public AppCompatCheckBox(@C0359n0 Context context) {
    ...
    public void drawableStateChanged() {
        ...
        C0706d dVar = this.f1899b;
        if (dVar != null) {
            dVar.mo3335b();
        }
        C0784t tVar = this.f1900c;
        if (tVar != null) {
            tVar.mo3652b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1900c.mo3659j();
    }

    @C0363p0
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1900c.mo3660k();
    }
    ...
    public void setSupportCompoundDrawablesTintList(@C0363p0 ColorStateList colorStateList) {
        this.f1900c.mo3672w(colorStateList);
        this.f1900c.mo3652b();
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setSupportCompoundDrawablesTintMode(@C0363p0 PorterDuff.Mode mode) {
        this.f1900c.mo3673x(mode);
        this.f1900c.mo3652b();
    }

    public AppCompatCheckBox(@C0359n0 Context context, @C0363p0 AttributeSet attributeSet) {
        this(context, attributeSet, C0387a.C0389b.checkboxStyle);
    }

    public AppCompatCheckBox(@C0359n0 Context context, @C0363p0 AttributeSet attributeSet, int i) {
