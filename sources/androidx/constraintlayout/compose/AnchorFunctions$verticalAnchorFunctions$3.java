...
public final class AnchorFunctions$verticalAnchorFunctions$3 extends Lambda implements C11305q<ConstraintReference, Object, LayoutDirection, ConstraintReference> {

    /* renamed from: f */
    public static final AnchorFunctions$verticalAnchorFunctions$3 f41091f = new AnchorFunctions$verticalAnchorFunctions$3();
    ...
    public final ConstraintReference invoke(@C12579k ConstraintReference constraintReference, @C12579k Object obj, @C12579k LayoutDirection layoutDirection) {
        ...
        ConstraintReference j0 = constraintReference.mo49252j0(obj);
        Intrinsics.checkNotNullExpressionValue(j0, "rightToLeft(other)");
        return j0;
    }
}
