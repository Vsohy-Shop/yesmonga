...
public final class ConstraintLayoutBaseScope$createStartBarrier$1 extends Lambda implements C11300l<C16611l0, C11079d2> {
    final /* synthetic */ C16591e[] $elements;
    final /* synthetic */ int $id;
    final /* synthetic */ float $margin;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConstraintLayoutBaseScope$createStartBarrier$1(int i, float f, C16591e[] eVarArr) {
        super(1);
        this.$id = i;
        this.$margin = f;
    ...
    /* renamed from: a */
    public final void mo48316a(@C12579k C16611l0 l0Var) {
        ...
        C16755c b = l0Var.mo49305b(Integer.valueOf(this.$id), direction);
