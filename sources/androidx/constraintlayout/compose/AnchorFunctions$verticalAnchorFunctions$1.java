...
public final class AnchorFunctions$verticalAnchorFunctions$1 extends Lambda implements C11305q<ConstraintReference, Object, LayoutDirection, ConstraintReference> {

    /* renamed from: f */
    public static final AnchorFunctions$verticalAnchorFunctions$1 f41089f = new AnchorFunctions$verticalAnchorFunctions$1();
    ...
    public final ConstraintReference invoke(@C12579k ConstraintReference constraintReference, @C12579k Object obj, @C12579k LayoutDirection layoutDirection) {
        ...
        ConstraintReference a0 = constraintReference.mo49233a0(obj);
        Intrinsics.checkNotNullExpressionValue(a0, "leftToLeft(other)");
        return a0;
    }
}
