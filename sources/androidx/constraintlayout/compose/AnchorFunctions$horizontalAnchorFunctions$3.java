...
public final class AnchorFunctions$horizontalAnchorFunctions$3 extends Lambda implements C11304p<ConstraintReference, Object, ConstraintReference> {

    /* renamed from: f */
    public static final AnchorFunctions$horizontalAnchorFunctions$3 f41087f = new AnchorFunctions$horizontalAnchorFunctions$3();
    ...
    public final ConstraintReference invoke(@C12579k ConstraintReference constraintReference, @C12579k Object obj) {
        ...
        ConstraintReference q = constraintReference.mo49265q(obj);
        Intrinsics.checkNotNullExpressionValue(q, "bottomToTop(other)");
        return q;
    }
}
