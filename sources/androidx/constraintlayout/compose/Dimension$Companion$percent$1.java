...
public final class Dimension$Companion$percent$1 extends Lambda implements C11300l<C16611l0, Dimension> {
    ...
    public final Dimension invoke(@C12579k C16611l0 l0Var) {
        ...
        Dimension v = Dimension.m76551d(0, this.$percent).mo49300v(0);
        Intrinsics.checkNotNullExpressionValue(v, "Percent(0, percent).suggested(0)");
        return v;
    }
}
