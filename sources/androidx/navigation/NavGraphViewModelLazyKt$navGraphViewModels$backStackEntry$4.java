...
public final class NavGraphViewModelLazyKt$navGraphViewModels$backStackEntry$4 extends Lambda implements C11289a<NavBackStackEntry> {
    ...
    public final NavBackStackEntry invoke() {
        return C19736g.m91827a(this.$this_navGraphViewModels).mo58096E(this.$navGraphRoute);
    }
}
