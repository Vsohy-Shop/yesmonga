...
public final class FragmentViewModelLazyKt$viewModels$2 extends Lambda implements C11289a<C19392a1> {
    final /* synthetic */ C11677z<C19395b1> $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FragmentViewModelLazyKt$viewModels$2(C11677z<? extends C19395b1> zVar) {
        super(0);
    ...
    public final C19392a1 invoke() {
        C19392a1 viewModelStore = FragmentViewModelLazyKt.m89930o(this.$owner$delegate).getViewModelStore();
