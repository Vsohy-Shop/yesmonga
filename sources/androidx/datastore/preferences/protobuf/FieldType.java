...
public enum FieldType {
    ...
    /* renamed from: o1 */
    public static final FieldType[] f47615o1 = null;

    /* renamed from: p1 */
    public static final Type[] f47616p1 = null;
    private final Collection collection;
    private final Class<?> elementType;

    /* renamed from: id */
    private final int f47623id;
    ...
    public enum Collection {
        ...
        /* renamed from: g */
        public boolean mo53977g() {
            return this.isList;
        }
    }

    /* renamed from: androidx.datastore.preferences.protobuf.FieldType$a */
    public static /* synthetic */ class C18632a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f47629a = null;

        /* renamed from: b */
        public static final /* synthetic */ int[] f47630b = null;
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f47630b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f47630b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0039:
                int[] r1 = f47629a     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                int[] r0 = f47629a     // Catch:{ NoSuchFieldError -> 0x004d }
            ...
            L_0x004d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.FieldType.C18632a.<clinit>():void");
        }
    }
    ...
    static {
        ...
        f47615o1 = new FieldType[values.length];
        for (FieldType fieldType : values) {
            f47615o1[fieldType.f47623id] = fieldType;
        }
    }

    /* access modifiers changed from: public */
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x002c, code lost:
        r1 = androidx.datastore.preferences.protobuf.FieldType.C18632a.f47630b[r5.ordinal()];
     */
    ...
    FieldType(int r3, androidx.datastore.preferences.protobuf.FieldType.Collection r4, androidx.datastore.preferences.protobuf.JavaType r5) {
        /*
            ...
            r0.collection = r4
            r0.javaType = r5
            int[] r1 = androidx.datastore.preferences.protobuf.FieldType.C18632a.f47629a
            int r2 = r4.ordinal()
            r1 = r1[r2]
            r2 = 2
            r3 = 1
            ...
            goto L_0x0028
        L_0x001b:
            java.lang.Class r1 = r5.mo54085g()
            r0.elementType = r1
            goto L_0x0028
        L_0x0022:
            java.lang.Class r1 = r5.mo54085g()
        ...
        L_0x0028:
            ...
            int[] r1 = androidx.datastore.preferences.protobuf.FieldType.C18632a.f47630b
            int r4 = r5.ordinal()
            r1 = r1[r4]
    ...
    /* renamed from: b */
    public static FieldType m84928b(int i) {
        if (i < 0) {
            return null;
        }
        FieldType[] fieldTypeArr = f47615o1;
    ...
    /* renamed from: g */
    public static Type m84929g(Class<?> cls) {
    ...
    /* renamed from: r */
    public static Type m84930r(Class<?> cls, Type[] typeArr) {
    ...
    /* renamed from: M */
    public boolean mo53968M() {
        return this.primitiveScalar;
    }

    /* renamed from: Q */
    public boolean mo53969Q() {
        return this.collection == Collection.SCALAR;
    }

    /* renamed from: S */
    public boolean mo53970S() {
        return Collection.PACKED_VECTOR.equals(this.collection);
    }

    /* renamed from: W */
    public boolean mo53971W(Field field) {
        if (Collection.VECTOR.equals(this.collection)) {
            return mo53972X(field);
        }
        return this.javaType.mo54087r().isAssignableFrom(field.getType());
    }

    /* renamed from: X */
    public final boolean mo53972X(Field field) {
        Class<?> type = field.getType();
        if (!this.javaType.mo54087r().isAssignableFrom(type)) {
            return false;
        }
        Type[] typeArr = f47616p1;
        if (field.getGenericType() instanceof ParameterizedType) {
            typeArr = ((ParameterizedType) field.getGenericType()).getActualTypeArguments();
        }
        Type r = m84930r(type, typeArr);
    ...
    /* renamed from: y */
    public boolean mo53975y() {
        return this.collection.mo53977g();
    }

    /* renamed from: z */
    public boolean mo53976z() {
