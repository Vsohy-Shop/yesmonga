...
public final class WireFormat {
    ...
    /* renamed from: a */
    public static final int f47717a = 4;

    /* renamed from: b */
    public static final int f47718b = 8;

    /* renamed from: c */
    public static final int f47719c = 5;

    /* renamed from: d */
    public static final int f47720d = 10;

    /* renamed from: e */
    public static final int f47721e = 10;
    ...
    /* renamed from: h */
    public static final int f47724h = 2;

    /* renamed from: i */
    public static final int f47725i = 3;

    /* renamed from: j */
    public static final int f47726j = 4;

    /* renamed from: k */
    public static final int f47727k = 5;

    /* renamed from: l */
    public static final int f47728l = 3;

    /* renamed from: m */
    public static final int f47729m = 7;

    /* renamed from: n */
    public static final int f47730n = 1;

    /* renamed from: o */
    public static final int f47731o = 2;

    /* renamed from: p */
    public static final int f47732p = 3;

    /* renamed from: q */
    public static final int f47733q = m85346c(1, 3);

    /* renamed from: r */
    public static final int f47734r = m85346c(1, 4);

    /* renamed from: s */
    public static final int f47735s = m85346c(2, 0);

    /* renamed from: t */
    public static final int f47736t = m85346c(3, 2);
    ...
    public enum JavaType {
        ...
        STRING(""),
        BYTE_STRING(ByteString.f47470d),
        ENUM((String) null),
        MESSAGE((String) null);
    ...
    public enum Utf8Validation {
        LOOSE {
            /* renamed from: b */
            public Object mo54205b(C18889w wVar) throws IOException {
                return wVar.mo55496W();
            }
        },
        STRICT {
            /* renamed from: b */
            public Object mo54205b(C18889w wVar) throws IOException {
                return wVar.mo55497X();
            }
        },
        LAZY {
            /* renamed from: b */
            public Object mo54205b(C18889w wVar) throws IOException {
                return wVar.mo55524x();
            }
        };

        /* renamed from: b */
        public abstract Object mo54205b(C18889w wVar) throws IOException;
    }
    ...
    public static /* synthetic */ class C18664a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f47770a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.WireFormat.C18664a.<clinit>():void");
        }
    }

    /* renamed from: a */
    public static int m85344a(int i) {
        return i >>> 3;
    }

    /* renamed from: b */
    public static int m85345b(int i) {
        return i & 7;
    }

    /* renamed from: c */
    public static int m85346c(int i, int i2) {
        return (i << 3) | i2;
    }

    /* renamed from: d */
    public static Object m85347d(C18889w wVar, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (C18664a.f47770a[fieldType.ordinal()]) {
            case 1:
                return Double.valueOf(wVar.mo55525y());
            case 2:
                return Float.valueOf(wVar.mo55478C());
            case 3:
                return Long.valueOf(wVar.mo55482G());
            case 4:
                return Long.valueOf(wVar.mo55501a0());
            case 5:
                return Integer.valueOf(wVar.mo55481F());
            case 6:
                return Long.valueOf(wVar.mo55477B());
            case 7:
                return Integer.valueOf(wVar.mo55476A());
            case 8:
                return Boolean.valueOf(wVar.mo55521u());
            case 9:
                return wVar.mo55524x();
            case 10:
                return Integer.valueOf(wVar.mo55499Z());
            case 11:
                return Integer.valueOf(wVar.mo55492S());
            case 12:
                return Long.valueOf(wVar.mo55493T());
            case 13:
                return Integer.valueOf(wVar.mo55494U());
            case 14:
                return Long.valueOf(wVar.mo55495V());
            case 15:
                return utf8Validation.mo54205b(wVar);
            case 16:
