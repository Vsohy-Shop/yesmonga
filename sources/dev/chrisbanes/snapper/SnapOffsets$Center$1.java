...
public final class SnapOffsets$Center$1 extends Lambda implements C11304p<C10368f, C10369g, Integer> {

    /* renamed from: f */
    public static final SnapOffsets$Center$1 f27997f = new SnapOffsets$Center$1();
    ...
    public final Integer invoke(@C12579k C10368f fVar, @C12579k C10369g gVar) {
        ...
        return Integer.valueOf(fVar.mo21758g() + (((fVar.mo21757f() - fVar.mo21758g()) - gVar.mo21794c()) / 2));
    }
}
