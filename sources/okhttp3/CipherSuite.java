...
@C11076d0(mo22514bv = {1, 0, 3}, mo22515d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, mo22516d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"}, mo22517k = 1, mo22518mv = {1, 4, 0})
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (C11622t.startsWith$default(str, "TLS_", false, 2, (Object) null)) {
            ...
            } else if (!C11622t.startsWith$default(str, "SSL_", false, 2, (Object) null)) {
                return str;
            } else {
        ...
        @C12579k
        @C11384m
        public final synchronized CipherSuite forJavaName(@C12579k String str) {
    ...
    static {
        ...
        TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", C14092c.f34515F);
        TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", 135);
        TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", C14092c.f34527J);
        ...
        TLS_RSA_WITH_AES_128_GCM_SHA256 = companion.init("TLS_RSA_WITH_AES_128_GCM_SHA256", C14092c.f34536M);
    ...
    @C12579k
    @C11384m
    public static final synchronized CipherSuite forJavaName(@C12579k String str) {
    ...
    public final String m172615deprecated_javaName() {
