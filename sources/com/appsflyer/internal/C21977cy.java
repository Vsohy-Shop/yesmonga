...
/* renamed from: com.appsflyer.internal.cy */
public final class C21977cy {
    ...
    public static void AFInAppEventType(int i, int i2, boolean z, int i3, int[] iArr, int[][] iArr2, int[] iArr3) {
        if (!z) {
