...
public final class C21885al {
    ...
    public static synchronized String AFKeystoreWrapper(WeakReference<Context> weakReference) {
        synchronized (C21885al.class) {
            ...
            if (AFInAppEventParameterName == null) {
                String str2 = null;
                if (weakReference.get() != null) {
                    str2 = C21868ah.valueOf(weakReference.get()).getString("AF_INSTALLATION", (String) null);
                }
                if (str2 != null) {
                    AFInAppEventParameterName = str2;
                } else {
                    try {
                        ...
                        SharedPreferences.Editor edit = C21868ah.valueOf(weakReference.get()).edit();
    ...
    private static java.lang.String valueOf(java.io.File r6) {
        ...
        L_0x001b:
            r6 = move-exception
            com.appsflyer.AFLogger.AFKeystoreWrapper(r0, r6)
            goto L_0x003c
        L_0x0020:
            r6 = move-exception
            r1 = r2
        ...
        L_0x002c:
            ...
            com.appsflyer.AFLogger.AFKeystoreWrapper(r3, r6)     // Catch:{ all -> 0x0028 }
        ...
        L_0x0052:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C21885al.valueOf(java.io.File):java.lang.String");
    }
}
