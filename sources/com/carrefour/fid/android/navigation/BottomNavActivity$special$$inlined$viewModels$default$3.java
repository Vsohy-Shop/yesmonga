...
public final class BottomNavActivity$special$$inlined$viewModels$default$3 extends Lambda implements C11289a<C19477a> {
    final /* synthetic */ C11289a $extrasProducer;
    final /* synthetic */ ComponentActivity $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BottomNavActivity$special$$inlined$viewModels$default$3(C11289a aVar, ComponentActivity componentActivity) {
        super(0);
