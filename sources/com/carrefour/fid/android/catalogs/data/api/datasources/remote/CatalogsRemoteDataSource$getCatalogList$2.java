...
@C11067d(mo22501c = "com.carrefour.fid.android.catalogs.data.api.datasources.remote.CatalogsRemoteDataSource$getCatalogList$2", mo22502f = "CatalogsRemoteDataSource.kt", mo22503i = {}, mo22504l = {19}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
...
public final class CatalogsRemoteDataSource$getCatalogList$2 extends SuspendLambda implements C11300l<C11045c<? super Result<? extends List<? extends Catalog>>>, Object> {
    int label;
    final /* synthetic */ CatalogsRemoteDataSource this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CatalogsRemoteDataSource$getCatalogList$2(CatalogsRemoteDataSource catalogsRemoteDataSource, C11045c<? super CatalogsRemoteDataSource$getCatalogList$2> cVar) {
        super(1, cVar);
    ...
    public final C11045c<C11079d2> create(@C12579k C11045c<?> cVar) {
        return new CatalogsRemoteDataSource$getCatalogList$2(this.this$0, cVar);
    }
    ...
    public final Object invoke(@C12580l C11045c<? super Result<? extends List<Catalog>>> cVar) {
        return ((CatalogsRemoteDataSource$getCatalogList$2) create(cVar)).invokeSuspend(C11079d2.f28267a);
    }
}
