...
/* renamed from: com.carrefour.fid.android.consent.domain.interactors.ConsentGetRefusedAndMissingConsentsUseCase$invoke$2$missingOptIns$1$2 */
public final class C36111x22ba56a7 extends Lambda implements C11300l<ConsentOptIn, Boolean> {
    public static final C36111x22ba56a7 INSTANCE = new C36111x22ba56a7();

    public C36111x22ba56a7() {
        super(1);
    }
    ...
    public final Boolean invoke(@C12579k ConsentOptIn consentOptIn) {
        ...
        return Boolean.valueOf(consentOptIn.mo117326h() == C37997a.m156421g());
    }
}
