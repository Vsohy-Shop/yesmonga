...
public final class ConsentGetConsentsUseCase$invoke$2$1 extends Lambda implements C11300l<ConsentOptIn, Boolean> {
    public static final ConsentGetConsentsUseCase$invoke$2$1 INSTANCE = new ConsentGetConsentsUseCase$invoke$2$1();

    public ConsentGetConsentsUseCase$invoke$2$1() {
        super(1);
    }
    ...
    public final Boolean invoke(@C12579k ConsentOptIn consentOptIn) {
        ...
        return Boolean.valueOf(C37997a.m156419e() == consentOptIn.mo117326h());
    }
}
