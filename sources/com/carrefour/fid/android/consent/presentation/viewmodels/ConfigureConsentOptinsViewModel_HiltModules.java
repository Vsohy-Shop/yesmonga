...
@C10264a(topLevelClass = ConfigureConsentOptinsViewModel.class)
public final class ConfigureConsentOptinsViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.consent.presentation.viewmodels.ConfigureConsentOptinsViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(ConfigureConsentOptinsViewModel configureConsentOptinsViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.consent.presentation.viewmodels.ConfigureConsentOptinsViewModel";
        }
    }

    private ConfigureConsentOptinsViewModel_HiltModules() {
    }
}
