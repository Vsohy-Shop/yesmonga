...
@C11067d(mo22501c = "com.carrefour.fid.android.shared.extension.EditTextKt$textChanges$1", mo22502f = "EditText.kt", mo22503i = {}, mo22504l = {72}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
...
public final class EditTextKt$textChanges$1 extends SuspendLambda implements C11304p<C11760r<? super String>, C11045c<? super C11079d2>, Object> {
    ...
    /* renamed from: com.carrefour.fid.android.shared.extension.EditTextKt$textChanges$1$a */
    public static final class C28709a implements TextWatcher {

        /* renamed from: a */
        public final /* synthetic */ C11760r<String> f70359a;

        public C28709a(C11760r<? super String> rVar) {
            this.f70359a = rVar;
        }

        public void afterTextChanged(@C12580l Editable editable) {
            this.f70359a.mo23751L(String.valueOf(editable));
        }
