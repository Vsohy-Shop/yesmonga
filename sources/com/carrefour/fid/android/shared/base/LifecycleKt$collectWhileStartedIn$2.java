...
public final class LifecycleKt$collectWhileStartedIn$2 extends SuspendLambda implements C11304p<T, C11045c<? super C11079d2>, Object> {
    int label;

    public LifecycleKt$collectWhileStartedIn$2(C11045c<? super LifecycleKt$collectWhileStartedIn$2> cVar) {
        super(2, cVar);
    }
    ...
    public final C11045c<C11079d2> create(@C12580l Object obj, @C12579k C11045c<?> cVar) {
        ...
        return new LifecycleKt$collectWhileStartedIn$2(cVar);
    }

    @C12580l
    /* renamed from: g */
    public final Object invoke(T t, @C12580l C11045c<? super C11079d2> cVar) {
        return ((LifecycleKt$collectWhileStartedIn$2) create(t, cVar)).invokeSuspend(C11079d2.f28267a);
    }
