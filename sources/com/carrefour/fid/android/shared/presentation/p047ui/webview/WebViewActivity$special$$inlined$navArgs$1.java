...
/* renamed from: com.carrefour.fid.android.shared.presentation.ui.webview.WebViewActivity$special$$inlined$navArgs$1 */
public final class WebViewActivity$special$$inlined$navArgs$1 extends Lambda implements C11289a<Bundle> {
    final /* synthetic */ Activity $this_navArgs;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public WebViewActivity$special$$inlined$navArgs$1(Activity activity) {
        super(0);
