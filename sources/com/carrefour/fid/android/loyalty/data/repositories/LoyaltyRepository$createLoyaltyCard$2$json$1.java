...
public final class LoyaltyRepository$createLoyaltyCard$2$json$1 extends Lambda implements C11300l<C12351e, C11079d2> {
    public static final LoyaltyRepository$createLoyaltyCard$2$json$1 INSTANCE = new LoyaltyRepository$createLoyaltyCard$2$json$1();

    public LoyaltyRepository$createLoyaltyCard$2$json$1() {
        super(1);
    }
