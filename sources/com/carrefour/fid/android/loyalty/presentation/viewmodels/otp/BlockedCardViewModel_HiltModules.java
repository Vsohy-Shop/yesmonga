...
@C10264a(topLevelClass = BlockedCardViewModel.class)
public final class BlockedCardViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.BlockedCardViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(BlockedCardViewModel blockedCardViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.BlockedCardViewModel";
        }
    }

    private BlockedCardViewModel_HiltModules() {
    }
}
