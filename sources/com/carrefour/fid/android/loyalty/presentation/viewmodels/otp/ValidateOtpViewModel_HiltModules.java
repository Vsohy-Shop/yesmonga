...
@C10264a(topLevelClass = ValidateOtpViewModel.class)
public final class ValidateOtpViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.ValidateOtpViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(ValidateOtpViewModel validateOtpViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.ValidateOtpViewModel";
        }
    }

    private ValidateOtpViewModel_HiltModules() {
    }
}
