...
@C10264a(topLevelClass = AttachCardViewModel.class)
public final class AttachCardViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.attach.AttachCardViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(AttachCardViewModel attachCardViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.attach.AttachCardViewModel";
        }
    }

    private AttachCardViewModel_HiltModules() {
    }
}
