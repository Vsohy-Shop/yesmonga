...
@C10264a(topLevelClass = ChannelsFidViewModel.class)
public final class ChannelsFidViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.ChannelsFidViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(ChannelsFidViewModel channelsFidViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.ChannelsFidViewModel";
        }
    }

    private ChannelsFidViewModel_HiltModules() {
    }
}
