...
@C10264a(topLevelClass = InitLoyaltyCardViewModel.class)
public final class InitLoyaltyCardViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.create.InitLoyaltyCardViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(InitLoyaltyCardViewModel initLoyaltyCardViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.create.InitLoyaltyCardViewModel";
        }
    }

    private InitLoyaltyCardViewModel_HiltModules() {
    }
}
