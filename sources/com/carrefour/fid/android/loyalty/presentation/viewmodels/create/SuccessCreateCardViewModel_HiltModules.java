...
@C10264a(topLevelClass = SuccessCreateCardViewModel.class)
public final class SuccessCreateCardViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.create.SuccessCreateCardViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(SuccessCreateCardViewModel successCreateCardViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.create.SuccessCreateCardViewModel";
        }
    }

    private SuccessCreateCardViewModel_HiltModules() {
    }
}
