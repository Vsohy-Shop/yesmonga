...
@C10264a(topLevelClass = LoyaltyMyCardViewModel.class)
public final class LoyaltyMyCardViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.details.LoyaltyMyCardViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(LoyaltyMyCardViewModel loyaltyMyCardViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.details.LoyaltyMyCardViewModel";
        }
    }

    private LoyaltyMyCardViewModel_HiltModules() {
    }
}
