...
@C10264a(topLevelClass = SecretCodeViewModel.class)
public final class SecretCodeViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.SecretCodeViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(SecretCodeViewModel secretCodeViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.otp.SecretCodeViewModel";
        }
    }

    private SecretCodeViewModel_HiltModules() {
    }
}
