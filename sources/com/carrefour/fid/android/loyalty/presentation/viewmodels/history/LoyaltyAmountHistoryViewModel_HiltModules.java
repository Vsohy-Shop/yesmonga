...
@C10264a(topLevelClass = LoyaltyAmountHistoryViewModel.class)
public final class LoyaltyAmountHistoryViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.loyalty.presentation.viewmodels.history.LoyaltyAmountHistoryViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(LoyaltyAmountHistoryViewModel loyaltyAmountHistoryViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.loyalty.presentation.viewmodels.history.LoyaltyAmountHistoryViewModel";
        }
    }

    private LoyaltyAmountHistoryViewModel_HiltModules() {
    }
}
