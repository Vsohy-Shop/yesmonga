...
@C11067d(mo22501c = "com.carrefour.fid.android.presentation.viewmodels.loyalty.bonus.PrimeFidListViewModel$updateFidConsents$2", mo22502f = "PrimeFidListViewModel.kt", mo22503i = {}, mo22504l = {339}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
@C11076d0(mo22515d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H@"}, mo22516d2 = {"Lkotlinx/coroutines/o0;", "Lkotlin/d2;", "<anonymous>"}, mo22517k = 3, mo22518mv = {1, 8, 0})
public final class PrimeFidListViewModel$updateFidConsents$2 extends SuspendLambda implements C11304p<C12074o0, C11045c<? super C11079d2>, Object> {
    int label;
    final /* synthetic */ PrimeFidListViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PrimeFidListViewModel$updateFidConsents$2(PrimeFidListViewModel primeFidListViewModel, C11045c<? super PrimeFidListViewModel$updateFidConsents$2> cVar) {
        super(2, cVar);
    ...
    public final C11045c<C11079d2> create(@C12580l Object obj, @C12579k C11045c<?> cVar) {
        return new PrimeFidListViewModel$updateFidConsents$2(this.this$0, cVar);
    }
    ...
    public final Object invokeSuspend(@C12579k Object obj) {
        ...
        if (i == 0) {
            ...
            C37631c l0 = this.this$0.f64800d;
            ...
            this.label = 1;
            if (l0.m172966invokegIAlus(aVar, this) == h) {
                return h;
            }
        } else if (i == 1) {
            C11661u0.m45747n(obj);
    ...
    public final Object invoke(@C12579k C12074o0 o0Var, @C12580l C11045c<? super C11079d2> cVar) {
        return ((PrimeFidListViewModel$updateFidConsents$2) create(o0Var, cVar)).invokeSuspend(C11079d2.f28267a);
    }
}
