...
@C11363r0({"SMAP\nLazyDsl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LazyDsl.kt\nandroidx/compose/foundation/lazy/LazyDslKt$itemsIndexed$4\n+ 2 OrderOnlineScreen.kt\ncom/carrefour/fid/android/presentation/viewmodels/order/refont/view/OrderOnlineScreenKt$OrderOnlineScreen$1$1\n*L\n1#1,423:1\n312#2,5:424\n*E\n"})
/* renamed from: com.carrefour.fid.android.presentation.viewmodels.order.refont.view.OrderOnlineScreenKt$OrderOnlineScreen$1$1$invoke$$inlined$itemsIndexed$default$3 */
public final class C27081x808cf939 extends Lambda implements C11306r<C2455e, Integer, C8592o, Integer, C11079d2> {
    final /* synthetic */ int $$dirty$inlined;
    final /* synthetic */ C11300l $actioner$inlined;
    final /* synthetic */ List $items;
    final /* synthetic */ List $orders$inlined;
    final /* synthetic */ C27077a $state$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C27081x808cf939(List list, List list2, C27077a aVar, C11300l lVar, int i) {
        super(4);
        this.$items = list;
        this.$orders$inlined = list2;
    ...
    @C8540g
    /* renamed from: a */
    public final void mo78730a(@C12579k C2455e eVar, int i, @C12580l C8592o oVar, int i2) {
        int i3;
        int i4;
        int i5;
        ...
        if ((i3 & 731) != 146 || !oVar.mo15011p()) {
            ...
            OrdersOnlineItemModel ordersOnlineItemModel = (OrdersOnlineItemModel) this.$items.get(i);
            if (i >= this.$orders$inlined.size() - 2 && !this.$state$inlined.mo78668i() && !this.$state$inlined.mo78669j() && this.$state$inlined.mo78665g()) {
                this.$actioner$inlined.invoke(C27028a.C27036h.f65745a);
            }
            OrderOnlineScreenKt.m114526o(ordersOnlineItemModel, this.$actioner$inlined, oVar, ((this.$$dirty$inlined >> 15) & 112) | 8);
            if (ComposerKt.m29813g0()) {
                ComposerKt.m29843v0();
                return;
            }
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3, Object obj4) {
        mo78730a((C2455e) obj, ((Number) obj2).intValue(), (C8592o) obj3, ((Number) obj4).intValue());
