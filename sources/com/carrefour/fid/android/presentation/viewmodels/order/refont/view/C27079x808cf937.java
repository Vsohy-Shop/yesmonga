...
/* renamed from: com.carrefour.fid.android.presentation.viewmodels.order.refont.view.OrderOnlineScreenKt$OrderOnlineScreen$1$1$invoke$$inlined$itemsIndexed$default$1 */
public final class C27079x808cf937 extends Lambda implements C11300l<Integer, Object> {
    final /* synthetic */ List $items;
    final /* synthetic */ C11304p $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C27079x808cf937(C11304p pVar, List list) {
        super(1);
        this.$key = pVar;
        this.$items = list;
    }
