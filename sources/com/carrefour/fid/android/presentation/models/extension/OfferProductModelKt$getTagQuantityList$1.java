...
public final class OfferProductModelKt$getTagQuantityList$1 extends Lambda implements C11300l<OfferProductModel, CharSequence> {

    /* renamed from: f */
    public static final OfferProductModelKt$getTagQuantityList$1 f97591f = new OfferProductModelKt$getTagQuantityList$1();

    public OfferProductModelKt$getTagQuantityList$1() {
        super(1);
    }
    ...
    public final CharSequence invoke(@C12579k OfferProductModel offerProductModel) {
        ...
        return String.valueOf(offerProductModel.mo121519p0());
    }
}
