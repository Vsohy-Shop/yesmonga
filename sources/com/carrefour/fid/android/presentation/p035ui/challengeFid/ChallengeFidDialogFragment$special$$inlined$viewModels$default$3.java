...
/* renamed from: com.carrefour.fid.android.presentation.ui.challengeFid.ChallengeFidDialogFragment$special$$inlined$viewModels$default$3 */
public final class ChallengeFidDialogFragment$special$$inlined$viewModels$default$3 extends Lambda implements C11289a<C19392a1> {
    final /* synthetic */ C11677z $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ChallengeFidDialogFragment$special$$inlined$viewModels$default$3(C11677z zVar) {
        super(0);
