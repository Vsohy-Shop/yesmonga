...
/* renamed from: com.carrefour.fid.android.presentation.ui.loyalty.fragments.create.compose.CreateLoyaltyCardStepTwoScreenKt$UserAddressField$10$1 */
public final class CreateLoyaltyCardStepTwoScreenKt$UserAddressField$10$1 extends Lambda implements C11300l<String, C11079d2> {
    final /* synthetic */ C11300l<C24396c, C11079d2> $actioner;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CreateLoyaltyCardStepTwoScreenKt$UserAddressField$10$1(C11300l<? super C24396c, C11079d2> lVar) {
        super(1);
        this.$actioner = lVar;
    }
    ...
    public final void invoke(@C12579k String str) {
        ...
        this.$actioner.invoke(new C24396c.C24399c(str));
        if (str.length() == 0) {
