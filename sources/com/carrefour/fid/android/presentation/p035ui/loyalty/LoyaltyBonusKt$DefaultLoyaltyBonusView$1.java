...
/* renamed from: com.carrefour.fid.android.presentation.ui.loyalty.LoyaltyBonusKt$DefaultLoyaltyBonusView$1 */
public final class LoyaltyBonusKt$DefaultLoyaltyBonusView$1 extends Lambda implements C11289a<C11079d2> {
    final /* synthetic */ C11300l<C24220a, C11079d2> $action;
    final /* synthetic */ List<LoyaltyBonus> $primes;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LoyaltyBonusKt$DefaultLoyaltyBonusView$1(C11300l<? super C24220a, C11079d2> lVar, List<LoyaltyBonus> list) {
        super(0);
        this.$action = lVar;
        this.$primes = list;
    }
