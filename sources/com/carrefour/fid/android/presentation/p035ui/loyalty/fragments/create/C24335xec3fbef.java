...
/* renamed from: com.carrefour.fid.android.presentation.ui.loyalty.fragments.create.CreateLoyaltyCardStepOneFragment$special$$inlined$hiltNavGraphViewModels$2 */
public final class C24335xec3fbef extends Lambda implements C11289a<C19392a1> {
    final /* synthetic */ C11677z $backStackEntry;
    final /* synthetic */ C11510n $backStackEntry$metadata;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C24335xec3fbef(C11677z zVar, C11510n nVar) {
        super(0);
