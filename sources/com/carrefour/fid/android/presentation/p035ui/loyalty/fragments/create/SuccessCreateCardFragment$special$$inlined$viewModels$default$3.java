...
/* renamed from: com.carrefour.fid.android.presentation.ui.loyalty.fragments.create.SuccessCreateCardFragment$special$$inlined$viewModels$default$3 */
public final class SuccessCreateCardFragment$special$$inlined$viewModels$default$3 extends Lambda implements C11289a<C19392a1> {
    final /* synthetic */ C11677z $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SuccessCreateCardFragment$special$$inlined$viewModels$default$3(C11677z zVar) {
        super(0);
