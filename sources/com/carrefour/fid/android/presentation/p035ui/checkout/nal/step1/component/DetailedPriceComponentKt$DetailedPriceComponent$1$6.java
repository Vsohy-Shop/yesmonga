...
@C11363r0({"SMAP\nDetailedPriceComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DetailedPriceComponent.kt\ncom/carrefour/fid/android/presentation/ui/checkout/nal/step1/component/DetailedPriceComponentKt$DetailedPriceComponent$1$6\n+ 2 CompositionLocal.kt\nandroidx/compose/runtime/CompositionLocal\n*L\n1#1,161:1\n76#2:162\n*S KotlinDebug\n*F\n+ 1 DetailedPriceComponent.kt\ncom/carrefour/fid/android/presentation/ui/checkout/nal/step1/component/DetailedPriceComponentKt$DetailedPriceComponent$1$6\n*L\n118#1:162\n*E\n"})
/* renamed from: com.carrefour.fid.android.presentation.ui.checkout.nal.step1.component.DetailedPriceComponentKt$DetailedPriceComponent$1$6 */
public final class DetailedPriceComponentKt$DetailedPriceComponent$1$6 extends Lambda implements C11304p<C8592o, Integer, C11079d2> {
    final /* synthetic */ BasketAmounts $basketAmount;
    final /* synthetic */ int $nbItems;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DetailedPriceComponentKt$DetailedPriceComponent$1$6(int i, BasketAmounts basketAmounts) {
        super(2);
        this.$nbItems = i;
    ...
    public final void invoke(@C12580l C8592o oVar, int i) {
        ...
        if ((i2 & 11) != 2 || !oVar.mo15011p()) {
            if (ComposerKt.m29813g0()) {
                ComposerKt.m29845w0(-945872053, i2, -1, "com.carrefour.fid.android.presentation.ui.checkout.nal.step1.component.DetailedPriceComponent.<anonymous>.<anonymous> (DetailedPriceComponent.kt:115)");
            }
