...
/* renamed from: com.carrefour.fid.android.presentation.ui.checkout.al.CheckoutStep1Fragment$handleOfferListResult$2$3 */
public final class CheckoutStep1Fragment$handleOfferListResult$2$3 extends Lambda implements C11300l<C37133a, C11079d2> {
    ...
    public CheckoutStep1Fragment$handleOfferListResult$2$3(CheckoutStep1Fragment checkoutStep1Fragment, OfferModel offerModel, List<? extends OfferProductModel> list) {
        super(1);
    ...
    /* renamed from: a */
    public final void mo68207a(@C12579k C37133a aVar) {
        Intrinsics.checkNotNullParameter(aVar, "it");
        CheckoutStep1Fragment checkoutStep1Fragment = this.this$0;
        OfferModel offerModel = this.$offer;
        checkoutStep1Fragment.mo68150Y((OfferProductModel) offerModel, this.$displayedList.indexOf(offerModel) + 1);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo68207a((C37133a) obj);
