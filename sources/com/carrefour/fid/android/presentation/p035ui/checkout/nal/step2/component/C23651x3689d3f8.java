...
/* renamed from: com.carrefour.fid.android.presentation.ui.checkout.nal.step2.component.OpeningComponentKt$OpeningComponent$2$3$invoke$$inlined$itemsIndexed$default$1 */
public final class C23651x3689d3f8 extends Lambda implements C11300l<Integer, Object> {
    final /* synthetic */ List $items;
    final /* synthetic */ C11304p $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C23651x3689d3f8(C11304p pVar, List list) {
        super(1);
        this.$key = pVar;
        this.$items = list;
    }
