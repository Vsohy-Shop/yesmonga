...
/* renamed from: com.carrefour.fid.android.presentation.ui.account.BaseAccountFragment$special$$inlined$viewModels$default$4 */
public final class BaseAccountFragment$special$$inlined$viewModels$default$4 extends Lambda implements C11289a<C19477a> {
    final /* synthetic */ C11289a $extrasProducer;
    final /* synthetic */ C11677z $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BaseAccountFragment$special$$inlined$viewModels$default$4(C11289a aVar, C11677z zVar) {
        super(0);
