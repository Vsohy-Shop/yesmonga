...
/* renamed from: com.carrefour.fid.android.presentation.ui.account.list.memo.MemoListFragment$onViewCreated$2 */
public final class MemoListFragment$onViewCreated$2 extends Lambda implements C11300l<String, C11079d2> {
    final /* synthetic */ MemoListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MemoListFragment$onViewCreated$2(MemoListFragment memoListFragment) {
        super(1);
    ...
    public final void invoke(@C12579k String str) {
        ...
        if (Intrinsics.areEqual((Object) str, (Object) C36168a.f89274b)) {
            this.this$0.mo67535X0().sendIntent(MemoListViewModel.C25826e.C25829c.f63255b);
