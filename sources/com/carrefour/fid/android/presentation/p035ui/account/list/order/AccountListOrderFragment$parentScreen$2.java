...
/* renamed from: com.carrefour.fid.android.presentation.ui.account.list.order.AccountListOrderFragment$parentScreen$2 */
public final class AccountListOrderFragment$parentScreen$2 extends Lambda implements C11289a<AccountListFragment.ParentScreen> {
    final /* synthetic */ AccountListOrderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AccountListOrderFragment$parentScreen$2(AccountListOrderFragment accountListOrderFragment) {
        super(0);
