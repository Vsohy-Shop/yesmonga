...
/* renamed from: com.carrefour.fid.android.presentation.ui.account.list.order.AccountListOrderFragment$handleLastListResult$offerProductModels$1$1 */
public final class C22997xebeeffd1 extends Lambda implements C11300l<C37133a, C11079d2> {
    ...
    public C22997xebeeffd1(AccountListOrderFragment accountListOrderFragment, OfferModel offerModel, List<? extends OfferProductModel> list) {
        super(1);
    ...
    /* renamed from: a */
    public final void mo67614a(@C12579k C37133a aVar) {
        Intrinsics.checkNotNullParameter(aVar, "it");
        AccountListOrderFragment accountListOrderFragment = this.this$0;
        OfferModel offerModel = this.$offer;
        accountListOrderFragment.mo67591o0((OfferProductModel) offerModel, this.$displayedOffers.indexOf(offerModel) + 1);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo67614a((C37133a) obj);
