...
/* renamed from: com.carrefour.fid.android.presentation.ui.account.list.order.AccountListOrderFragment$handleOnMixingPressed$1 */
public final class AccountListOrderFragment$handleOnMixingPressed$1 extends Lambda implements C11300l<Bundle, C11079d2> {
    final /* synthetic */ AccountListOrderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AccountListOrderFragment$handleOnMixingPressed$1(AccountListOrderFragment accountListOrderFragment) {
        super(1);
        this.this$0 = accountListOrderFragment;
    }

    /* renamed from: a */
    public final void mo67617a(@C12579k Bundle bundle) {
