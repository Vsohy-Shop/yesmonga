...
/* renamed from: com.carrefour.fid.android.presentation.ui.product.search.result.ProductSearchWithListAllResultsFragment$special$$inlined$viewModels$default$4 */
public final class C25612x9552a06a extends Lambda implements C11289a<C19477a> {
    final /* synthetic */ C11289a $extrasProducer;
    final /* synthetic */ C11677z $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C25612x9552a06a(C11289a aVar, C11677z zVar) {
        super(0);
