...
/* renamed from: com.carrefour.fid.android.presentation.ui.product.list.adapter.CriteoFlagshipViewHolder$bindProductList$1$3 */
public final class CriteoFlagshipViewHolder$bindProductList$1$3 extends Lambda implements C11300l<C37133a, C11079d2> {
    final /* synthetic */ C24646a.C24647a $baseCallbacks;
    final /* synthetic */ CriteoProductModel $criteoProduct;
    final /* synthetic */ int $position;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CriteoFlagshipViewHolder$bindProductList$1$3(C24646a.C24647a aVar, CriteoProductModel criteoProductModel, int i) {
        super(1);
    ...
    /* renamed from: a */
    public final void mo74162a(@C12579k C37133a aVar) {
        Intrinsics.checkNotNullParameter(aVar, "it");
        this.$baseCallbacks.mo68150Y(this.$criteoProduct, this.$position + 1);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo74162a((C37133a) obj);
