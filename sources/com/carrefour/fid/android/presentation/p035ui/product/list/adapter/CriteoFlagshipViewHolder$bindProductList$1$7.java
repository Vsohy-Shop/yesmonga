...
/* renamed from: com.carrefour.fid.android.presentation.ui.product.list.adapter.CriteoFlagshipViewHolder$bindProductList$1$7 */
public final class CriteoFlagshipViewHolder$bindProductList$1$7 extends Lambda implements C11289a<C11079d2> {
    final /* synthetic */ CriteoProductModel $criteoProduct;
    final /* synthetic */ C24646a.C24648b $mixingCallbacks;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CriteoFlagshipViewHolder$bindProductList$1$7(C24646a.C24648b bVar, CriteoProductModel criteoProductModel) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (bVar != null) {
            bVar.mo72034z(this.$criteoProduct);
        }
    }
}
