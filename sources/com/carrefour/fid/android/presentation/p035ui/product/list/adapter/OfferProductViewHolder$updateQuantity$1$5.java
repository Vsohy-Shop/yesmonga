...
@C11067d(mo22501c = "com.carrefour.fid.android.presentation.ui.product.list.adapter.OfferProductViewHolder$updateQuantity$1$5", mo22502f = "OfferListViewHolder.kt", mo22503i = {}, mo22504l = {}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
@C11076d0(mo22515d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u00002\u0006\u0010\u0001\u001a\u00020\u0000H@"}, mo22516d2 = {"Lkotlin/d2;", "it", "<anonymous>"}, mo22517k = 3, mo22518mv = {1, 8, 0})
/* renamed from: com.carrefour.fid.android.presentation.ui.product.list.adapter.OfferProductViewHolder$updateQuantity$1$5 */
public final class OfferProductViewHolder$updateQuantity$1$5 extends SuspendLambda implements C11304p<C11079d2, C11045c<? super C11079d2>, Object> {
    ...
    public OfferProductViewHolder$updateQuantity$1$5(OfferProductModel offerProductModel, QuantityView quantityView, Offer offer, OfferProductViewHolder offerProductViewHolder, C11045c<? super OfferProductViewHolder$updateQuantity$1$5> cVar) {
        super(2, cVar);
    ...
    public final C11045c<C11079d2> create(@C12580l Object obj, @C12579k C11045c<?> cVar) {
        return new OfferProductViewHolder$updateQuantity$1$5(this.$offerProductModel, this.$this_apply, this.$offer, this.this$0, cVar);
    }

    @C12580l
    /* renamed from: g */
    public final Object invoke(@C12579k C11079d2 d2Var, @C12580l C11045c<? super C11079d2> cVar) {
        return ((OfferProductViewHolder$updateQuantity$1$5) create(d2Var, cVar)).invokeSuspend(C11079d2.f28267a);
    }
    ...
    public final Object invokeSuspend(@C12579k Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (this.$offerProductModel.mo121519p0() > 1) {
                ...
                this.this$0.mo74181I(this.$offerProductModel);
            }
