...
/* renamed from: com.carrefour.fid.android.presentation.ui.product.list.adapter.CriteoButterflyViewHolder$bind$2 */
public final class CriteoButterflyViewHolder$bind$2 extends Lambda implements C11300l<C37133a, C11079d2> {
    final /* synthetic */ C24646a.C24647a $baseCallbacks;
    final /* synthetic */ int $position;
    final /* synthetic */ CriteoProductModel $product;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CriteoButterflyViewHolder$bind$2(C24646a.C24647a aVar, CriteoProductModel criteoProductModel, int i) {
        super(1);
    ...
    /* renamed from: a */
    public final void mo74151a(@C12579k C37133a aVar) {
        Intrinsics.checkNotNullParameter(aVar, "it");
        this.$baseCallbacks.mo68148J(this.$product, this.$position + 1);
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo74151a((C37133a) obj);
