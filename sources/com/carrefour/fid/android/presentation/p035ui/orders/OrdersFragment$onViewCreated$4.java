...
/* renamed from: com.carrefour.fid.android.presentation.ui.orders.OrdersFragment$onViewCreated$4 */
public final class OrdersFragment$onViewCreated$4 extends Lambda implements C11300l<String, C11079d2> {
    final /* synthetic */ OrdersFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OrdersFragment$onViewCreated$4(OrdersFragment ordersFragment) {
        super(1);
    ...
    public final void invoke(@C12579k String str) {
        ...
        if (Intrinsics.areEqual((Object) str, (Object) C36168a.f89274b)) {
            this.this$0.mo72074T0().sendIntent(OrdersViewModel.C26640b.C26642b.f65058b);
