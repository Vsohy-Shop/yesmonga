...
@C11067d(mo22501c = "com.carrefour.fid.android.storelocator.presentation.presenters.FacilitiesSearchPresenter$onSearchStoreClicked$1", mo22502f = "FacilitiesSearchPresenter.kt", mo22503i = {}, mo22504l = {213}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
@C11076d0(mo22515d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H@"}, mo22516d2 = {"Lkotlinx/coroutines/o0;", "Lkotlin/d2;", "<anonymous>"}, mo22517k = 3, mo22518mv = {1, 8, 0})
public final class FacilitiesSearchPresenter$onSearchStoreClicked$1 extends SuspendLambda implements C11304p<C12074o0, C11045c<? super C11079d2>, Object> {
    final /* synthetic */ LatLng $latLng;
    int label;
    final /* synthetic */ FacilitiesSearchPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FacilitiesSearchPresenter$onSearchStoreClicked$1(FacilitiesSearchPresenter facilitiesSearchPresenter, LatLng latLng, C11045c<? super FacilitiesSearchPresenter$onSearchStoreClicked$1> cVar) {
        super(2, cVar);
    ...
    public final C11045c<C11079d2> create(@C12580l Object obj, @C12579k C11045c<?> cVar) {
        return new FacilitiesSearchPresenter$onSearchStoreClicked$1(this.this$0, this.$latLng, cVar);
    }
    ...
    public final Object invokeSuspend(@C12579k Object obj) {
        ...
        if (Result.m38710j(obj2)) {
            facilitiesSearchPresenter.mo84334u((C38166m) obj2, false);
        }
        ...
        if (e != null) {
            ...
            if (oneAppServiceException == null) {
                oneAppServiceException = OneAppServiceException.f89687a.mo108370c(e);
            }
            facilitiesSearchPresenter2.mo84303g(oneAppServiceException);
        }
        this.this$0.mo84298b();
        return C11079d2.f28267a;
    }

    @C12580l
    public final Object invoke(@C12579k C12074o0 o0Var, @C12580l C11045c<? super C11079d2> cVar) {
        return ((FacilitiesSearchPresenter$onSearchStoreClicked$1) create(o0Var, cVar)).invokeSuspend(C11079d2.f28267a);
    }
}
