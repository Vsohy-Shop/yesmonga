...
@C10264a(topLevelClass = DriveMapViewModel.class)
public final class DriveMapViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.service.presentation.viewmodels.drive.DriveMapViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(DriveMapViewModel driveMapViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.service.presentation.viewmodels.drive.DriveMapViewModel";
        }
    }

    private DriveMapViewModel_HiltModules() {
    }
}
