...
@C10264a(topLevelClass = DeliverySummaryViewModel.class)
public final class DeliverySummaryViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.service.presentation.viewmodels.delivery.mvi.summary.DeliverySummaryViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(DeliverySummaryViewModel deliverySummaryViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.service.presentation.viewmodels.delivery.mvi.summary.DeliverySummaryViewModel";
        }
    }

    private DeliverySummaryViewModel_HiltModules() {
    }
}
