...
@C10264a(topLevelClass = DriveSummaryViewModel.class)
public final class DriveSummaryViewModel_HiltModules {
    ...
    public static abstract class BindsModule {
        ...
        @C10356h("com.carrefour.fid.android.service.presentation.viewmodels.drive.DriveSummaryViewModel")
        @C10147a
        @C10207e
        @C10352d
        public abstract C19476v0 binds(DriveSummaryViewModel driveSummaryViewModel);
    }
    ...
    public static final class KeyModule {
        ...
        public static String provide() {
            return "com.carrefour.fid.android.service.presentation.viewmodels.drive.DriveSummaryViewModel";
        }
    }

    private DriveSummaryViewModel_HiltModules() {
    }
}
