...
public final class ServiceDataStore$json$1 extends Lambda implements C11300l<C12351e, C11079d2> {
    public static final ServiceDataStore$json$1 INSTANCE = new ServiceDataStore$json$1();

    public ServiceDataStore$json$1() {
        super(1);
    }
