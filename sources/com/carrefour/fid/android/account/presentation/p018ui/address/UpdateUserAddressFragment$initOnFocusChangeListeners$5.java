...
/* renamed from: com.carrefour.fid.android.account.presentation.ui.address.UpdateUserAddressFragment$initOnFocusChangeListeners$5 */
public final class UpdateUserAddressFragment$initOnFocusChangeListeners$5 extends Lambda implements C11300l<String, C11079d2> {
    final /* synthetic */ UpdateUserAddressFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public UpdateUserAddressFragment$initOnFocusChangeListeners$5(UpdateUserAddressFragment updateUserAddressFragment) {
        super(1);
