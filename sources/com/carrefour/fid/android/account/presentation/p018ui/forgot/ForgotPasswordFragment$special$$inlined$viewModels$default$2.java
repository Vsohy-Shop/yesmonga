...
/* renamed from: com.carrefour.fid.android.account.presentation.ui.forgot.ForgotPasswordFragment$special$$inlined$viewModels$default$2 */
public final class ForgotPasswordFragment$special$$inlined$viewModels$default$2 extends Lambda implements C11289a<C19392a1> {
    final /* synthetic */ C11289a $ownerProducer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ForgotPasswordFragment$special$$inlined$viewModels$default$2(C11289a aVar) {
        super(0);
