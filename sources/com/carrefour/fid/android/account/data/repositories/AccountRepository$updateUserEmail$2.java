...
@C11067d(mo22501c = "com.carrefour.fid.android.account.data.repositories.AccountRepository$updateUserEmail$2", mo22502f = "AccountRepository.kt", mo22503i = {}, mo22504l = {247, 251}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
...
public final class AccountRepository$updateUserEmail$2 extends SuspendLambda implements C11300l<C11045c<? super Result<? extends AccountInfo>>, Object> {
    ...
    public AccountRepository$updateUserEmail$2(AccountRepository accountRepository, String str, AccountInfo accountInfo, C11045c<? super AccountRepository$updateUserEmail$2> cVar) {
        super(1, cVar);
    ...
    public final C11045c<C11079d2> create(@C12579k C11045c<?> cVar) {
        return new AccountRepository$updateUserEmail$2(this.this$0, this.$email, this.$newUserInfo, cVar);
    }
    ...
    public final Object invokeSuspend(@C12579k Object obj) {
        ...
        obj2 = Result.m38702b(C11661u0.m45734a(C28639a.m118565d(wVar, "Unable to save the user email")));
        return Result.m38701a(obj2);
    }

    @C12580l
    public final Object invoke(@C12580l C11045c<? super Result<AccountInfo>> cVar) {
        return ((AccountRepository$updateUserEmail$2) create(cVar)).invokeSuspend(C11079d2.f28267a);
    }
}
