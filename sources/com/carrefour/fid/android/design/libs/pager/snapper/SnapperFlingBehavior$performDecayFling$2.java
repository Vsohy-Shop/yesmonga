...
public final class SnapperFlingBehavior$performDecayFling$2 extends Lambda implements C11300l<C1964f<Float, C1983k>, C11079d2> {
    ...
    public SnapperFlingBehavior$performDecayFling$2(Ref.FloatRef floatRef, C2201l lVar, Ref.FloatRef floatRef2, SnapperFlingBehavior snapperFlingBehavior, boolean z, int i) {
        super(1);
    ...
    /* renamed from: a */
    public final void mo114161a(@C12579k C1964f<Float, C1983k> fVar) {
        ...
        C37473e e = this.this$0.f94111a.mo114135e();
        if (e == null) {
            fVar.mo6822a();
            return;
        }
        if (fVar.mo6831j() && this.$canSpringThenFling) {
            if (fVar.mo6829h().floatValue() > 0.0f && e.mo114170a() == this.$targetIndex - 1) {
                fVar.mo6822a();
            } else if (fVar.mo6829h().floatValue() < 0.0f && e.mo114170a() == this.$targetIndex) {
                fVar.mo6822a();
            }
        }
        if (fVar.mo6831j() && this.this$0.mo114158n(fVar, e, this.$targetIndex, new C11300l<Float, Float>(this.$this_performDecayFling) {
            @C12579k
            /* renamed from: d */
            public final Float mo114162d(float f) {
                return Float.valueOf(((C2201l) this.receiver).mo7360a(f));
            }

            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                return mo114162d(((Number) obj).floatValue());
            }
        })) {
            fVar.mo6822a();
        }
