...
public final class BannerComponentKt$BannerMedium$2$1$1 extends Lambda implements C11300l<C16044q, C11079d2> {
    final /* synthetic */ String $bannerContentDescription;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BannerComponentKt$BannerMedium$2$1$1(String str) {
        super(1);
    ...
    public final void invoke(@C12579k C16044q qVar) {
        ...
        if (str != null) {
            SemanticsPropertiesKt.m71959G0(qVar, str);
        }
    }
}
