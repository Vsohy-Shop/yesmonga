...
@C11363r0({"SMAP\nHeaderComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 HeaderComponent.kt\ncom/carrefour/fid/android/design/components/compose/HeaderComponentKt$DsHeader$1\n+ 2 Dp.kt\nandroidx/compose/ui/unit/DpKt\n*L\n1#1,607:1\n154#2:608\n*S KotlinDebug\n*F\n+ 1 HeaderComponent.kt\ncom/carrefour/fid/android/design/components/compose/HeaderComponentKt$DsHeader$1\n*L\n74#1:608\n*E\n"})
public final class HeaderComponentKt$DsHeader$1 extends Lambda implements C11304p<C8592o, Integer, C11079d2> {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ String $title;
    final /* synthetic */ C16361p0 $titleStyle;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HeaderComponentKt$DsHeader$1(String str, C16361p0 p0Var, int i) {
        super(2);
        this.$title = str;
    ...
    public final void invoke(@C12580l C8592o oVar, int i) {
        ...
        if ((i2 & 11) != 2 || !oVar.mo15011p()) {
            if (ComposerKt.m29813g0()) {
                ComposerKt.m29845w0(828886220, i2, -1, "com.carrefour.fid.android.design.components.compose.DsHeader.<anonymous> (HeaderComponent.kt:71)");
            }
