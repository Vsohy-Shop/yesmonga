...
public final class PriceComponentKt$SimplePrice$1$1 extends Lambda implements C11300l<C16044q, C11079d2> {
    final /* synthetic */ Context $context;
    final /* synthetic */ String $price;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PriceComponentKt$SimplePrice$1$1(String str, Context context) {
        super(1);
        this.$price = str;
