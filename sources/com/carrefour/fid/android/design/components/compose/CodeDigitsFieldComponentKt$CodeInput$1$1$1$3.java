...
public final class CodeDigitsFieldComponentKt$CodeInput$1$1$1$3 extends Lambda implements C11289a<C11079d2> {
    final /* synthetic */ C11300l<C36965b, C11079d2> $actioner;
    final /* synthetic */ List<String> $digitList;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CodeDigitsFieldComponentKt$CodeInput$1$1$1$3(C11300l<? super C36965b, C11079d2> lVar, List<String> list) {
        super(0);
        this.$actioner = lVar;
        this.$digitList = list;
    }
