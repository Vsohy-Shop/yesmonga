...
/* renamed from: com.carrefour.fid.android.product.presentation.ui.facet.facets.FacetStatefulKt$SortAndFilterList$1$invoke$$inlined$items$default$7 */
public final class C27983x2195799f extends Lambda implements C11300l<Integer, Object> {
    final /* synthetic */ List $items;
    final /* synthetic */ C11300l $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C27983x2195799f(C11300l lVar, List list) {
        super(1);
        this.$key = lVar;
        this.$items = list;
    }
