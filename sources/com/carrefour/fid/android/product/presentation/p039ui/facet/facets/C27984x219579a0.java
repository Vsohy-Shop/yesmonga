...
/* renamed from: com.carrefour.fid.android.product.presentation.ui.facet.facets.FacetStatefulKt$SortAndFilterList$1$invoke$$inlined$items$default$8 */
public final class C27984x219579a0 extends Lambda implements C11304p<C2497l, Integer, C2488d> {
    final /* synthetic */ List $items;
    final /* synthetic */ C11304p $span;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C27984x219579a0(C11304p pVar, List list) {
        super(2);
        this.$span = pVar;
        this.$items = list;
    }
    ...
    /* renamed from: a */
    public final long mo81439a(@C12579k C2497l lVar, int i) {
        Intrinsics.checkNotNullParameter(lVar, "$this$null");
        return ((C2488d) this.$span.invoke(lVar, this.$items.get(i))).mo8563i();
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return C2488d.m11156a(mo81439a((C2497l) obj, ((Number) obj2).intValue()));
    }
}
