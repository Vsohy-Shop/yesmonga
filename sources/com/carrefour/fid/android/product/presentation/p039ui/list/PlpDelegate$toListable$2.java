...
/* renamed from: com.carrefour.fid.android.product.presentation.ui.list.PlpDelegate$toListable$2 */
public final class PlpDelegate$toListable$2 extends Lambda implements C11300l<C37133a, C11079d2> {
    final /* synthetic */ int $position;
    final /* synthetic */ C27670g $this_toListable;
    final /* synthetic */ PlpDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PlpDelegate$toListable$2(PlpDelegate plpDelegate, C27670g gVar, int i) {
        super(1);
    ...
    /* renamed from: a */
    public final void mo81535a(@C12579k C37133a aVar) {
        Intrinsics.checkNotNullParameter(aVar, "it");
        this.this$0.f67872j.add(aVar);
        PlpOffer i = C27662e.m116389i(((C27670g.C27676f) this.$this_toListable).mo80412e().mo118842j());
        if (i != null) {
            this.this$0.mo81509o().sendIntent(new PlpViewModel.C28181c.C28188g(i, this.$position));
            this.this$0.f67867e.mo80229f(((C27670g.C27676f) this.$this_toListable).mo80412e().mo118842j(), 0, this.$position);
        }
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        mo81535a((C37133a) obj);
