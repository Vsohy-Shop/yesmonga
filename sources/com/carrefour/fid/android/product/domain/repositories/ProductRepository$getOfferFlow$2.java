...
@C11067d(mo22501c = "com.carrefour.fid.android.product.domain.repositories.ProductRepository$getOfferFlow$2", mo22502f = "ProductRepository.kt", mo22503i = {0, 1}, mo22504l = {25, 26, 27}, mo22505m = "invokeSuspend", mo22506n = {"$this$flow", "$this$flow"}, mo22507s = {"L$0", "L$0"})
@C11076d0(mo22515d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0004\u001a\u00020\u0003*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00010\u0000H@"}, mo22516d2 = {"Lkotlinx/coroutines/flow/f;", "Lcom/carrefour/fid/android/core/types/a;", "Lcom/carrefour/fid/android/domain/models/offer/Offer;", "Lkotlin/d2;", "<anonymous>"}, mo22517k = 3, mo22518mv = {1, 8, 0})
@C11363r0({"SMAP\nProductRepository.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ProductRepository.kt\ncom/carrefour/fid/android/product/domain/repositories/ProductRepository$getOfferFlow$2\n+ 2 ResultL.kt\ncom/carrefour/fid/android/core/types/ResultLKt\n+ 3 ResultL.kt\ncom/carrefour/fid/android/core/types/ResultL$Companion\n*L\n1#1,43:1\n195#2,3:44\n198#2:48\n85#3:47\n*S KotlinDebug\n*F\n+ 1 ProductRepository.kt\ncom/carrefour/fid/android/product/domain/repositories/ProductRepository$getOfferFlow$2\n*L\n27#1:44,3\n27#1:48\n27#1:47\n*E\n"})
public final class ProductRepository$getOfferFlow$2 extends SuspendLambda implements C11304p<C11908f<? super C36371a<? extends Offer>>, C11045c<? super C11079d2>, Object> {
    ...
    public ProductRepository$getOfferFlow$2(ProductRepository productRepository, String str, String str2, String str3, C11045c<? super ProductRepository$getOfferFlow$2> cVar) {
        super(2, cVar);
    ...
    public final C11045c<C11079d2> create(@C12580l Object obj, @C12579k C11045c<?> cVar) {
        ProductRepository$getOfferFlow$2 productRepository$getOfferFlow$2 = new ProductRepository$getOfferFlow$2(this.this$0, this.$storeService, this.$gtin, this.$slotSlice, cVar);
        productRepository$getOfferFlow$2.L$0 = obj;
        return productRepository$getOfferFlow$2;
    }

    @C12580l
    /* renamed from: g */
    public final Object invoke(@C12579k C11908f<? super C36371a<Offer>> fVar, @C12580l C11045c<? super C11079d2> cVar) {
        return ((ProductRepository$getOfferFlow$2) create(fVar, cVar)).invokeSuspend(C11079d2.f28267a);
    }
    ...
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.C12579k java.lang.Object r8) {
        ...
        L_0x006c:
            ...
            com.carrefour.fid.android.domain.models.offer.Offer r8 = r8.mo80087f()
        ...
        L_0x0098:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.carrefour.fid.android.product.domain.repositories.ProductRepository$getOfferFlow$2.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
