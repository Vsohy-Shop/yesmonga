...
@C11067d(mo22501c = "com.carrefour.fid.android.basket.domain.repositories.BasketRepository$deleteOfferByBasketReference$2", mo22502f = "BasketRepository.kt", mo22503i = {}, mo22504l = {149, 156}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
@C11076d0(mo22515d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00010\u0000H@"}, mo22516d2 = {"Lkotlin/Result;", "", "<anonymous>"}, mo22517k = 3, mo22518mv = {1, 8, 0})
@C11363r0({"SMAP\nBasketRepository.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BasketRepository.kt\ncom/carrefour/fid/android/basket/domain/repositories/BasketRepository$deleteOfferByBasketReference$2\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,386:1\n2624#2,3:387\n1#3:390\n*S KotlinDebug\n*F\n+ 1 BasketRepository.kt\ncom/carrefour/fid/android/basket/domain/repositories/BasketRepository$deleteOfferByBasketReference$2\n*L\n155#1:387,3\n*E\n"})
public final class BasketRepository$deleteOfferByBasketReference$2 extends SuspendLambda implements C11300l<C11045c<? super Result<? extends Boolean>>, Object> {
    final /* synthetic */ String $basketReference;
    final /* synthetic */ String $gtin;
    final /* synthetic */ boolean $synchronize;
    int label;
    final /* synthetic */ BasketRepository this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BasketRepository$deleteOfferByBasketReference$2(BasketRepository basketRepository, String str, String str2, boolean z, C11045c<? super BasketRepository$deleteOfferByBasketReference$2> cVar) {
        super(1, cVar);
    ...
    public final C11045c<C11079d2> create(@C12579k C11045c<?> cVar) {
        return new BasketRepository$deleteOfferByBasketReference$2(this.this$0, this.$basketReference, this.$gtin, this.$synchronize, cVar);
    }
    ...
    public final Object invokeSuspend(@C12579k Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj3 = b.mo32786e(str, str2, z2, this);
            if (obj3 == h) {
                return h;
            }
        } else if (i == 1) {
        ...
        String str3 = this.$basketReference;
        ...
        if (e == null) {
            ...
            if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (BasketReference.m156097f(((Basket) it.next()).mo116822G(), str3)) {
                            z = false;
                            break;
                        }
                    } else {
    ...
    public final Object invoke(@C12580l C11045c<? super Result<Boolean>> cVar) {
        return ((BasketRepository$deleteOfferByBasketReference$2) create(cVar)).invokeSuspend(C11079d2.f28267a);
    }
}
