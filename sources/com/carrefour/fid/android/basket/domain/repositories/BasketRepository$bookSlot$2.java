...
@C11067d(mo22501c = "com.carrefour.fid.android.basket.domain.repositories.BasketRepository$bookSlot$2", mo22502f = "BasketRepository.kt", mo22503i = {}, mo22504l = {80, 81}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
...
@C11363r0({"SMAP\nBasketRepository.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BasketRepository.kt\ncom/carrefour/fid/android/basket/domain/repositories/BasketRepository$bookSlot$2\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,386:1\n1#2:387\n*E\n"})
public final class BasketRepository$bookSlot$2 extends SuspendLambda implements C11300l<C11045c<? super Result<? extends Basket>>, Object> {
    ...
    public BasketRepository$bookSlot$2(BasketRepository basketRepository, String str, Basket basket, C11045c<? super BasketRepository$bookSlot$2> cVar) {
        super(1, cVar);
    ...
    public final C11045c<C11079d2> create(@C12579k C11045c<?> cVar) {
        return new BasketRepository$bookSlot$2(this.this$0, this.$slotId, this.$currentBasket, cVar);
    }
    ...
    public final Object invoke(@C12580l C11045c<? super Result<Basket>> cVar) {
        return ((BasketRepository$bookSlot$2) create(cVar)).invokeSuspend(C11079d2.f28267a);
    }
}
