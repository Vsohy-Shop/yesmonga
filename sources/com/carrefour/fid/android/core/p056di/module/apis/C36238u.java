...
@C8567o(parameters = 0)
/* renamed from: com.carrefour.fid.android.core.di.module.apis.u */
public final class C36238u {

    /* renamed from: a */
    public static final int f89536a = 0;

    @C10315i
    @C12579k
    /* renamed from: a */
    public final LinkLoyaltyCardApiService mo108203a(@C10255b @C12579k Context context, @C12579k AppEnvironment appEnvironment, @C12579k C36151f fVar, @C12579k TokenAuthenticator tokenAuthenticator, @C12579k C28826i iVar, @C12579k LogMInterceptor logMInterceptor, @C12579k C28833m mVar) {
        ...
        Object g = new GenericNetworkService.Builder(context, (C28835a) null, (C28816c) null, 6, (DefaultConstructorMarker) null).mo83857i(appEnvironment.mo84164d()).mo83855g(CollectionsKt__CollectionsKt.m40448L(iVar, logMInterceptor, fVar, mVar)).mo83850b(tokenAuthenticator).mo83854f(new Pair[0]).mo83869v(true).mo83859k("com.carrefour.fid.android").mo30586g(LinkLoyaltyCardApiService.class);
        Intrinsics.checkNotNullExpressionValue(g, "Builder(context)\n       …rdApiService::class.java)");
        return (LinkLoyaltyCardApiService) g;
    }
}
