...
@C8567o(parameters = 0)
/* renamed from: com.carrefour.fid.android.core.di.module.apis.n0 */
public final class C36225n0 {

    /* renamed from: a */
    public static final int f89490a = 0;

    @C10315i
    @C12579k
    /* renamed from: a */
    public final C36621b mo108189a(@C10255b @C12579k Context context, @C12579k AppEnvironment appEnvironment, @C12579k C36151f fVar, @C12579k TokenAuthenticator tokenAuthenticator, @C12579k LogMInterceptor logMInterceptor, @C12579k C28833m mVar, @C12579k C28818d dVar) {
        ...
        Object g = new GenericNetworkService.Builder(context, (C28835a) null, (C28816c) null, 6, (DefaultConstructorMarker) null).mo83857i(appEnvironment.mo84167g()).mo83855g(CollectionsKt__CollectionsKt.m40448L(logMInterceptor, fVar, mVar, dVar)).mo83850b(tokenAuthenticator).mo83854f(new Pair[0]).mo83869v(true).mo83859k("com.carrefour.fid.android").mo30586g(C36621b.class);
    ...
    @C12579k
    /* renamed from: b */
    public final C36458a0 mo108190b() {
        return new C36458a0();
    }
}
