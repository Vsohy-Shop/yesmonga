...
/* renamed from: com.carrefour.fid.android.checkout.presentation.ui.slot.ServiceSlotOmrFragment$special$$inlined$viewModels$default$2 */
public final class ServiceSlotOmrFragment$special$$inlined$viewModels$default$2 extends Lambda implements C11289a<C19392a1> {
    final /* synthetic */ C11289a $ownerProducer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ServiceSlotOmrFragment$special$$inlined$viewModels$default$2(C11289a aVar) {
        super(0);
