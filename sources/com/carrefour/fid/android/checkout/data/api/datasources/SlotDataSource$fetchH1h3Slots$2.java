...
@C11067d(mo22501c = "com.carrefour.fid.android.checkout.data.api.datasources.SlotDataSource$fetchH1h3Slots$2", mo22502f = "SlotDataSource.kt", mo22503i = {}, mo22504l = {45}, mo22505m = "invokeSuspend", mo22506n = {}, mo22507s = {})
...
@C11363r0({"SMAP\nSlotDataSource.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SlotDataSource.kt\ncom/carrefour/fid/android/checkout/data/api/datasources/SlotDataSource$fetchH1h3Slots$2\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,125:1\n1549#2:126\n1620#2,3:127\n*S KotlinDebug\n*F\n+ 1 SlotDataSource.kt\ncom/carrefour/fid/android/checkout/data/api/datasources/SlotDataSource$fetchH1h3Slots$2\n*L\n55#1:126\n55#1:127,3\n*E\n"})
public final class SlotDataSource$fetchH1h3Slots$2 extends SuspendLambda implements C11300l<C11045c<? super Result<? extends ServiceSlot>>, Object> {
    ...
    public SlotDataSource$fetchH1h3Slots$2(SlotDataSource slotDataSource, String str, int i, C11045c<? super SlotDataSource$fetchH1h3Slots$2> cVar) {
        super(1, cVar);
    ...
    public final C11045c<C11079d2> create(@C12579k C11045c<?> cVar) {
        return new SlotDataSource$fetchH1h3Slots$2(this.this$0, this.$facilityServiceId, this.$productCount, cVar);
    }
    ...
    public final Object invokeSuspend(@C12579k Object obj) {
        ...
        if (i == 0) {
            ...
            SlotH1h3RequestBody slotH1h3RequestBody = new SlotH1h3RequestBody(this.$productCount);
            this.label = 1;
            obj = a.mo131386e(str, slotH1h3RequestBody, this);
            if (obj == h) {
                return h;
            }
        } else if (i == 1) {
        ...
        SlotListResponse slotListResponse2 = (SlotListResponse) wVar.mo30572a();
        if (slotListResponse2 != null) {
            bool = slotListResponse2.getProductThresholdExceeded();
        }
        if (!wVar.mo30576g() || list == null) {
            ...
            obj2 = Result.m38702b(new ServiceSlot(arrayList, z));
        }
    ...
    public final Object invoke(@C12580l C11045c<? super Result<ServiceSlot>> cVar) {
        return ((SlotDataSource$fetchH1h3Slots$2) create(cVar)).invokeSuspend(C11079d2.f28267a);
    }
}
