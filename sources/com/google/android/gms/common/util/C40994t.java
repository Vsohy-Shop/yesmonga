...
public class C40994t {
    @C40473a
    /* renamed from: a */
    public static int m166675a(@C0359n0 byte[] bArr, int i, int i2, int i3) {
        int i4 = (i2 & -4) + i;
        while (i < i4) {
            int i5 = ((bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << DateTimeFieldType.f30603E0) | (bArr[i + 3] << 24)) * -862048943;
        ...
        if (i7 != 1) {
            if (i7 != 2) {
                if (i7 == 3) {
                    i8 = (bArr[i4 + 2] & 255) << DateTimeFieldType.f30603E0;
                }
                int i9 = i3 ^ i2;
