...
/* renamed from: com.google.android.gms.internal.mlkit_common.s1 */
public final class C42503s1 implements C33005d<C42524u0> {

    /* renamed from: a */
    public static final C42503s1 f107333a = new C42503s1();

    /* renamed from: b */
    public static final C33000c f107334b;

    /* renamed from: c */
    public static final C33000c f107335c;

    /* renamed from: d */
    public static final C33000c f107336d;

    /* renamed from: e */
    public static final C33000c f107337e;

    /* renamed from: f */
    public static final C33000c f107338f;

    static {
        C33000c.C33002b a = C33000c.m133160a("errorCode");
        C42501s sVar = new C42501s();
        sVar.mo137789a(1);
        f107334b = a.mo95637b(sVar.mo137790b()).mo95636a();
        C33000c.C33002b a2 = C33000c.m133160a("hasResult");
        C42501s sVar2 = new C42501s();
        sVar2.mo137789a(2);
        f107335c = a2.mo95637b(sVar2.mo137790b()).mo95636a();
        C33000c.C33002b a3 = C33000c.m133160a("isColdCall");
        C42501s sVar3 = new C42501s();
        sVar3.mo137789a(3);
        f107336d = a3.mo95637b(sVar3.mo137790b()).mo95636a();
        C33000c.C33002b a4 = C33000c.m133160a("imageInfo");
        C42501s sVar4 = new C42501s();
        sVar4.mo137789a(4);
        f107337e = a4.mo95637b(sVar4.mo137790b()).mo95636a();
        C33000c.C33002b a5 = C33000c.m133160a("recognizerOptions");
        C42501s sVar5 = new C42501s();
        sVar5.mo137789a(5);
        f107338f = a5.mo95637b(sVar5.mo137790b()).mo95636a();
    }

    /* renamed from: a */
    public final /* bridge */ /* synthetic */ void mo85035a(Object obj, Object obj2) throws IOException {
        C42524u0 u0Var = (C42524u0) obj;
