...
public final class C30009c {
    /* renamed from: a */
    public static String m121600a(@CheckForNull String str, @CheckForNull Object... objArr) {
        int length;
        int length2;
        int indexOf;
        String str2;
    ...
    /* renamed from: b */
    public static boolean m121601b(@CheckForNull String str) {
        return C29996ab.m121586a(str);
    }
}
