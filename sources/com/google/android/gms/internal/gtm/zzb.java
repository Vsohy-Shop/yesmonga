...
public enum zzb {
    ...
    ACCOUNT(C35517a.f87583g),
    ACTIVITY(C0696c.f2306r),
    ACTIVATE(C33584t.f81710j),
    ...
    COMPANY(C9650g.f26453p),
    COMPONENT(C9314l.f25417c),
    CONSENT(OTVendorUtils.CONSENT_TYPE),
    ...
    DIMENSION(C16717v.C16719b.f42184g),
    ...
    ESCAPE("escape"),
    EVENT_ACTION(C28526d.f68933j),
    EVENT_CATEGORY(C28526d.f68929i),
    EVENT_LABEL(C28526d.f68937k),
    ...
    PAGE(C28565n.C28566a.f69613b),
    PAGE_PATH("page_path"),
    PARAMS(C32648f.f79206e),
    PARTITION("partition"),
    PERCENTAGE(PercentageDecorator.f26902e),
    PIXEL("pixel"),
    PLACEMENT(C9166d.f24869j0),
    PLATFORM("platform"),
    POSITION(C9259x.f25239v),
    PRICES("prices"),
    PRIORITY("priority"),
    PRODUCT("product"),
    ...
    STRING(C16717v.C16719b.f42182e),
    STRIP_WWW("strip_www"),
    TAG_ID("tag_id"),
    TAG_LIST("tag_list"),
