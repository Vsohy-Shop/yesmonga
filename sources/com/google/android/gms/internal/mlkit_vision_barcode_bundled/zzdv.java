...
public enum zzdv {
    ...
    /* renamed from: o1 */
    public static final zzdv[] f99126o1 = null;
    private final zzeq zzab;
    ...
    static {
        int i;
        f99126o1 = new zzdv[r1];
        for (zzdv zzdv : values()) {
            f99126o1[zzdv.zzac] = zzdv;
        }
    }

    /* access modifiers changed from: public */
    zzdv(int i, int i2, zzeq zzeq) {
        this.zzac = i;
        this.zzab = zzeq;
        zzeq zzeq2 = zzeq.VOID;
        int i3 = i2 - 1;
        if (i3 == 1) {
            this.zzad = zzeq.mo123208g();
        } else if (i3 != 3) {
            this.zzad = null;
        } else {
            this.zzad = zzeq.mo123208g();
