...
public final class C38741q {
    /* renamed from: a */
    public static String m160104a(@CheckForNull String str, @CheckForNull Object... objArr) {
        int length;
        int length2;
        int indexOf;
        String str2;
    ...
    /* renamed from: b */
    public static boolean m160105b(@CheckForNull String str) {
        return C38715o.m160082a(str);
    }
}
