...
public final class C42078mc {

    /* renamed from: a */
    public static final C42042kc f106297a = new C42060lc();

    /* renamed from: b */
    public static final /* synthetic */ int f106298b = 0;

    static {
        if (C42006ic.m170287C() && C42006ic.m170288D()) {
            int i = C41984h8.f106189a;
        }
    }

    /* renamed from: a */
    public static /* bridge */ /* synthetic */ int m170565a(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 != 0) {
            if (i3 == 1) {
    ...
    public static int m170566b(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        /*
            int r0 = r7.length()
            r1 = 0
        L_0x0005:
        ...
        L_0x00ff:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.C42078mc.m170566b(java.lang.CharSequence, byte[], int, int):int");
    }

    /* renamed from: c */
    public static int m170567c(CharSequence charSequence) {
    ...
    /* renamed from: d */
    public static boolean m170568d(byte[] bArr) {
        return f106297a.mo137089b(bArr, 0, bArr.length);
    }

    /* renamed from: e */
    public static boolean m170569e(byte[] bArr, int i, int i2) {
        return f106297a.mo137089b(bArr, i, i2);
    }
}
