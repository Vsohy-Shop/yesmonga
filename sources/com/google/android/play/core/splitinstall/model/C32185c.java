...
/* renamed from: com.google.android.play.core.splitinstall.model.c */
public final class C32185c {

    /* renamed from: a */
    public static final Map<Integer, String> f78469a;

    /* renamed from: b */
    public static final Map<Integer, String> f78470b;
    ...
    /* renamed from: a */
    public static String m130216a(@C32183a int i) {
        Map<Integer, String> map = f78469a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        Map<Integer, String> map2 = f78470b;
