...
/* renamed from: com.google.android.play.core.assetpacks.model.d */
public final class C31960d {

    /* renamed from: a */
    public static final Map<Integer, String> f78000a;

    /* renamed from: b */
    public static final Map<Integer, String> f78001b;
    ...
    /* renamed from: a */
    public static String m129581a(@C31957a int i) {
        Map<Integer, String> map = f78000a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f78001b.get(valueOf);
