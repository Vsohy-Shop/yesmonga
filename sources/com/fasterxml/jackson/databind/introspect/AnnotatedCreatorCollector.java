...
final class AnnotatedCreatorCollector extends CollectorBase {
    ...
    private List<AnnotatedMethod> _findPotentialFactories(TypeFactory typeFactory, JavaType javaType, Class<?> cls) {
        ...
        TypeResolutionContext.Empty empty = new TypeResolutionContext.Empty(typeFactory2);
        int size = arrayList.size();
        ArrayList arrayList2 = new ArrayList(size);
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (((AnnotatedMethod) arrayList2.get(i4)) == null) {
                ...
                arrayList2.set(i4, constructFactoryCreator(method3, MethodGenericTypeResolver.narrowMethodTypeParameters(method3, javaType, typeFactory2, empty), (Method) null));
            } else {
