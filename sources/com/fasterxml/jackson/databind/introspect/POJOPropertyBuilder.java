...
public class POJOPropertyBuilder extends BeanPropertyDefinition implements Comparable<POJOPropertyBuilder> {
    ...
    public static /* synthetic */ class C149836 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.introspect.POJOPropertyBuilder.C149836.<clinit>():void");
        }
    }
    ...
    public JsonProperty.Access removeNonVisible(boolean z) {
        return removeNonVisible(z, (POJOPropertiesCollector) null);
    }
    ...
    public JsonProperty.Access removeNonVisible(boolean z, POJOPropertiesCollector pOJOPropertiesCollector) {
        ...
        int i = C149836.$SwitchMap$com$fasterxml$jackson$annotation$JsonProperty$Access[findAccess.ordinal()];
        if (i == 1) {
