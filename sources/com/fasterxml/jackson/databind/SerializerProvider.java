...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public JsonMappingException invalidTypeIdException(JavaType javaType, String str, String str2) {
        return InvalidTypeIdException.from((JsonParser) null, _colonConcat(String.format("Could not resolve type id '%s' as a subtype of %s", new Object[]{str, ClassUtil.getTypeDescription(javaType)}), str2), javaType, str);
    }
