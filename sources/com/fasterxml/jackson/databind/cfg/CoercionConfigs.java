...
public class CoercionConfigs implements Serializable {
    ...
    public static /* synthetic */ class C149601 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.cfg.CoercionConfigs.C149601.<clinit>():void");
        }
    }
    ...
    public CoercionAction findCoercion(DeserializationConfig deserializationConfig, LogicalType logicalType, Class<?> cls, CoercionInputShape coercionInputShape) {
        ...
        int i = C149601.$SwitchMap$com$fasterxml$jackson$databind$cfg$CoercionInputShape[coercionInputShape.ordinal()];
        boolean z = true;
        if (i != 1) {
            if (i != 2) {
