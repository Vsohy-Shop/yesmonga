...
public class BuilderBasedDeserializer extends BeanDeserializerBase {
    ...
    public static /* synthetic */ class C149641 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.deser.BuilderBasedDeserializer.C149641.<clinit>():void");
        }
    }
    ...
    public BuilderBasedDeserializer(BeanDeserializerBuilder beanDeserializerBuilder, BeanDescription beanDescription, JavaType javaType, BeanPropertyMap beanPropertyMap, Map<String, SettableBeanProperty> map, Set<String> set, boolean z, boolean z2) {
        this(beanDeserializerBuilder, beanDescription, javaType, beanPropertyMap, map, set, z, (Set<String>) null, z2);
    }
        ...
        if (jsonDeserializer == null && (jsonDeserializer = this._delegateDeserializer) == null) {
            ...
            if (isEnabled || _findCoercionFromEmptyArray != CoercionAction.Fail) {
                ...
                if (nextToken == jsonToken) {
                    int i = C149641.$SwitchMap$com$fasterxml$jackson$databind$cfg$CoercionAction[_findCoercionFromEmptyArray.ordinal()];
                    if (i == 1) {
