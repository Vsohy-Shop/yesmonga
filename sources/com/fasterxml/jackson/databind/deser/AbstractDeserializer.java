        ...
        if (beanProperty != null && annotationIntrospector != null && (member = beanProperty.getMember()) != null && (findObjectIdInfo = annotationIntrospector.findObjectIdInfo(member)) != null) {
            ...
            if (generatorType == ObjectIdGenerators.PropertyGenerator.class) {
                ...
                if (settableBeanProperty2 == null) {
                    deserializationContext.reportBadDefinition(this._baseType, String.format("Invalid Object Id definition for %s: cannot find property with name %s", new Object[]{ClassUtil.nameOf(handledType()), ClassUtil.name(propertyName)}));
                }
