...
public class NumberDeserializers {
    ...
    public static /* synthetic */ class C149671 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.deser.std.NumberDeserializers.C149671.<clinit>():void");
        }
    }
        ...
        public Character deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            if (currentTokenId == 1) {
                ...
                if (currentTokenId == 11) {
                    ...
                    int i = C149671.$SwitchMap$com$fasterxml$jackson$databind$cfg$CoercionAction[findCoercionAction.ordinal()];
                    if (i == 1) {
