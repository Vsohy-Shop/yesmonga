...
public class MapSerializer extends ContainerSerializer<Map<?, ?>> implements ContextualSerializer {
    ...
    public static /* synthetic */ class C150021 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.ser.std.MapSerializer.C150021.<clinit>():void");
        }
    }
    ...
    public com.fasterxml.jackson.databind.JsonSerializer<?> createContextual(com.fasterxml.jackson.databind.SerializerProvider r14, com.fasterxml.jackson.databind.BeanProperty r15) throws com.fasterxml.jackson.databind.JsonMappingException {
        ...
        L_0x00ef:
            ...
            com.fasterxml.jackson.databind.ser.std.MapSerializer r4 = r4.withFilterId((java.lang.Object) r0)
        L_0x0101:
            ...
            int[] r2 = com.fasterxml.jackson.databind.ser.std.MapSerializer.C150021.$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include
            int r0 = r0.ordinal()
            r0 = r2[r0]
            r2 = 1
    ...
    public MapSerializer withResolved(BeanProperty beanProperty, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2, Set<String> set, boolean z) {
        return withResolved(beanProperty, jsonSerializer, jsonSerializer2, set, (Set<String>) null, z);
    }
    ...
    public MapSerializer(Set<String> set, JavaType javaType, JavaType javaType2, boolean z, TypeSerializer typeSerializer, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2) {
        this(set, (Set<String>) null, javaType, javaType2, z, typeSerializer, jsonSerializer, jsonSerializer2);
    }
    ...
    public MapSerializer(MapSerializer mapSerializer, BeanProperty beanProperty, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2, Set<String> set) {
        this(mapSerializer, beanProperty, jsonSerializer, jsonSerializer2, set, (Set<String>) null);
    }
