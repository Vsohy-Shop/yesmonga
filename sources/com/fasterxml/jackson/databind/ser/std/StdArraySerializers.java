...
public class StdArraySerializers {
    ...
    public static class BooleanArraySerializer extends ArraySerializerBase<boolean[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ...
            createSchemaNode.set("items", createSchemaNode(C16717v.C16719b.f42183f));
    ...
    public static class CharArraySerializer extends StdSerializer<char[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ObjectNode createSchemaNode = createSchemaNode("array", true);
            ObjectNode createSchemaNode2 = createSchemaNode(C16717v.C16719b.f42182e);
            createSchemaNode2.put("type", C16717v.C16719b.f42182e);
    ...
    public static class IntArraySerializer extends ArraySerializerBase<int[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            return createSchemaNode("array", true).set("items", createSchemaNode(C16717v.C16719b.f42179b));
        }
