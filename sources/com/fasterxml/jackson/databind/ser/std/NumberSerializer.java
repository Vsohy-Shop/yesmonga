...
public class NumberSerializer extends StdScalarSerializer<Number> implements ContextualSerializer {
    ...
    public static /* synthetic */ class C150031 {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (findFormatOverrides == null || C150031.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[findFormatOverrides.getShape().ordinal()] != 1) {
            return this;
        }
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
        return createSchemaNode(this._isInt ? C16717v.C16719b.f42179b : "number", true);
    }
