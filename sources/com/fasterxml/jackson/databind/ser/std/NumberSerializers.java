...
public class NumberSerializers {
    ...
    public static /* synthetic */ class C150041 {
    ...
    public static abstract class Base<T> extends StdScalarSerializer<T> implements ContextualSerializer {
        ...
        public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
            ...
            if (findFormatOverrides == null || C150041.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[findFormatOverrides.getShape().ordinal()] != 1) {
                return this;
            }
    ...
    public static class IntLikeSerializer extends Base<Object> {
        ...
        public IntLikeSerializer() {
            super(Number.class, JsonParser.NumberType.INT, C16717v.C16719b.f42179b);
        }
    ...
    public static class IntegerSerializer extends Base<Object> {
        public IntegerSerializer(Class<?> cls) {
            super(cls, JsonParser.NumberType.INT, C16717v.C16719b.f42179b);
        }
