...
public class TreeTraversingParser extends ParserMinimalBase {
    ...
    public static /* synthetic */ class C149951 {
        ...
        static {
            ...
            L_0x006c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.node.TreeTraversingParser.C149951.<clinit>():void");
        }
    }
    ...
    public String getText() {
        ...
        switch (C149951.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()]) {
            case 5:
    ...
    public JsonToken nextToken() throws IOException, JsonParseException {
        ...
        int i = C149951.$SwitchMap$com$fasterxml$jackson$core$JsonToken[nextToken.ordinal()];
        if (i == 1) {
