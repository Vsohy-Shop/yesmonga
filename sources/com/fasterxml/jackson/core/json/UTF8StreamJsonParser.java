...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    private final void _closeArrayScope() throws JsonParseException {
        ...
        if (!this._parsingContext.inArray()) {
            _reportMismatchedEndMarker(93, C12361b.f30259j);
        }
    ...
    private final void _closeObjectScope() throws JsonParseException {
        ...
        if (!this._parsingContext.inObject()) {
            _reportMismatchedEndMarker(125, C12361b.f30261l);
        }
        this._parsingContext = this._parsingContext.clearAndGetParent();
    }
    ...
    private final int _decodeUtf8_2(int i) throws IOException {
        ...
        this._inputPtr = i3;
        byte b = bArr[i2];
        if ((b & C19135a.f49026p7) != 128) {
            _reportInvalidOther(b & 255, i3);
        }
        return ((i & 31) << 6) | (b & C12520s0.f30502a);
    }
    ...
    private final int _decodeUtf8_3(int i) throws IOException {
        ...
        byte b2 = (i2 << 6) | (b & C12520s0.f30502a);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        ...
        return (b2 << 6) | (b3 & C12520s0.f30502a);
    }
    ...
    private final int _decodeUtf8_4(int i) throws IOException {
        ...
        byte b2 = ((i & 7) << 6) | (b & C12520s0.f30502a);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        byte[] bArr2 = this._inputBuffer;
        ...
        byte b4 = (b2 << 6) | (b3 & C12520s0.f30502a);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        ...
        this._inputPtr = i7;
        byte b5 = bArr3[i6];
        if ((b5 & C19135a.f49026p7) != 128) {
            _reportInvalidOther(b5 & 255, i7);
        }
        return ((b4 << 6) | (b5 & C12520s0.f30502a)) - 65536;
    }
    ...
    private final java.lang.String addName(int[] r17, int r18, int r19) throws com.fasterxml.jackson.core.JsonParseException {
        ...
        L_0x00cf:
            ...
            char r6 = (char) r6
            r8[r11] = r6
            r6 = r12 & 1023(0x3ff, float:1.434E-42)
...
/*
Method generation error in method: com.fasterxml.jackson.core.json.UTF8StreamJsonParser._handleInvalidNumberStart(int, boolean):com.fasterxml.jackson.core.JsonToken, dex: classes3.dex
...
*/
    ...
    public final void _matchFalse() throws IOException {
        ...
        _matchToken2(C13758b.f33438c, 1);
    }
    ...
    public final void _matchTrue() throws IOException {
        ...
        _matchToken2(C13758b.f33436b, 1);
    }
