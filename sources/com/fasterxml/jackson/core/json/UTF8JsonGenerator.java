...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
        ...
        while (i < i2) {
            ...
            if (c <= 127) {
                ...
                if (escapeSequence2 != null) {
                    ...
                    int i8 = i3 + 1;
                    bArr[i3] = (byte) ((c >> 6) | C14092c.f34560U);
                    i3 = i8 + 1;
                    bArr[i8] = (byte) ((c & '?') | 128);
                } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x000e, code lost:
        ...
        r2 = r5._outputTail;
        r3 = r2 + 1;
        r1[r2] = (byte) ((r0 >> 6) | com.contentsquare.android.api.C14092c.f34560U);
        r5._outputTail = r3 + 1;
        r1[r3] = (byte) ((r0 & '?') | 128);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0020, code lost:
        r4 = r7._outputTail;
        r5 = r4 + 1;
        r1[r4] = (byte) ((r9 >> 6) | com.contentsquare.android.api.C14092c.f34560U);
        r7._outputTail = r5 + 1;
        r1[r5] = (byte) ((r9 & '?') | 128);
        r9 = r2;
     */
    ...
    public final void _outputSurrogates(int i, int i2) throws IOException {
        ...
        int i3 = this._outputTail;
        int i4 = i3 + 1;
        bArr[i3] = (byte) ((_decodeSurrogate >> 18) | C9527p.f26031b);
        int i5 = i4 + 1;
    ...
    private final void _writeStringSegment2(String str, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                int i7 = i3 + 1;
                bArr[i3] = (byte) ((charAt >> 6) | C14092c.f34560U);
                i3 = i7 + 1;
    ...
    public void writeRaw(char c) throws IOException {
        ...
        if (c <= 127) {
            ...
            int i2 = this._outputTail;
            int i3 = i2 + 1;
            bArr[i2] = (byte) ((c >> 6) | C14092c.f34560U);
            this._outputTail = i3 + 1;
            bArr[i3] = (byte) ((c & '?') | 128);
        } else {
