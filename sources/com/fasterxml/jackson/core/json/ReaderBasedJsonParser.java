...
public class ReaderBasedJsonParser extends ParserBase {
    ...
    private void _closeScope(int i) throws JsonParseException {
        if (i == 93) {
            ...
            if (!this._parsingContext.inArray()) {
                _reportMismatchedEndMarker(i, C12361b.f30259j);
            }
        ...
        if (i == 125) {
            ...
            if (!this._parsingContext.inObject()) {
                _reportMismatchedEndMarker(i, C12361b.f30261l);
            }
            this._parsingContext = this._parsingContext.clearAndGetParent();
    ...
    private final void _isNextTokenNameYes(int i) throws IOException {
        ...
        if (i == 34) {
            ...
            _matchToken(C13758b.f33438c, 1);
            this._nextToken = JsonToken.VALUE_FALSE;
        } else if (i == 110) {
            _matchToken("null", 1);
            this._nextToken = JsonToken.VALUE_NULL;
        } else if (i == 116) {
            _matchToken(C13758b.f33436b, 1);
    ...
    private final com.fasterxml.jackson.core.JsonToken _parseFloat(int r9, int r10, int r11, boolean r12, int r13) throws java.io.IOException {
        ...
        L_0x0022:
            ...
            r8.reportUnexpectedNumberChar(r11, r1)
        L_0x0029:
            r7 = r11
            r11 = r9
            r9 = r7
...
*/
    ...
    public String _handleOddName(int i) throws IOException {
        ...
        } else if (inputCodeLatin1JsNames[i] == 0) {
            z = true;
        } else {
            z = false;
        }
    ...
    public int _readBinary(com.fasterxml.jackson.core.Base64Variant r17, java.io.OutputStream r18, byte[] r19) throws java.io.IOException {
        ...
        L_0x0095:
            ...
            goto L_0x0124
        L_0x0098:
            int r10 = r0._decodeBase64Escape((com.fasterxml.jackson.core.Base64Variant) r1, (char) r10, (int) r14)
            r12 = r10
        L_0x009d:
        ...
        L_0x012d:
            r11 = 3
            int r5 = r0._decodeBase64Escape((com.fasterxml.jackson.core.Base64Variant) r1, (char) r5, (int) r11)
            r10 = r5
            goto L_0x0135
        L_0x0134:
            r11 = 3
    ...
    public JsonLocation getCurrentLocation() {
        return new JsonLocation(_getSourceReference(), -1, this._currInputProcessed + ((long) this._inputPtr), this._currInputRow, (this._inputPtr - this._currInputRowStart) + 1);
    }
