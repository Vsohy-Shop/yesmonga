...
import com.fasterxml.jackson.core.p025io.NumberOutput;
...
public class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    private char[] _allocateEntityBuffer() {
        ...
        cArr[0] = '\\';
        cArr[2] = '\\';
        cArr[3] = C12361b.f30265p;
        cArr[4] = '0';
        cArr[5] = '0';
        cArr[8] = '\\';
        cArr[9] = C12361b.f30265p;
    ...
    private final void _writeNull() throws IOException {
        ...
        cArr[i] = 'n';
        int i2 = i + 1;
        cArr[i2] = C12361b.f30265p;
        int i3 = i2 + 1;
        cArr[i3] = C15369g.f37979e;
        int i4 = i3 + 1;
        cArr[i4] = C15369g.f37979e;
        this._outputTail = i4 + 1;
    }
    ...
    public final void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        if (i9 > 0) {
            ...
            int i10 = i + 1;
            int i11 = bArr[i] << DateTimeFieldType.f30603E0;
            if (i9 == 2) {
                i11 |= (bArr[i10] & 255) << 8;
            }
    ...
    public void writeBoolean(boolean z) throws IOException {
        ...
        char[] cArr = this._outputBuffer;
        if (z) {
            cArr[i2] = C15369g.f37991q;
            int i3 = i2 + 1;
            cArr[i3] = 'r';
            int i4 = i3 + 1;
            cArr[i4] = C12361b.f30265p;
            i = i4 + 1;
            cArr[i] = 'e';
        } else {
            cArr[i2] = 'f';
            int i5 = i2 + 1;
            cArr[i5] = C15369g.f37993s;
            int i6 = i5 + 1;
            cArr[i6] = C15369g.f37979e;
            int i7 = i6 + 1;
            cArr[i7] = C15369g.f37987m;
            i = i7 + 1;
            cArr[i] = 'e';
        }
        this._outputTail = i + 1;
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        int i10 = bArr[0] << DateTimeFieldType.f30603E0;
        if (1 < _readMore) {
            i10 |= (bArr[1] & 255) << 8;
        } else {
            i3 = 1;
