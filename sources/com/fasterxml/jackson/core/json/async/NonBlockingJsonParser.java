...
/*
Method generation error in method: com.fasterxml.jackson.core.json.async.NonBlockingJsonParser._decodeSplitUTF8_3(int, int, int):boolean, dex: classes3.dex
...
/*
Method generation error in method: com.fasterxml.jackson.core.json.async.NonBlockingJsonParser._decodeSplitUTF8_4(int, int, int):boolean, dex: classes3.dex
...
*/
        ...
        while (true) {
            ...
            if (!(i5 == 34 || iArr2[i5] == 0)) {
                ...
                if (i5 > 127) {
                    ...
                    if (i5 < 2048) {
                        r10 = (r10 << 8) | (i5 >> 6) | C14092c.f34560U;
                        r11++;
                    } else {
    ...
    private final com.fasterxml.jackson.core.JsonToken _startFieldNameAfterComma(int r5) throws java.io.IOException {
        ...
        L_0x001d:
            ...
            com.fasterxml.jackson.core.JsonToken r5 = r4._finishHashComment(r0)
            return r5
        L_0x0026:
            r2 = 47
            if (r5 != r2) goto L_0x002f
            com.fasterxml.jackson.core.JsonToken r5 = r4._startSlashComment(r0)
            return r5
        L_0x002f:
        ...
        L_0x0071:
            ...
            int r5 = r4._features
            int r1 = FEAT_MASK_TRAILING_COMMA
            r5 = r5 & r1
            if (r5 == 0) goto L_0x0086
            com.fasterxml.jackson.core.JsonToken r5 = r4._closeObjectScope()
            return r5
        L_0x0086:
            com.fasterxml.jackson.core.JsonToken r5 = r4._handleOddName(r0)
            return r5
        L_0x008b:
            int r5 = r4._inputPtr
            int r5 = r5 + 13
    ...
    private final com.fasterxml.jackson.core.JsonToken _startValueExpectColon(int r5) throws java.io.IOException {
        ...
        L_0x0079:
            r5 = 0
            com.fasterxml.jackson.core.JsonToken r5 = r4._startUnexpectedValue(r5, r0)
            return r5
        L_0x007f:
            com.fasterxml.jackson.core.JsonToken r5 = r4._startPositiveNumber(r0)
            return r5
        L_0x0084:
    ...
    private final com.fasterxml.jackson.core.JsonToken _startValueExpectComma(int r8) throws java.io.IOException {
        ...
        L_0x0029:
            ...
            com.fasterxml.jackson.core.JsonToken r8 = r7._startSlashComment(r0)
            return r8
        L_0x0032:
            if (r8 != r3) goto L_0x0039
            com.fasterxml.jackson.core.JsonToken r8 = r7._finishHashComment(r0)
            return r8
        L_0x0039:
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            r0.<init>()
        ...
        L_0x00ae:
            goto L_0x00ea
        L_0x00af:
            com.fasterxml.jackson.core.JsonToken r8 = r7._startPositiveNumber(r0)
            return r8
        L_0x00b4:
        ...
        L_0x00de:
            ...
            return r8
        L_0x00ea:
            com.fasterxml.jackson.core.JsonToken r8 = r7._startUnexpectedValue(r6, r0)
            return r8
        L_0x00ef:
    ...
    public final JsonToken _finishFieldWithEscape() throws IOException {
        ...
        if (_decodeSplitEscaped > 127) {
            ...
            if (_decodeSplitEscaped < 2048) {
                i2 = i5 << 8;
                i3 = (_decodeSplitEscaped >> 6) | C14092c.f34560U;
            } else {
...
/*
Method generation error in method: com.fasterxml.jackson.core.json.async.NonBlockingJsonParser._finishFloatExponent(boolean, int):com.fasterxml.jackson.core.JsonToken, dex: classes3.dex
    jadx.core.utils.exceptions.JadxRuntimeException: Code variable not set in r6v0 ?
    	at jadx.core.dex.instructions.args.SSAVar.getCodeVar(SSAVar.java:189)
    	at jadx.core.codegen.MethodGen.addMethodArguments(MethodGen.java:157)
    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:129)
...
*/
            ...
            switch (i) {
                ...
                default:
                    switch (i) {
                        ...
                        case 17:
                            return _finishKeywordToken(C13758b.f33436b, this._pending32, JsonToken.VALUE_TRUE);
                        case 18:
                            return _finishKeywordToken(C13758b.f33438c, this._pending32, JsonToken.VALUE_FALSE);
                        case 19:
    ...
    public JsonToken _startFalseToken() throws IOException {
        ...
        this._minorState = 18;
        return _finishKeywordToken(C13758b.f33438c, 1, JsonToken.VALUE_FALSE);
    }
    ...
    public com.fasterxml.jackson.core.JsonToken _startFloat(char[] r7, int r8, int r9) throws java.io.IOException {
        ...
        L_0x004d:
            ...
            r6.reportUnexpectedNumberChar(r3, r4)
            goto L_0x0059
        L_0x0057:
            r3 = r9
            r9 = r2
    ...
    public JsonToken _startTrueToken() throws IOException {
        ...
        this._minorState = 17;
        return _finishKeywordToken(C13758b.f33436b, 1, JsonToken.VALUE_TRUE);
    }
