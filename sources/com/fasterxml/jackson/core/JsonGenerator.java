...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    public static /* synthetic */ class C149541 {

        /* renamed from: $SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion */
        static final /* synthetic */ int[] f37071xa51b40dc;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f37071xa51b40dc     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f37071xa51b40dc     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f37071xa51b40dc     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f37071xa51b40dc     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.JsonGenerator.C149541.<clinit>():void");
        }
    }
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId writableTypeId) throws IOException {
        String str;
        Object obj = writableTypeId.f37090id;
        ...
        if (canWriteTypeId()) {
            ...
            int i = C149541.f37071xa51b40dc[inclusion.ordinal()];
            if (!(i == 1 || i == 2)) {
                if (i == 3) {
    ...
    public WritableTypeId writeTypeSuffix(WritableTypeId writableTypeId) throws IOException {
        ...
        if (writableTypeId.wrapperWritten) {
            int i = C149541.f37071xa51b40dc[writableTypeId.include.ordinal()];
            if (i == 1) {
                Object obj = writableTypeId.f37090id;
                if (obj instanceof String) {
                    str = (String) obj;
