...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    public void _handleEOF() throws JsonParseException {
        ...
        if (!this._parsingContext.inRoot()) {
            ...
            _reportInvalidEOF(String.format(": expected close marker for %s (start marker at %s)", new Object[]{str, this._parsingContext.getStartLocation(_getSourceReference())}), (JsonToken) null);
        }
    }
