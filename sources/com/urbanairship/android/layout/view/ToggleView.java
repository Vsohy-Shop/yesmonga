...
@C11076d0(mo22515d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0017\u0012\u0006\u0010\u000b\u001a\u00020\n\u0012\u0006\u0010\f\u001a\u00020\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u0010\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0004\u001a\u00020\u0003H\u0014J\u0010\u0010\t\u001a\u00020\b2\u0006\u0010\u0004\u001a\u00020\u0007H\u0014¨\u0006\u000f"}, mo22516d2 = {"Lcom/urbanairship/android/layout/view/ToggleView;", "Lcom/urbanairship/android/layout/widget/CheckableView;", "Lcom/urbanairship/android/layout/model/ToggleModel;", "Lcom/urbanairship/android/layout/property/p;", "style", "Landroidx/appcompat/widget/SwitchCompat;", "d", "Lcom/urbanairship/android/layout/property/e;", "Lcom/urbanairship/android/layout/widget/ShapeButton;", "c", "Landroid/content/Context;", "context", "model", "<init>", "(Landroid/content/Context;Lcom/urbanairship/android/layout/model/ToggleModel;)V", "urbanairship-layout_release"}, mo22517k = 1, mo22518mv = {1, 7, 1})
public final class ToggleView extends CheckableView<ToggleModel> {

    /* renamed from: com.urbanairship.android.layout.view.ToggleView$a */
    public static final class C35967a implements C35793b.C35794a {

        /* renamed from: a */
        public final /* synthetic */ ToggleView f88908a;

        public C35967a(ToggleView toggleView) {
            this.f88908a = toggleView;
        }

        /* renamed from: f */
        public void mo107011f(boolean z) {
            int i;
            ToggleView toggleView = this.f88908a;
            if (z) {
                i = 8;
            } else {
                i = 0;
            }
            toggleView.setVisibility(i);
        }
        ...
        public void setEnabled(boolean z) {
            this.f88908a.setEnabled(z);
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ToggleView(@C12579k Context context, @C12579k ToggleModel toggleModel) {
        super(context, toggleModel);
        Intrinsics.checkNotNullParameter(context, C9175a.f24932Y);
        Intrinsics.checkNotNullParameter(toggleModel, C40045d.f102104u);
        toggleModel.mo106988H(new C35967a(this));
    }
    ...
    public ShapeButton mo107590c(@C12579k C35832e eVar) {
        ...
        return new ToggleView$createCheckboxView$1(this, getContext(), b.mo107339c(), c.mo107339c(), b.mo107338b(), c.mo107338b());
    }
    ...
    public SwitchCompat mo107591d(@C12579k C35849p pVar) {
        ...
        return new ToggleView$createSwitchView$1(this, getContext());
    }
}
