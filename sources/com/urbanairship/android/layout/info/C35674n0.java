...
import com.urbanairship.android.layout.property.C35851r;
...
/* renamed from: com.urbanairship.android.layout.info.n0 */
public final class C35674n0 extends C35686t0 implements C35682r0, C35681r, C35645a, C35678p0 {

    /* renamed from: b */
    public final /* synthetic */ C35682r0 f88181b;

    /* renamed from: c */
    public final /* synthetic */ C35681r f88182c;

    /* renamed from: d */
    public final /* synthetic */ C35645a f88183d;

    /* renamed from: e */
    public final /* synthetic */ C35680q0 f88184e;
    @C12579k

    /* renamed from: f */
    public final FormInputType f88185f;
    @C12580l

    /* renamed from: g */
    public final String f88186g;
    @C12579k

    /* renamed from: h */
    public final C35851r f88187h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C35674n0(@C12579k C9323b bVar) {
        ...
        this.f88181b = C35691u0.m147171l(bVar);
        this.f88182c = C35691u0.m147168i(bVar);
        this.f88183d = C35691u0.m147166g(bVar);
        this.f88184e = C35691u0.m147170k(bVar);
        JsonValue k = bVar3.mo18812k("input_type");
        if (k != null) {
            ...
            String str3 = "input_type";
            Class<Integer> cls4 = Integer.class;
            String str4 = "get(key) ?: throw JsonEx… required field: '$key'\")";
            ...
            if (Intrinsics.areEqual((Object) d, (Object) C11342l0.m43547d(cls))) {
                ...
                throw new JsonException("Invalid type '" + cls.getSimpleName() + "' for field '" + str3 + '\'');
            }
            FormInputType b = FormInputType.m147660b(str);
            Intrinsics.checkNotNullExpressionValue(b, "from(json.requireField(\"input_type\"))");
            this.f88185f = b;
            JsonValue k2 = bVar3.mo18812k("place_holder");
            if (k2 == null) {
                str2 = null;
            } else {
                Intrinsics.checkNotNullExpressionValue(k2, "get(key) ?: return null");
                C11494d d2 = C11342l0.m43547d(cls);
                if (Intrinsics.areEqual((Object) d2, (Object) C11342l0.m43547d(cls))) {
                    ...
                    str2 = (String) k2.mo18784z();
                } else if (Intrinsics.areEqual((Object) d2, (Object) C11342l0.m43547d(cls5))) {
                    str2 = (String) k2.mo18749A();
                } else if (Intrinsics.areEqual((Object) d2, (Object) C11342l0.m43547d(cls2))) {
                    str2 = (String) k2.mo17264q();
                } else {
                    throw new JsonException("Invalid type '" + cls.getSimpleName() + "' for field '" + "place_holder" + '\'');
                }
            }
            this.f88186g = str2;
            JsonValue k3 = bVar3.mo18812k("text_appearance");
            if (k3 != null) {
                Intrinsics.checkNotNullExpressionValue(k3, str4);
                C11494d d3 = C11342l0.m43547d(cls5);
                if (Intrinsics.areEqual((Object) d3, (Object) C11342l0.m43547d(cls))) {
                ...
                C35851r g = C35851r.m147811g(bVar2);
                Intrinsics.checkNotNullExpressionValue(g, "fromJson(json.requireField(\"text_appearance\"))");
                this.f88187h = g;
                return;
            }
    ...
    public String mo106791a() {
        return this.f88182c.mo106791a();
    }

    @C12580l
    /* renamed from: d */
    public List<EnableBehaviorType> mo106774d() {
        return this.f88181b.mo106774d();
    }

    @C12580l
    public C35835f getBackgroundColor() {
        return this.f88181b.getBackgroundColor();
    }

    @C12580l
    public String getContentDescription() {
        return this.f88183d.getContentDescription();
    }

    @C12579k
    public ViewType getType() {
        return this.f88181b.getType();
    }

    @C12580l
    public C35693v0 getVisibility() {
        return this.f88181b.getVisibility();
    }

    @C12580l
    /* renamed from: h */
    public C35830c mo106778h() {
        return this.f88181b.mo106778h();
    }

    @C12580l
    /* renamed from: i */
    public List<EventHandler> mo106779i() {
        return this.f88181b.mo106779i();
    }

    public boolean isRequired() {
        return this.f88184e.isRequired();
    }

    @C12580l
    /* renamed from: k */
    public final String mo106821k() {
        return this.f88186g;
    }

    @C12579k
    /* renamed from: l */
    public final FormInputType mo106822l() {
        return this.f88185f;
    }

    @C12579k
    /* renamed from: m */
    public final C35851r mo106823m() {
        return this.f88187h;
    }
}
