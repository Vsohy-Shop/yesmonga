...
/* renamed from: com.urbanairship.android.layout.info.c0 */
public final class C35650c0 extends C35684s0<C35689u.C35690a> implements C35669l {

    /* renamed from: b */
    public final /* synthetic */ C35669l f88117b;
    @C12579k

    /* renamed from: c */
    public final C35686t0 f88118c;
    @C12579k

    /* renamed from: d */
    public final List<C35689u.C35690a> f88119d;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C35650c0(@C12579k C9323b bVar) {
        super((DefaultConstructorMarker) null);
        C9323b bVar2;
        Intrinsics.checkNotNullParameter(bVar, "json");
        this.f88117b = C35691u0.m147167h(bVar);
        ...
        if (k != null) {
            ...
            this.f88118c = aVar.mo106835a(bVar2);
            this.f88119d = C10976s.m41419k(new C35689u.C35690a(getView()));
            return;
        }
    ...
    public String mo106791a() {
        return this.f88117b.mo106791a();
    }

    @C12580l
    /* renamed from: d */
    public List<EnableBehaviorType> mo106774d() {
        return this.f88117b.mo106774d();
    }

    @C12580l
    public C35835f getBackgroundColor() {
        return this.f88117b.getBackgroundColor();
    }

    @C12579k
    public ViewType getType() {
        return this.f88117b.getType();
    }
    ...
    public C35693v0 getVisibility() {
        return this.f88117b.getVisibility();
    }

    @C12580l
    /* renamed from: h */
    public C35830c mo106778h() {
        return this.f88117b.mo106778h();
    }

    @C12580l
    /* renamed from: i */
    public List<EventHandler> mo106779i() {
        return this.f88117b.mo106779i();
    }
