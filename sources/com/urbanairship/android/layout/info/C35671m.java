...
/* renamed from: com.urbanairship.android.layout.info.m */
public final class C35671m extends C35684s0<C35689u.C35690a> implements C35669l, C35682r0, C35681r {

    /* renamed from: b */
    public final /* synthetic */ C35682r0 f88173b;

    /* renamed from: c */
    public final /* synthetic */ C35681r f88174c;
    @C12579k

    /* renamed from: d */
    public final C35686t0 f88175d;
    @C12579k

    /* renamed from: e */
    public final List<C35689u.C35690a> f88176e;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C35671m(@C12579k C9323b bVar) {
        super((DefaultConstructorMarker) null);
        C9323b bVar2;
        Intrinsics.checkNotNullParameter(bVar, "json");
        this.f88173b = C35691u0.m147171l(bVar);
        this.f88174c = C35691u0.m147168i(bVar);
        ...
        if (k != null) {
            ...
            this.f88175d = aVar.mo106835a(bVar2);
            this.f88176e = C10976s.m41419k(new C35689u.C35690a(getView()));
            return;
        }
    ...
    public String mo106791a() {
        return this.f88174c.mo106791a();
    }

    @C12580l
    /* renamed from: d */
    public List<EnableBehaviorType> mo106774d() {
        return this.f88173b.mo106774d();
    }

    @C12580l
    public C35835f getBackgroundColor() {
        return this.f88173b.getBackgroundColor();
    }

    @C12579k
    public ViewType getType() {
        return this.f88173b.getType();
    }
    ...
    public C35693v0 getVisibility() {
        return this.f88173b.getVisibility();
    }

    @C12580l
    /* renamed from: h */
    public C35830c mo106778h() {
        return this.f88173b.mo106778h();
    }

    @C12580l
    /* renamed from: i */
    public List<EventHandler> mo106779i() {
        return this.f88173b.mo106779i();
    }
