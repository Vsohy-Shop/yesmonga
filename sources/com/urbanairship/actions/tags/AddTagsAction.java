...
public class AddTagsAction extends C35514a {
    @C0359n0

    /* renamed from: k */
    public static final String f87573k = "add_tags_action";
    @C0359n0

    /* renamed from: l */
    public static final String f87574l = "^+t";

    public static class AddTagsPredicate implements C35492e.C35494b {
        /* renamed from: a */
    ...
    public void mo106390g(@C0359n0 Map<String, Set<String>> map) {
        C36059m.m148413i("AddTagsAction - Adding channel tag groups: %s", map);
        C9060z U = mo106393j().mo17788U();
        for (Map.Entry next : map.entrySet()) {
            U.mo17952b((String) next.getKey(), (Set) next.getValue());
        }
        U.mo17953d();
    }
    ...
    public void mo106391h(@C0359n0 Set<String> set) {
        C36059m.m148413i("AddTagsAction - Adding tags: %s", set);
        mo106393j().mo17789V().mo17930b(set).mo17931c();
    }

    /* renamed from: i */
    public void mo106392i(@C0359n0 Map<String, Set<String>> map) {
        C36059m.m148413i("AddTagsAction - Adding named user tag groups: %s", map);
        C9060z X = UAirship.m146188Y().mo106227r().mo18031X();
        for (Map.Entry next : map.entrySet()) {
            X.mo17952b((String) next.getKey(), (Set) next.getValue());
        }
        X.mo17953d();
    }
}
