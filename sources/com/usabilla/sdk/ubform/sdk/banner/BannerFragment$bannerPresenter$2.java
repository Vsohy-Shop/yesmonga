...
public final class BannerFragment$bannerPresenter$2 extends Lambda implements C11289a<BannerPresenter> {
    final /* synthetic */ BannerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BannerFragment$bannerPresenter$2(BannerFragment bannerFragment) {
        super(0);
    ...
    public final BannerPresenter invoke() {
        FormModel L0 = this.this$0.mo20689S0();
        BannerFragment bannerFragment = this.this$0;
        return new BannerPresenter(L0, bannerFragment, bannerFragment.mo20695Y0());
    }
}
